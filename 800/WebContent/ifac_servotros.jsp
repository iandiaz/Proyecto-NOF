...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/iguias_search?tipo_dte=804'">VOLVER</button> 
...
<div class="content" >
  ...
  <input type="hidden" name="tdte" value="<%=tdte%>" >   
	...
	<div style="padding: 5px 5px 5px 5px;">
		...
		<div class="bgrabar">
          <button type="submit" name="grabar" id="grabar" class="btn btn-success" <% if(fac_servotros_estado.equals("ENVIADA")){ %>disabled<% } %> >ENVIAR AL SII</button>
       </div> 
	</div>
</form>
