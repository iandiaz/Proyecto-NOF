...
String fac_servotros_condiciones=(String)request.getAttribute("fac_servotros_condiciones");	
String fac_servotros_fecvencimiento=(String)request.getAttribute("fac_servotros_fecvencimiento");	
String empresas_nombrenofemisor=(String)request.getAttribute("empresas_nombrenofemisor");	
String fac_servotros_tipodte=(String)request.getAttribute("fac_servotros_tipodte");	
...
String fac_servotros_obs=(String)request.getAttribute("fac_servotros_obs");	
...
String sub_fac_servotros_total=(String)request.getAttribute("fac_servotros_total");

String fac_servotros_total=(String)request.getAttribute("fac_servotros_total");
...
String neto= nff.format(Integer.parseInt(fac_servotros_total)).replace(",",".");
...
if(fac_servotros_tipodte.equals("34")){iva="0";}
...
String gr_glosa_desc=(String)request.getAttribute("fac_servotros_glosa_desc");	
String fac_servotros_estado=(String)request.getAttribute("fac_servotros_estado");
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/cguias_search?f1=&f2=&tipo_dte=804'">VOLVER</button> 
	<div align="center" class="title">
		<p>CONSULTAR GENERADOR DOCUMENTO DTE</p>
	</div>
</div>
<div class="content" >
  <form action="ifac_servotros" name="form1" method="post">
  ...
  <input type="hidden" name="tdte" value="<%=tdte%>" >   
	<div class=" cuadroblanco" style="height:120px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>CONDICIONES:</strong><input name="fac_servotros_condiciones" type="text" style="width:380px;height:30px ;background:#FFF;" disabled="disabled" value="<%=fac_servotros_condiciones%>"></div>
		...
		<div class="divhead"><strong>TIPO DOCUMENTO:</strong><input type="radio"  value="33" disabled="disabled" <% if(fac_servotros_tipodte.equals("33")){%> checked="checked" <%} %> >(33)AFECTA <input type="radio" disabled="disabled" <% if(fac_servotros_tipodte.equals("34")){%> checked="checked" <%} %> value="34">(34)EXENTA</div>
		<div class="divhead"><strong>FEC. VENCIMIENTO:</strong><input type="text" style="width:150px;height:30px ;background:#FFF;" value="<%=fac_servotros_fecvencimiento %>" disabled="disabled" ></div>
	...
	<div class=" cuadroblanco" style="height:235px;margin-top: 5px;">
		...
		%>
		<div class="divhead"><strong>SERV OTROS <%=i+1%>:</strong><input type="text" style="width:600px;height:30px ;background:#FFF;" value="<%=servicio%>" disabled></div>
		<div class="divhead"><strong>VALOR <%=i+1%>:</strong><input type="text" style="width:120px;height:30px ;background:#FFF;text-align: right;" value="<%=valor%>" disabled></div>
		<% } %>
		</div>
	</div>
	<div class=" cuadroblanco" style="height:120px;margin-top: 5px;">
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>SUBTOTAL:</strong><input type="text" style="width:150px;height:30px ;background:#FFF;text-align: right;" disabled="disabled" value="<%=neto%>"></div>
		...
		<div class="divhead"><strong>GLOSA DESCUENTO:</strong><input type="text"  style="width:350px;height:30px ;background:#FFF;"  value="<%=gr_glosa_desc %>" readonly="readonly" ></div>
		<div class="divhead"><strong><% if(fac_servotros_tipodte.equals("33") || fac_servotros_tipodte.equals("30")){%>AFECTO<%}%><% if(fac_servotros_tipodte.equals("34") || fac_servotros_tipodte.equals("32")){%>EXENTO<%}%>:</strong><input type="text" style="width:130px;height:30px ;background:#FFF;text-align: right;" disabled="disabled" value="<%=netodesc %>" id="netoneto"></div>
		...
		<div class="divhead"><strong>TOTAL:</strong><input type="text" style="width:150px;height:30px ;background:#FFF;text-align: right;" disabled="disabled" value="<%=totalfinal%>"></div>
	...
	<div style="padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>OBSERVACIONES:</strong><input type="text"  maxlength="64" style="width:720px;height:30px ;background:#FFF;" value="<%=fac_servotros_obs%>" disabled="disabled"></div>
