...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/cguias_search?f1=&f2=&tipo_dte=824'">VOLVER</button> 
...
<form action="" name="form1" id="form1"  method="post" target="_blank">
  <input type="hidden" name="fact_id" value="<%=guia_des_traszf_id%>" >
	<div class=" cuadroblanco" style="height:80px;">
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>NRO.GUIA:</strong><input  type="text" style="width:100px;height:30px ;background:#FFF;" disabled="disabled" value="<%=folio%>"></div>
	...
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>NUMERO DE TICKET:</strong><input type="text"  value="<%=numticket %>" style="width:750px;height:30px ;background:#FFF;" disabled></div>
