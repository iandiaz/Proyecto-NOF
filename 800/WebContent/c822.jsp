...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/cguias_search?f1=&f2=&tipo_dte=822'">VOLVER</button> 
...
<div class="content" >
	...
	<div class=" cuadroblanco" style="height:160px;margin-top: 5px;padding: 5px 5px 5px 5px">
		<div class="divhead"><strong>N DE IMPRESIONES:</strong><input type="text" name="fac_servim_n_impresiones" id="fac_servim_n_impresiones" onkeydown="return validateNum(event)" class="" maxlength="10" style="width:130px;height:30px ;background:#FFF;" value="<%=n_impresiones%>" readonly="readonly"></div>
		...
		<input type="hidden" name="empresa_emisora_nombre" id="empresa_emisora_nombre"  value="<%=emi %>" >
			...
			<input type="hidden" name="folio_prev" id="folio_prev" value="<%=GD_FOLIO%>">
