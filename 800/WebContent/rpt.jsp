...
padding: 5px 5px 5px 5px;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <p >REPORTE GENERADOR DOCUMENTO DTE</p>
                    </div>
  ...
  <div class="content" >
         ...
         <input type="hidden" name="id_g" value="<%=request.getParameter("id_g")%>">
                                ...
                                <div class="divhead"><strong >INFORME:</strong><select name="informe" id="informe" class="informe" style="width: 600px">
  <option value="1" selected="selected" >1.- REPORTE DTE EMITIDOS</option>
      ...
      <div class="divhead"><strong >EMISOR:</strong><select name="select_empresa_e" id="select_empresa_e">
       ...
       <div class="divhead"><strong >TIPO DOC:</strong><select name="select_tdoc" id="select_tdoc">
			   <option value="" selected="selected">TODOS</option>
			   
			   <option value="33" >FACTURA ELECTRONICA AFECTA</option>
			   ...
			   <option value="30" >FACTURA AFECTA</option>
			   <option value="32" >FACTURA EXENTA</option>
			   
			   <option value="39" >BOLETA ELECTRONICA AFECTA</option>
