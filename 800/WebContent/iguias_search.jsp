...
String url="";
if(tdte.equals("801")){ url = "iguias";}
if(tdte.equals("802")){ url = "iguias_res";}
if(tdte.equals("803")){ url = "ifac_servim";}
if(tdte.equals("804")){ url = "ifac_servotros";}
if(tdte.equals("811")){ url = "ifac_act";}
if(tdte.equals("812")){ url = "ifac_serv";}
if(tdte.equals("821")){ url = "iguias_venta";}
if(tdte.equals("822")){ url = "iguias_ventaserv";}
if(tdte.equals("823")){ url = "N800_I_03_001_823";}
if(tdte.equals("824")){ url = "iguias_dest";}
if(tdte.equals("841")){ url = "i841";}
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/iguias_stipo'">VOLVER</button> 
...
<div class="content">
<form action="iguias_search" name="form1" method="get">
	...
	<div class="containermenu">
		<div class="menu">
			<div class="titulomenu" style="border: 1px solid black;">
				...
				<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR DOCUMENTO PARA SII</p> </h3>
			</div>
...
<td width="700px" style="font-size:20px"><strong>CLIENTE</strong></td>
<td width="130px" style="font-size:20px"><strong>MONTO</strong></td>
<td width="150px" style="font-size:20px"><strong>FECHA</strong></td>
<td width="90px" style="font-size:20px"><strong>ESTADO BIRT</strong></td>
<td width="150px" style="font-size:20px"><strong>ESTADO SII</strong></td>						
					...
					%>        		
						<tr class="hov" onclick="location='<%=url %>?d_id=<%=Alertas[0]%>';">
