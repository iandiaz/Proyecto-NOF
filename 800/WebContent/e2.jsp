...
if(tdte.equals("821")){ url = "e821";}
if(tdte.equals("822")){ url = "e822";}
if(tdte.equals("823")){ url = "e823";}
if(tdte.equals("824")){ url = "e824";}
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/e1'">VOLVER</button> 
