...
String guia_des_traszf_id =(String)request.getAttribute("824_id");
...
String ref =(String)request.getAttribute("numticket");
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/iguias_search?tipo_dte=824'">VOLVER</button> 
	<div align="center" class="title">
		<p >INGRESAR GENERADOR DOCUMENTO DTE</p>
	</div>
</div>
<div class="content" >
  <form action="iguias_dest" name="form1" method="post">
  <input type="hidden" name="guia_des_traszf_id" value="<%=guia_des_traszf_id%>" >
	...
	<div class=" cuadroblanco" style="height:160px;margin-top: 5px;">
		...
		<div style="padding: 5px 5px 5px 5px"><div class="divhead"><strong>RAZON SOCIAL:</strong><input type="text" style="width:600px;height:30px ;background:#FFF;" disabled="disabled" value="<%=nom1%>"></div>
	...
	<div style="padding: 5px 5px 5px 5px;">
		...
		<div class="divhead" ><strong>GLOSA DESCUENTO:</strong><input type="text"  style="width:350px;height:30px ;background:#FFF;"  value="<%=gr_glosa_desc %>" disabled="disabled" ></div>
