...
String folionc=(String)request.getAttribute("folionc");	
if(folionc==null) folionc="ND";
...
String n_impresiones=(String)request.getAttribute("n_impresiones");	
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/iguias_search?tipo_dte=841'">VOLVER</button> 
...
<div class="content" >
  <form action="" name="form1" id="form1" method="post" > 
	...
	<div class="divhead"><strong>NRO.NC:</strong><input type="text" name="folio" id="folio" style="width:80px;height:30px ;background:#FFF;"  value="<%=folionc%>" readonly="readonly" ></div>
	...
	<div class=" cuadroblanco" style="height:120px;margin-top: 5px;">
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>N DE IMPRESIONES:</strong><input type="text"  maxlength="10" style="width:130px;height:30px ;background:#FFF;" value="<%=n_impresiones%>" disabled="disabled"></div>
		...
		-->
          <button type="submit" value="graba" name="grabar" id="grabar" class="btn btn-success" onclick="return validateSubmit();" >ENVIAR AL SII</button>
       </div> 
	</div>
	</div>
