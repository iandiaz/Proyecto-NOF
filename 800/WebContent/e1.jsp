...
<div class="content">
<form action="e2" name="form1" method="get">
	...
	<div class="containermenu">
		<div class="menu" style="width:800px">
			<div class="titulomenu" style="border: 1px solid black; width:800px">
				...
				<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:798px">ELEGIR MODULO A ELIMINAR DTE</p> </h3>
			</div>
...
<% 
					...
					%>        		
						<tr class="hov" onclick="document.getElementById('tipo_dte').value='<%=Alertas[0]%>';document.form1.submit();">
