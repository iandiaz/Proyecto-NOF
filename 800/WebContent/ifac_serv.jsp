...
String FAC_ESTADO=(String)request.getAttribute("FAC_ESTADO");
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/iguias_search?tipo_dte=812'">VOLVER</button> 
	<div align="center" class="title">
		<p >INGRESAR GENERADOR DOCUMENTO DTE</p>
	</div>
</div>
<div class="content" >
  <form action="ifac_serv" name="form1" method="post">
  <input type="hidden" name="fact_id" value="<%=fact_id%>" style="width:80px;height:30px ;background:#FFF;">
  <input type="hidden" name="tdte" value="<%=tdte%>" >
	...
	<div style="padding: 5px 5px 5px 5px;">
		...
		<div class="bgrabar">
          <button type="submit" name="grabar" id="grabar" class="btn btn-success" <% if(FAC_ESTADO.equals("EMITIDA")){ %>disabled<% } %> >GRABAR</button>
       </div>
