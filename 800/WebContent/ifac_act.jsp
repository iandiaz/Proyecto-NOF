...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/iguias_search?f1=&f2=&tipo_dte=811'">VOLVER</button> 
	<div align="center" class="title">
		<p>INGRESAR GENERADOR DOCUMENTO DTE</p>
	</div>
</div>
<div class="content" >
  <form action="ifac_act" name="form1" method="post">
  <input type="hidden" name="fact_id" value="<%=FACT_ID%>" >
  <input type="hidden" name="tdte" value="<%=fac_servim_tipodte%>" >   
