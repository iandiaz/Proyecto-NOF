	...
	<div class="containermenu">
		<div class="menu" style="width:800px">
			<div class="titulomenu" style="border: 1px solid black; width:800px">
				...
				<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:798px">ELEGIR DOCUMENTO</p> </h3>
			</div>
			<div style="max-height:400px; width:800px;">
				<table class="table" style="margin-left:0px">
					...
					<td width="750px" style="font-size:20px"><strong>TIPO DOCUMENTO</strong></td>
					</tr>  
...
<% 
					...
					for(int i =0; i<arAlertas.length; i++){
						...
						if(Alertas[2].equals("0")){
							col ="";
						}else{
							col = "style='background-color:#FF0000;color:white'";
						}
					%>        		
						<tr class="hov" <%=col%> onclick="document.getElementById('tipo_dte').value='<%=Alertas[0]%>';document.form1.submit();" >
							<td width="50px" ><%=Alertas[0]%></td>
							<td width="750px" ><%=Alertas[1]%></td>
						</tr>
			        	<% 
			        	col="";
			        	} %>
