...
String guia_des_tras_normal_id =(String)request.getAttribute("823_id");
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/800/cguias_search?f1=&f2=&tipo_dte=823'">VOLVER</button> 
	<div align="center" class="title">
		<p >ELIMINAR GENERADOR DOCUMENTO DTE</p>
	</div>
</div>
<div class="content" >
  ...
  <input type="hidden" name="guia_des_tras_normal_id" value="<%=guia_des_tras_normal_id%>" >
	...
	<div class=" cuadroblanco" style="height:160px;margin-top: 5px;">
	<div style="padding: 5px 5px 5px 5px">
		<div class="divhead"><strong>NUMERO DE TICKET:</strong><input type="text" name="ref" value="<%=numticket %>" style="width:750px;height:30px ;background:#FFF;" disabled></div>
