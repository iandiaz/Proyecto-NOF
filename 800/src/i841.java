...
/**
 * Servlet implementation class i841
 */
@WebServlet("/i841")
public class i841 extends HttpServlet {
			...
			try {
				...
				System.out.println("Docs: "+FID);
				 ...
				 String SQL_DATOS="SELECT"
					 		...
					 		+ "		`841`.`841_dondedice`, "
					 		+ "		`841`.`841_debedecir`, "
					 		+ "		DATE_FORMAT(`841`.`841_fecha`,'%Y-%m-%d') as 841_fecha, "
					 		+ "		`841`.`841_tipodte`, "
					 		+ "		`841`.`841_empresa_emisora`, "
					 		+ "		`841`.`841_obs0`, "
					 		+ "		`841`.`841_obs1`, "
					 		+ "		`841`.`841_obs2` "
					 		+ " , 	if(`841`.`tipo_dteref` is null,'',`841`.`tipo_dteref`) as  tipo_dteref  "
							+ " , `841`.folioref "
							+ " , DATE_FORMAT(`841`.fec_ref,'%Y-%m-%d') as fec_ref  "
							...
							+ "	,	`841`.`841_iva` "
							+ "	,	`841`.`841_total` "
							+ "	,	`841`.`841_glosa_descuento` "
							+ "	,	`841`.`841_razon_nc` "
							+ "	,	`841`.`841_tipo_cambio` "
							+ "	,	`841`.`841_n_impresiones` "
							
							
			
					 		+ "	FROM"
					 		+ "		`841`"
					 		+ " LEFT JOIN USUARIOS ON `841`.`841_USU_EMISION` = USUARIOS.USUARIOS_ID"
				...
				String tipodte=RS_DATOS.getString("841_tipodte");
				String fecha_fac = RS_DATOS.getString("841_fecha");
				//String condiciones = RS_DATOS.getString("801_CONDICIONES").replace(";", "");
				
				String neto=RS_DATOS.getString("841_neto").replace(";", "");
				String iva=RS_DATOS.getString("841_iva").replace(";", "");
				String total = RS_DATOS.getString("841_total").replace(";", "");
				String descuento= RS_DATOS.getString("841_descuento").replace(";", "");
				if(descuento==null || descuento.equals(""))descuento="0";
				String glosa_descuento= RS_DATOS.getString("841_glosa_descuento").replace(";", "");
				
				String OBS0 = RS_DATOS.getString("841_obs0").replace(";", "");
					
				String OBS1 = RS_DATOS.getString("841_obs1").replace(";", "");
				String OBS2 = RS_DATOS.getString("841_obs2").replace(";", "");
				...
				String id_emp_emisora = RS_DATOS.getString("841_empresa_emisora");
				String razon_nc = RS_DATOS.getString("841_razon_nc");
				
				
				String codref=RS_DATOS.getString("CodigoRef");
				
				String dondedice=RS_DATOS.getString("841_dondedice");
				String debedecir=RS_DATOS.getString("841_debedecir");
				String M841_n_impresiones=RS_DATOS.getString("841_n_impresiones");
				...
				if(puedeenviar){
					 String encabezado="->Encabezado<-\r\n"+
					    		RS_DATOS.getString("841_tipodte")+";"+folio+";"+RS_DATOS.getString("841_fecha")+";0;0;"+
					    		RS_DATOS.getString("841_rut")+";"+RS_DATOS.getString("841_rz").replace(";", "")+";"+RS_DATOS.getString("841_giro").replace(";", "")+";"+
					    		RS_DATOS.getString("841_direccion").replace(";", "")+";"+RS_DATOS.getString("841_comuna")+";"+RS_DATOS.getString("841_ciudad")+";"+
					    ...
					    String SQL_INSERTe = "INSERT INTO dte_encabezado (TipoDTE, Folio,FechaEmision, TipoDespacho, IndTraslado, "
					    		...
					    		+ "DirCliente, ComCliente, CiuCliente, Email, Modulo,Codigo_relacionado,Condiciones,Region,Responsable,Tipo_cambio,Contacto,Telefono,empresa_emisora_id,cliente_id,n_impresiones) "
					    		+ "VALUES ('"+RS_DATOS.getString("841_tipodte")+"','"+folio+"','"+RS_DATOS.getString("841_fecha")+"','0','0'"
					    		+ ",'"+RS_DATOS.getString("841_rut")+"','"+RS_DATOS.getString("841_rz")+"','"+RS_DATOS.getString("841_giro")+"'"
					    		+ ",'"+RS_DATOS.getString("841_direccion")+"','"+RS_DATOS.getString("841_comuna")+"','"+RS_DATOS.getString("841_ciudad")+"'"
					    		+ ",'"+RS_DATOS.getString("cont_email")+"','841','"+request.getParameter("d_id")+"','','"+RS_DATOS.getString("regi_nombre").replace("'", "\'")+"'"
					    		+ " ,'','"+RS_DATOS.getString("841_tipo_cambio")+"' ,'"+RS_DATOS.getString("CONT_NOMBRE")+"','','"+id_emp_emisora+"','"+RS_DATOS.getString("clpr_id")+"','"+M841_n_impresiones+"')";
					    ...
					    String SQL_UPFAC = "UPDATE `841` SET id_dte = "+id_usu_last+" WHERE 841_ID = "+request.getParameter("d_id");
						...
						String SQL_DET = "SELECT "
								...
								+ " WHERE d.841_id= "+request.getParameter("d_id")+" AND d.estados_vig_novig_id=1";
						...
						int c=1;
						if(!codref.equals("2"))while(RS_DET.next()){
							...
							String detexento="0";
							if(tipo_dteref.equals("34")) detexento=RS_DET.getString("d841_valor");
							detalle+=c+""
									+ ";"+RS_DET.getString("d841_codigo")+""
									+ ";"+RS_DET.getString("d841_descripcion")+";1;"
				            		+ RS_DET.getString("d841_valor")+";0;0;0;0;"+detexento+";"
				            		+ RS_DET.getInt("d841_valor")+";INT1;UN;"+descLarga+";\r\n";
							...
							String SQL_INSERTd = "INSERT INTO dte_detalle (id_enc, NroLinea, Codigo, Descripcion, Cantidad, "
						    		...
						    		+ "VALUES ("+id_usu_last+","+c+",'"+RS_DET.getString("d841_codigo")+"','"+RS_DET.getString("d841_descripcion")+"',1,"
						    		+ ""+RS_DET.getString("d841_valor")+",0,0,0,0,'"+detexento+"',"+RS_DET.getString("d841_valor")+","
						    		+ "'INT1','UN','"+descLarga+"')";
							...
							detalle+=c+""
									+ ";0"
									+ ";DONDE DICE "+dondedice+" DEBE DECIR "+debedecir+";1;"
				            		+ "0;0;0;0;0;0;"
				            		+ "0;INT1;UN;;\r\n";
							...
							String SQL_INSERTd = "INSERT INTO dte_detalle (id_enc, NroLinea, Codigo, Descripcion, Cantidad, "
									+ "Precio, PorcDescto, ValorDescto, PorcRecgo, ValorRecgo, ValorExento, Valor, "
									+ "TipoCodigo, UniMedida, DescLarga) "
						    		+ "VALUES ("+id_usu_last+","+c+",'0','DONDE DICE "+dondedice+" DEBE DECIR "+debedecir+"',0,"
						    		+ "0,0,0,0,0,0,0,"
						    		+ "'INT1','UN','')";
							System.out.println(SQL_INSERTd);
						    stategrabar.executeUpdate(SQL_INSERTd);
					    ...
					    String SQL_801 = "UPDATE `841` SET 841_folio = '"+folio+"' WHERE 841_ID = "+request.getParameter("d_id");
					    ...
					    if(!tipo_dteref.equals("")){
					    	    referencia="->Referencia<-\r\n"+"1;"+tipo_dteref+";"+folioref+";"+fec_ref+";"+codref+";"+razon_nc+";\r\n";
							    ...
							    String SQL_INSERTr = "INSERT INTO dte_referencia (id_enc, NroLineaRef, TipoDTERef, FolioRef, FechaRef, CodigoRef, RazonRef) "
							    		+ "VALUES ("+id_usu_last+",1,'"+tipo_dteref+"','"+folioref+"','"+fec_ref+"','"+codref+"','"+razon_nc+"')";
			        	...
			        	if(codref.equals("2")){
			        		...
			        		data=encabezado+""+totales+""+detalle+""+referencia+""+obs+"\r\n";
							
			        	}// data=encabezado+""+detalle+""+referencia+""+obs+"\r\n";
						...
						Writer outFile = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(""+directorio+tipodte+"_841_"+request.getParameter("d_id")+"_"+folio+"_"+id_emp_emisora+".txt"),"UTF-8"));
						outFile.write(data);
						outFile.close();
			...
			request.setAttribute("d_id", request.getParameter("d_id"));
			 ...
			 String f_nc_sql="SELECT"
				    ...
				    if(f_nc_RS.next()){
				    	...
				    	request.setAttribute("n_impresiones", f_nc_RS.getString("841_n_impresiones"));
				    ...
				    String SQL_DETT = "SELECT * FROM detalle_841 WHERE 841_id = "+request.getParameter("d_id");
				    ...
				    if(modref.equals("801")){
			 		   ...
			 		   while(RS_DATOSD.next()){
			 			   ...
			 			   if(tref.equals("3")){
			 				   ...
			 				   String SQL_DETTALLE = "SELECT * FROM detalle_841 WHERE 841_id = "+request.getParameter("d_id")+" AND d841_idref="+RS_DATOSD.getString("DETIF_ID");
...
//						   
			           ...
			           RequestDispatcher rd = request.getRequestDispatcher("i841_801.jsp");
						 ...
						 String SQL_CAB = "SELECT 	g.802_folio,"
						    ...
						    while(RS_DETALLE.next()){
						    	 ...
						    	 int valor= RS_DETALLE.getInt("d802_TOTAL");
					 			   if(tref.equals("3")){
					 				   //sacamos el valor de la tabla de 841 
					 				   String SQL_DETTALLE = "SELECT * FROM detalle_841 WHERE 841_id = "+request.getParameter("d_id")+" AND d841_idref="+RS_DETALLE.getString("d802_id");
					 				    System.out.println(SQL_DETTALLE);
					 				    ResultSet DETTALLE_RS = stateDet.executeQuery(SQL_DETTALLE);
					 				    if(DETTALLE_RS.next()) valor= DETTALLE_RS.getInt("d841_valor");
				            ...
				            RequestDispatcher rd = request.getRequestDispatcher("i841_802.jsp");
				            rd.forward(request, response);
					 }
				    ...
				    if(modref.equals("803")){
						 ...
						 String SQL_CAB = "SELECT "
						    ...
						    String SQL_DET = "SELECT * FROM detalle_803 WHERE estados_vig_novig_id=1 AND 803_id = "+id;
						    //System.out.println(SQL_DET);
						    ...
						    while(DET_RS.next()){ 
						    	 ...
						    	 int valor= DET_RS.getInt("d803_valor");
					 			   if(tref.equals("3")){
					 				   //sacamos el valor de la tabla de 841 
					 				   String SQL_DETTALLE = "SELECT * FROM detalle_841 WHERE 841_id = "+request.getParameter("d_id")+" AND d841_idref="+DET_RS.getString("d803_id");
					 				    System.out.println(SQL_DETTALLE);
					 				    ResultSet DETTALLE_RS = stateDet.executeQuery(SQL_DETTALLE);
					 				    if(DETTALLE_RS.next()) valor= DETTALLE_RS.getInt("d841_valor");
...
//						   
				            ...
				            RequestDispatcher rd = request.getRequestDispatcher("i841_803.jsp");
				            rd.forward(request, response);
					 }
						 ...
						 String SQL_CAB = "SELECT "
						    ...
						    while(DET_RS.next()){
						    	 int valor= DET_RS.getInt("d804_valor");
					 			   if(tref.equals("3")){
					 				   //sacamos el valor de la tabla de 841 
					 				   String SQL_DETTALLE = "SELECT * FROM detalle_841 WHERE 841_id = "+request.getParameter("d_id")+" AND d841_idref="+DET_RS.getString("d804_id");
					 				    System.out.println(SQL_DETTALLE);
					 				    ResultSet DETTALLE_RS = stateDet.executeQuery(SQL_DETTALLE);
					 				    if(DETTALLE_RS.next()) valor= DETTALLE_RS.getInt("d841_valor");
...
//						   
				            statecor.close();
				            conexion.close();
				            RequestDispatcher rd = request.getRequestDispatcher("i841_804.jsp");
				            rd.forward(request, response);
					 }
