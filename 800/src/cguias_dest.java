...
/**
 * Servlet implementation class cguias_dest
 */
@WebServlet("/cguias_dest")
public class cguias_dest extends HttpServlet {
	...
	public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
			...
			try {
	    		...
	    		System.out.println(SQL_Cliente);
	 		    ...
	 		    if(CLIENTE_RS.next()){
			    	...
			    	request.setAttribute("folio", CLIENTE_RS.getString("824_folio"));
		...
		RequestDispatcher rd = request.getRequestDispatcher("cguias_dest.jsp");
