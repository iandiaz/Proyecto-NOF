...
import DAO.DteReferenciasDAO;
import DAO.DteTotalesDAO;
import DAO.DtesDAO;
import VO.DteDetalleVO;
import VO.DteReferenciaVO;
 ...
 */
@WebServlet("/C03_001_801")
public class C03_001_801 extends HttpServlet {
	...
	public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		DteReferenciaVO dte_referencia= DteReferenciasDAO.getDteReferencia(id_dte);
		...
		request.setAttribute("dte_referencia", dte_referencia);
		
		
		
		
		RequestDispatcher rd = request.getRequestDispatcher("C03_001_801.jsp");
