...
padding: 5px 5px 5px 5px;
  ...
  <div class="content" >
         ...
         <input type="hidden" name="id_g" value="<%=request.getParameter("id_g")%>">
                                ...
                                <div class="divhead"><strong >INFORME:</strong><select name="informe" id="informe" class="informe" style="width:500px;">
  <option value="1" selected="selected" >1.- REPORTE SUB-UBICACION</option>
