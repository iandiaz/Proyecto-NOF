...
if(request.getAttribute("grupos_nombre")!=null && !request.getAttribute("grupos_nombre").equals("")) grupos_nombre =(String) request.getAttribute("grupos_nombre");
...
<!-- VALIDANDO QUE LOS CAMPOS VALLAN CON ALGO -->
	...
	function validarIngreso(){
		...
		alert('DEBE INGRESAR UN NOMBRE DE TIPO CONTRATO');
 ...
 <% 
  if(request.getParameter("Exito")!=null && !request.getParameter("Exito").equals("")){
  		if(request.getParameter("Exito").equals("NOK")){
			out.println("<script>alert('EL NOMBRE DE TIPO CONTRATO YA EXISTE')</script>");
	...
	%>
    <meta charset="utf-8">
    <title>New Office - SUB-UBICACIONES</title>
...
margin: 0 auto;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/012/msubu1'">VOLVER</button>
                   
                    <div align="center" class="title" >
                    <p >MODIFICAR SUB-UBICACION</p>
                    </div>
  ...
  <tr>
    <td >
    	<div class="divhead"><strong >ID:</strong><input type="text" value="<%=grupos_id %>" style="width:50px;height:30px; background:#FFF;color: #000;" disabled="disabled"></div>
    </td>
  </tr>
  <tr>
    <td><div class="divhead"><strong>EMPRESA:</strong><input type="text" style="width:350px;height:30px ;background:#FFF;"  value="<%=empresas_nombrenof %>" disabled="disabled" ></div> 
 	</td>
  </tr>
  <tr>
    <td><div class="divhead"><strong>DIRECCION:</strong><input type="text" style="width:350px;height:30px ;background:#FFF;" value="<%=DIRE_DIRECCION %>" disabled="disabled" ></div> 
 	</td>
  </tr>
  <tr>
    <td><div class="divhead"><strong>UBICACION:</strong><input type="text" style="width:350px;height:30px ;background:#FFF;" name="ubi_fisica" id="ubi_fisica" value="<%=ubi_fisica %>" disabled="disabled" ></div> 
 	</td>
  </tr>  <tr>
    <td><div class="divhead"><strong>SUB-UBICACION:</strong><input maxlength="20" autofocus="autofocus" type="text" class="amarillo"  style="width:240px;height:30px ;background:#FF3;" name="tcon_nombre" id="tcon_nombre" value="<%=grupos_nombre %>" required >
