...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/012/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
  ...
  <div class="content">
        ...
        <div class="titulomenu" style="border: 1px solid black">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F;width:1198px">ELEGIR SUB-UBICACION A CONSULTAR</p> </h3>
...
<td width="350px" style="font-size:20px"  ><strong>EMPRESA</strong></td>
<td width="350px" style="font-size:20px"  ><strong>DIRECCION</strong></td>

<td width="350px" style="font-size:20px"  ><strong>UBICACION</strong></td>
<td width="350px" style="font-size:20px"  ><strong>SUB-UBICACION</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<arGrupos.length; i++){
			...
			<tr class="hov" style="color:<%=Grupos[3].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Grupos[3].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='csubu2?id_g=<%=Grupos[0]%>';" >
				<td width="80px"><%=Grupos[0]%></td>
				<td width="350px"><%=Grupos[6]%></td>
				<td width="350px"><%=Grupos[5]%></td>
				
				<td width="350px"><%=Grupos[1]%></td>
				<td width="350px"><%=Grupos[2]%></td>
				<td width="150px"><%=Grupos[4]%></td>
			</tr>
