...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/012/'">VOLVER</button> 
	<div align="center" class="title">
		<p >INGRESAR SUB-UBICACION</p>
	</div>
</div>
	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR UBICACION A INGRESAR SUB-UBICACION</p> </h3>
			</div>
...
<td width="200px" style="font-size:20px"><strong>EMPRESA</strong></td>

<td width="460px" style="font-size:20px"><strong>DIRECCION</strong></td>

<td width="400px" style="font-size:20px"><strong>UBICACION</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arGrupos.length; i++){
        	 String[] Alertas = arGrupos[i].split("/");
        	 %>
			<tr class="hov" style="color:<%=Alertas[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='isubu2?ubi_id=<%=Alertas[0]%>';">
				<td width="80px" ><%=Alertas[0]%></td>
				<td width="200px" ><%=Alertas[5]%></td>
				
				<td width="460px" ><%=Alertas[4]%></td>
				<td width="400px" ><%=Alertas[1]%></td>
