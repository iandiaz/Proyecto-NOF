...
<html lang="en">
  ...
  <div class="content">
        ...
        <div class="titulomenu" style="border: 1px solid black">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F;width:1198px">ELEGIR SUB-UBICACION A ELIMINAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<arGrupos.length; i++){
			...
			<tr class="hov" style="color:<%=Grupos[3].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Grupos[3].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='esubu2?id_g=<%=Grupos[0]%>';" >
