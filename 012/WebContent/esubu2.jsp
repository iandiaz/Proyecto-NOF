...
String ubi_nombre=(String)request.getAttribute("ubi_fisica");
...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/012/esubu1'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
                   
                    <div align="center" class="title" >
                    <p >ELIMINAR SUB-UBICACION</p>
                    </div>
  ...
  <table class="table-movil" border="0" align="center" style="height:300px;">
<tr>
  ...
  <tr>
	<td><div class="divhead"><strong>UBICACION:</strong><input type="text" value="<%=ubi_nombre%>" style="width:350px;height:30px; background:#FFF;color: #000;" disabled="disabled" >
					</div></td>
					
</tr>
<tr>
	<td><div class="divhead"><strong>SUB-UBICACION:</strong><input type="text" value="<%=grupos_nombre%>" style="width:240px;height:30px; background:#FFF;color: #000;" disabled="disabled" >
					</div></td>
...
<tr>
  ...
  <div class="bgrabar" >
           <button onclick="location='esubu2?delete_id=<%=grupos_id%>';" type="button" name="grabar" id="grabar" class="btn btn-success" >GRABAR</button>
           </div> 
       </div> 
