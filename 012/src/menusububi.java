...
/**
 * Servlet implementation class menusububi
 */
@WebServlet("/menusububi")
public class menusububi extends HttpServlet {
...
String SQL_PERFILES = "SELECT "
		...
		///////////////////////////////////////////////////////////
		RequestDispatcher rd = request.getRequestDispatcher("menusububi.jsp");
