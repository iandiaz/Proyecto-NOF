...
/**
 * Servlet implementation class isubu1
 */
@WebServlet("/isubu1")
public class isubu1 extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
		    ...
		    //consultamos por los grupos
    		 String SQL_Grupos = ""
		    		...
		    		+ " INNER JOIN estados_vig_novig ON ubicacion.estados_vig_novig_id = estados_vig_novig.estados_vig_novig_id "
		    		+ " INNER JOIN `empresas` ON `empresas`.`empresas_id` = `direccion`.`CLPR_ID` "
		    		+ " WHERE UBI_TIPO = 1 AND `ubicacion`.`ubi_usa_sububicacion`=1 "
		    		+ " ORDER BY ubicacion.ubi_fisica ASC";
		    ...
		    while(Grupos_RS.next()){        	   
		    	...
		    	grupos.add(Grupos_RS.getString("UBI_ID")+"/"+Grupos_RS.getString("ubi_fisica").replaceAll("/", " ")+"/"+Grupos_RS.getString("estados_vig_novig_id")+"/"+Grupos_RS.getString("estados_vig_novig_nombre")+"/"+Grupos_RS.getString("DIRE_DIRECCION").replaceAll("/", " ")+"/"+Grupos_RS.getString("empresas_nombrenof").replaceAll("/", " "));
		...
		RequestDispatcher rd = request.getRequestDispatcher("isubu1.jsp");
