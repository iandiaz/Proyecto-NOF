...
/**
 * Servlet implementation class msubu1
 */
@WebServlet("/msubu1")
public class msubu1 extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
		    ...
		    //consultamos por los grupos
    		 String SQL_Grupos = ""
 		    		...
 		    		+ " ubicacion.ubi_fisica, sububicacion.SUBI_NOMBRE, estados_vig_novig.estados_vig_novig_id, estados_vig_novig.estados_vig_novig_nombre,"
		...
		RequestDispatcher rd = request.getRequestDispatcher("msubu1.jsp");
