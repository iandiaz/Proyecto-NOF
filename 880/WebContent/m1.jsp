...
String Usu_nom=(String)request.getAttribute("usuname");	
	...
	String[] ar_adm =(String[]) request.getAttribute("ar_adm");
...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <form method="get" action="Mclpr" style="margin: 0px 0px 0px 0px;">                 
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button type="button" onclick="location='/880/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR PERIODO A MODIFICAR</p> </h3>
...
<td width="120px" style="font-size:20px"  ><strong>A&Ntilde;O</strong></td>
<td width="120px" style="font-size:20px"><strong>MES</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<ar_adm.length; i++){
        	 String[] adm = ar_adm[i].split("/");
        	 	 String estado = adm[3].equals("1")? "VIGENTE":"NO VIGENTE";
        	 %>
        		
			<tr class="hov" style="color:<%=adm[3].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=adm[3].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='m2?id=<%=adm[0]%>';">
				<td width="47px"><%=adm[0]%></td>
				<td width="120px"><%=adm[1]%></td>
				<td width="120px"><%=adm[2]%></td>
				<td width="155px"><%=estado%></td>
			</tr>
