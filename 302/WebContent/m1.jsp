...
<div align="center" class="form-group has-warning" style="font-size: 20px"> 
 ...
 <table  class="table004det" style="margin: 0 auto;float: none;width: 400px">
  ...
  <tr>
  <th scope="col" align="center"><input class="todos"  type="checkbox" onclick="toggleTodos()"></th>
  ...
  <% 
	 ...
	 for(String usus_tick : usuarios_tick){
		...
		try{
		 ...
		 %>
			 <tr>
			 <td class="int" align="center"><input class="dale" name="usus[]" value="<%=usu_t_ar[0]%>" type="checkbox" <% if(selecciones_usu.contains(usu_t_ar[0])){%> checked="checked" <%} %>  ></td>
