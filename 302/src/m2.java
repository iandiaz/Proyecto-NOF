...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		if(request.getParameter("grabar") !=  null){
			try {
	    		...
	    		while(ticketusu_rs.next()){
	    			  ...
	    			  String prioridad=request.getParameter("prio_"+ticketusu_rs.getString("TICK_ID"));	
	    			  String r =request.getParameter(ticketusu_rs.getString("TICK_ID")+"_r");
	    			  String vis =request.getParameter(ticketusu_rs.getString("TICK_ID")+"_visible");
		      		  
	    			  if(r==null || r.equals("")) r="0";
	    			  
	    			  if(vis==null || vis.equals("")) vis="0";
	    			  
	    			  if(prioridad==null || prioridad.equals("")) prioridad="NULL";
	    			  
	    			  String in="update `adm_tecnicos` SET admt_prioridad="+prioridad+" , admt_req_repuesto="+r+",admt_visible="+vis+"  WHERE  admt_ticket='"+ticketusu_rs.getString("TICK_ID")+"' ";
		...
		try {
    		...
    		ResultSet USUS_RS = state.executeQuery(find_usus_sql);
      		while(USUS_RS.next()){
      			iniciales+=",'"+USUS_RS.getString("admt_s_ususelect").trim()+"' ";
    		...
    		while(ticketusu_rs.next()){
	    		...
	    		if(!existe){
	    			...
	    			String in="INSERT INTO `adm_tecnicos` ("
	    					...
	    					+ "	,'"+ticketusu_rs.getString("DETI_EMPRESA")+"'"
	    			...
	    			String up=" UPDATE `adm_tecnicos` "
	    					...
	    					+ "		,admt_tiempo='"+ticketusu_rs.getString("DiffDate")+"'"
