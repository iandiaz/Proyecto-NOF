...
/**
 * Servlet implementation class cperusu
 */
@WebServlet("/cperusu")
public class cperusu extends HttpServlet {
	...
	private void mt_detail(HttpServletRequest request,
		...
		try {
		  ...
		  //System.out.println("SIZE LIST: "+menus.size());
                ...
                RequestDispatcher a = request.getRequestDispatcher("cperusu_det.jsp");
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        ...
        RequestDispatcher a = request.getRequestDispatcher("cperusu.jsp");
    	a.forward(request, response);
