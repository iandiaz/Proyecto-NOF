...
/**
 * Servlet implementation class eperusu
 */
@WebServlet("/eperusu")
public class eperusu extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!sesion_valida) response.sendRedirect("/001/");
			...
			//validamos si esta eliminando 
			String id_perusu_del=request.getParameter("id_p");
			if(id_perusu_del!=null && !id_perusu_del.equals("")){
				
				deletePerfilUsuario(request,response,id_perusu_del );
			}
			response.sendRedirect("/004/eperusu");
		}
...
private void deletePerfilUsuario(HttpServletRequest request,
			HttpServletResponse response, String id_perusu_del) throws ServletException, IOException {
		// TODO Auto-generated method stub
	...
	try {
		...
		//insrtamos en birt
		 ...
		 if(Constantes.SYNCDB==1){
			 System.out.println("SYNCRONIZACION ACTIVADA ");
	    ...
	    String SQL_PERFILES = " UPDATE `perfilusu` "
	    		+ " SET `perfilusu`.`estados_vig_novig_id` = 2, "
...
PrintWriter out = response.getWriter();
	...
	try {
	  ...
	  //System.out.println("SIZE LIST: "+menus.size());
            ...
            RequestDispatcher a = request.getRequestDispatcher("eperusu_det.jsp");
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        ...
        RequestDispatcher a = request.getRequestDispatcher("eperusu.jsp");
    	a.forward(request, response);
