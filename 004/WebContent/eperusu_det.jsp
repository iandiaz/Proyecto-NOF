...
right: 10px;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <form method="get" action="eperusu" style="margin: 0px 0px 0px 0px;">       
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                     	</form>  
                    <button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/004/eperusu'">VOLVER</button>
  ...
  <div class="content">
        <form action="" method="post"   >
         ...
         <div class="divhead">
				<strong>CORRELATIVO:</strong><input type="text" value="<%=correlativo %>" style="width:50px;height:30px; background:#FFF; margin: 0px 0px 0px 0px; color: black;" disabled="disabled" readonly="readonly">
		    </div>       
		   
		    
		    <div class="divhead">
		 		<strong>ESTADO:</strong><input type="text" value="<%=estado_vignovig %>"  style="width:140px;height:30px; background:#FFF;margin: 0px 0px 0px 0px;color: black;" disabled="disabled" readonly="readonly">
			   
 		    </div>
 		    
 		    <div class="divhead" style=" min-width: 500px;" >
		     	<strong >NOMBRE PERFIL USUARIO:</strong><input type="text" value="<%=per_name %>"  style="width:290px;height:30px; background:#FFF;margin: 0px 0px 0px 0px;color: black;" disabled="disabled" readonly="readonly">
			</div>
  ...
  <tr>
    ...
    <td class="int" align="center"  width="32px"><input id="permisos" name="permisos[]" value="<%=modulos[3]==null? "":modulos[3] %>" type="checkbox" disabled="disabled"></td>
    <td class="int" align="center" width="32px"><input id="permisos" name="permisos[]" value="<%=modulos[4]==null? "":modulos[4]%>" type="checkbox" disabled="disabled"></td>
    <td class="int" align="center" width="32px"><input id="permisos" name="permisos[]" value="<%=modulos[5]==null? "":modulos[5]%>" type="checkbox" disabled="disabled" ></td>
   <td class="int" align="center" width="32px"><input id="permisos" name="permisos[]" value="<%=modulos[6]==null? "":modulos[6]%>" type="checkbox" disabled="disabled"></td>
    <td class="int" align="center" width="32px"><% if(modulos[7].equals("-1")){%><input name="permisos[]" value="<%=modulos[7]==null? "":modulos[7]%>"  type="checkbox" disabled="disabled">
     <% }else{%>
	...
	<div style="display: none;width: auto;" class="div<%=i%> divrep">
    	...
    	for(int x=0 ; x<per_repotes_ar.length;x++ ){
    		...
    		%>
    		<p><input name="permisos[]" value="<%=date_rep[0]%>"  type="checkbox" disabled="disabled"><%=date_rep[1]%></p>
    	<% } %>
    	</div> 	
   <% } %></td>
  </tr>
