...
right: 10px;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/004/cperusu'">VOLVER</button>
                   
                    <div align="center" class="title" >
                    <p >CONSULTAR PERFIL USUARIO</p>
                    </div>
  ...
  <tr>
   ...
   <td class="int" align="center" width="32px"><input id="permisos" name="permisos[]" value="<%=modulos[6]==null? "":modulos[6]%>" type="checkbox" disabled="disabled"></td>
    <td class="int" align="center" width="32px"><% if(modulos[7].equals("-1")){%><input value="<%=modulos[7]==null? "":modulos[7]%>"  type="checkbox" disabled="disabled">
     <% }else{%>
