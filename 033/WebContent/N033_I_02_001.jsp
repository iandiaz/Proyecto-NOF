...
margin: 0 auto;
    ...
    $( document ).ready(function() {
    	...
    	$( "#rc_fecha_fact,#rc_fecha_gd,#rc_fecha" ).datepicker({ dateFormat: "dd-mm-yy", monthNames: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'],
  ...
  <form action="" name="form1" method="post" id="form1" > 
  	...
  	<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><span style="margin:0px 0px;font-size:20px;">DATOS DE LA RECEPCION</span> </h3>
		...
		<div style="padding: 5px 5px 5px 5px;">
			...
			<div class="divhead vertical-middle"><strong>VALOR T/C:</strong><input type="text" class="amarillo" maxlength="8" style="width:100px;height:30px ;" id="rc_tcambio_ref" name="rc_tcambio_ref" value="${rc.tcambio_ref}" onkeydown="return onlyNum(event)"><span class="cabecera" style="color:#F00"> *</span></div>
			
			<div class="divhead vertical-middle"><strong>NRO. GUIA DESPACHO:</strong><input type="text" class="amarillo" maxlength="35" style="width:370px;height:30px ;" id="rc_nro_gd" name="rc_nro_gd" value="${rc.nro_guia_despacho}"><span class="cabecera" style="color:#F00"> *</span></div>
			...
			<div class="divhead vertical-middle"><strong>TOTAL:</strong><input type="text" class="amarillo" maxlength="8" style="width:100px;height:30px ;" id="rc_total_gd" name="rc_total_gd" value="${rc.total_guia_despacho}" onkeydown="return onlyNum(event)"><span class="cabecera" style="color:#F00"> *</span></div>
			
			<div class="divhead vertical-middle"><strong>NRO. FACTURA:</strong><input type="text" class="amarillo" maxlength="35" style="width:370px;height:30px ;" id="rc_nro_fact" name="rc_nro_fact" value="${rc.nro_factura}"><span class="cabecera" style="color:#F00"> *</span></div>
			<div class="divhead vertical-middle"><strong>FECHA FACTURA:</strong><input type="text" class="amarillo" style="width:120px;height:30px ;" id="rc_fecha_fact" name="rc_fecha_fact"  value="${rc.fecha_factura}" readonly="readonly"><span class="cabecera" style="color:#F00"> *</span></div>
			<div class="divhead vertical-middle"><strong>TOTAL:</strong><input type="text" class="amarillo" maxlength="8" style="width:100px;height:30px ;" id="rc_total_fact" name="rc_total_fact" value="${rc.total_factura}" onkeydown="return onlyNum(event)"><span class="cabecera" style="color:#F00"> *</span></div>
	...
	<div class=" cuadroblanco" style="height:auto;margin-top: 5px;overflow: auto; min-height: 50px">
  	<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><span style="margin:0px 0px;font-size:20px;">DATOS DE LOS PRODUCTOS SOLICITADOS </span> </h3>
		...
		<div class="divhead vertical-middle"><button type="button" class="btn btn-success loadingButton" style="display: none" >CARGANDO...</button></div>
		
		<br><br><br>
		<table class="table noloading" style="margin-left:0px; margin: 0 auto; ">
	...
	<div class=" cuadroblanco" style="height:auto;margin-top: 5px;overflow: auto; min-height: 50px">
  	<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><span style="margin:0px 0px;font-size:20px;">TOTAL DE RECEPCION DE COMPRA</span></h3>
	
		<div style="padding: 5px 5px 5px 5px;">
			
			<div class="divhead vertical-middle"><strong>FACTURA TOTAL NETO:</strong><input type="text" maxlength="20" style="width:220px;height:30px ;" id="oc_neto" name="oc_neto" readonly="readonly"><span class="cabecera" style="color:#F00"> *</span></div>
			...
			<div class="divhead vertical-middle"><strong>RECEPCION TOTAL NETO:</strong><input type="text" maxlength="20" style="width:220px;height:30px ;" id="oc_neto" name="oc_neto" readonly="readonly"><span class="cabecera" style="color:#F00"> *</span></div>
			<div class="divhead vertical-middle"><strong>IVA:</strong><input type="text" maxlength="20" style="width:220px;height:30px ;" id="oc_iva" name="oc_iva" readonly="readonly" ><span class="cabecera" style="color:#F00"> *</span></div>
			<div class="divhead vertical-middle"><strong>TOTAL:</strong><input type="text" maxlength="20" style="width:220px;height:30px ;" id="oc_total" name="oc_total" readonly="readonly" ><span class="cabecera" style="color:#F00"> *</span></div>
			
			<div class="divhead vertical-middle"><strong>DIFERENCIA TOTAL NETO:</strong><input type="text" maxlength="20" style="width:220px;height:30px ;" id="oc_neto" name="oc_neto" readonly="readonly"><span class="cabecera" style="color:#F00"> *</span></div>
			<div class="divhead vertical-middle"><strong>IVA:</strong><input type="text" maxlength="20" style="width:220px;height:30px ;" id="oc_iva" name="oc_iva" readonly="readonly" ><span class="cabecera" style="color:#F00"> *</span></div>
			<div class="divhead vertical-middle"><strong>TOTAL:</strong><input type="text" maxlength="20" style="width:220px;height:30px ;" id="oc_total" name="oc_total" readonly="readonly" ><span class="cabecera" style="color:#F00"> *</span></div>
