...
/**
 * Servlet implementation class mguia_search
 */
@WebServlet("/mguia_search")
public class mguia_search extends HttpServlet {
	...
	public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
    		...
    		String SQL_Alertas = "SELECT g.823_folio,g.823_id,g.823_total, e.empresas_nombrenof, d1.DIRE_DIRECCION, "
		...
		RequestDispatcher rd = request.getRequestDispatcher("mguia_search.jsp");
