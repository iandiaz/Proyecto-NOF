	...
	public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		if(request.getParameter("grabar") != null){
			try {
				...
				//----------------- CABECERA -----------------------//
	    		String IDG=request.getParameter("guia_des_tras_normal_id");
			    ...
			    String SQL_GUIA = ""
			    		...
			    		+ "	 823_fecmod = now(),"
			    		+ "	 823_modificador = '"+Controlador.getUsuIDSession(request)+"'"
			    		+ "	WHERE"
			    		+ "		823_id = '"+IDG+"' ";
	    		...
	    		String log_sql=""
	    				...
	    				+ " ) "
	    				+ " VALUES "
	    				+ " (now(), 'USUARIO ESTABLECE NO VIGENTE REGISTRO "+IDG+" DE LA TABLA 823', '"+Controlador.getUsuIDSession(request)+"') ";
