...
/**
 * Servlet implementation class menuguia
 */
@WebServlet("/menuguia")
public class menuguia extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
    		...
    		String log_sql=""
    				...
    				+ " ) "
    				+ " VALUES "
    				+ " (now(), 'USUARIO INGRESA AL MENU DEL MODULO 823', '"+id_iusuario+"') ";
		...
		///////////////////////////////////////////////////////////
		RequestDispatcher rd = request.getRequestDispatcher("menuguia.jsp");
