...
<div class="content">        
	<div class="containermenu">
         <div class="menu">
			...
			<form method="post" action="I02_001" style="margin:0px 0px 0px 0px">
			...
			<input type="hidden" name="gv_fecha" value="<%=gv_fecha %>" >
			
        	<div style=" max-height:400px; width:1250px; ">
				<table class="table" style="height:340px; margin-left:0px; width:100%;">
				<thead style="border: 1px solid black">
					<tr style="background-color:#0101DF;color:#FFFFFF">
						<td width="10px" style="font-size:20px"><% if(arAlertas!=null && arAlertas.length <= 14){%> <input type="checkbox" class="allCheck"> <%} %></td>
				...
				%>
						<tr class="hov">
							<td width="10px" ><% if(!Alertas[13].equals("NO EXISTE")){%><input style="zoom:2.0;"  type="checkbox" <% if(Alertas[5].equals(Alertas[6])){ %> checked <% } %> value="<%=Alertas[0]%>;;<%=Alertas[6]%>;;<%=Alertas[1]%>;;<%=Alertas[2]%>;;<%=Alertas[3]%>;;<%=Alertas[4]%>;;<%=Alertas[7]%>;;<%=Alertas[8]%>;;<%=Alertas[9]%>;;<%=Alertas[10]%>;;<%=Alertas[11]%>;;<%=Alertas[12]%>;;<%=Alertas[13]%>" name="permisos[]" class="ck_deta"> <% } %></td>
