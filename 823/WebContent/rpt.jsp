...
String p222=(String)request.getAttribute("p222");
String p227=(String)request.getAttribute("p227");
...
padding: 5px 5px 5px 5px;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <p >REPORTE GUIA DE DESPACHO TRASLADO ACTIVOS NORMAL</p>
                    </div>
 ...
 <% if(p222.equals("1")){%><option value="1" selected="selected" >1.- REPORTE GUIA DE DESPACHO TRASLADO ACTIVOS NORMAL</option><%} %>
 <% if(p227.equals("1")){%><option value="2"  >2.- REPORTE GUIA DE DESPACHO TRASLADO ACTIVOS NORMAL DETALLE</option><%} %>
  ...
  <option value="" selected="selected">TODOS</option>
   <% for(int i =0; i<ar_grupos.length; i++){
    ...
    <div class="divhead fecs"><strong>Fec Desde:</strong><input maxlength="35" type="text" id="datepicker" name="f1" class="amarillo" style="width:130px;height:30px ;background:#FF3;" ></div>
            ...
            <div class="divhead fecs"><strong>TICKET:</strong><input maxlength="35" type="text" id="tick" name="tick" class="amarillo" style="width:130px;height:30px ;background:#FF3;" ></div>
