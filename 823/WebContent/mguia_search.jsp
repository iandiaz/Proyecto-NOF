	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR GUIA DE DESPACHO A MODIFICAR</p> </h3>
			</div>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
        	 ...
        	 %>
			<tr class="hov" style="color:<%=Alertas[5].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[5].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='mguia?guia_des_tras_normal_id=<%=Alertas[0]%>';">
