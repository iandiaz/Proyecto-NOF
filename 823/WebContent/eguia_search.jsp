...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/823/'">VOLVER</button> 
	<div align="center" class="title">
		<p >ELIMINAR GUIA DE DESPACHO TRASLADO ACTIVOS NORMAL</p>
	</div>
</div>
	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR GUIA DE DESPACHO A ELIMINAR</p> </h3>
			</div>
        	<div style=" max-height:300px; width:1250px; ">
  <table class="table" style="margin-left:0px; width:100%;">
<thead style="border: 1px solid black">
<tr style="background-color:#0101DF;color:#FFFFFF">
<td width="150px" style="font-size:20px"><strong>FOLIO</strong></td>
<td width="350px" style="font-size:20px"><strong>ENTIDAD DESTINO</strong></td>
<td width="500px" style="font-size:20px"><strong>DIRECCION</strong></td>
<td width="150px" style="font-size:20px"><strong>FECHA</strong></td>
<td width="150px" style="font-size:20px"><strong>TOTAL</strong></td>
<td width="200px" style="font-size:20px"><strong>ESTADO SII</strong></td>
</tr>  
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
        	 ...
        	 String valString = nf.format(Integer.parseInt(Alertas[6])).replace(",",".");
        	 %>
			<tr class="hov" style="color:<%=Alertas[5].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[5].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='eguia?guia_des_tras_normal_id=<%=Alertas[0]%>';">
				<td width="150px" ><%=Alertas[7]%></td>
				
				<td width="350px" ><%=Alertas[1]%></td>
				<td width="500px" ><%=Alertas[2]%></td>
				<td width="150px" ><%=Alertas[3]%></td>
				<td width="150px" >$<%=valString%></td>
				<td width="200px" ><%=Alertas[4]%></td>
			</tr>
        	<% } %>
</table>
	</div>
