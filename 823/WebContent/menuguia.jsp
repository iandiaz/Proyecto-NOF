...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
     ...
     <p >MENU GUIA DE DESPACHO TRASLADO ACTIVOS NORMAL</p>
                     </div>
  ...
  <div class="content">
        ...
        <div class="movilButons">
         ...
         <button type="button" class="btn btn-success movile" <% if(perb_ingresar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='I01_001'" <%} %> >INGRESAR</button>
