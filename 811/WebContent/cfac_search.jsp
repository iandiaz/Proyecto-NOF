...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>New Office - Consultar Factura de Compra Afecta - Exenta Activo</title>
...
<div class="navbar">
	...
	<div align="center" class="title">
		<p >CONSULTAR FACTURA DE COMPRA AFECTA - EXENTA ACTIVO</p>
	</div>
</div>
	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR FACTURA</p> </h3>
			</div>
...
<td width="700px" style="font-size:20px"><strong>PROVEEDOR</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
			...
			<tr class="hov" onclick="location='cfac?oc_id=<%=Alertas[0]%>';">
