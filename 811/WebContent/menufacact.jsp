...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
     ...
     <p >MENU FACTURA DE COMPRA AFECTA - EXENTA ACTIVO</p>
                     </div>
  ...
  <div class="content">
        ...
        <div class="movilButons">
         ...
         <button type="button" class="btn btn-danger movile" <% if(perb_eliminar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='egruper'" <%} %> >ELIMINAR</button>
