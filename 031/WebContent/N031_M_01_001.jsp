        ...
        .done(function( data ) {
        	$('#fbody').empty();
          		...
          		$.each( ocs_arr, function( key, oc ) {
          			...
          			var line="<tr class='hov "+classvnv+"' onclick=\"location='N<%=Constantes.MODULO %>_M_02_001?n=1&id="+oc.id+"';\" style='font-size:20px'  >";
		...
		<p >MODIFICAR <%=modname %></p>
         ...
         <div class="menu"  style="min-width: 520px;max-width: 520px;">
         	<div class="titulomenu" style="border: 1px solid black;min-width: 520px;max-width: 520px;">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR ORDEN DE COMPRA A MODIFICAR</p> </h3>
			</div>
