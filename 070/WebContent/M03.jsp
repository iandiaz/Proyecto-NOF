...
margin: 0 auto;
    ...
    $( document ).ready(function() {
    	...
    	function seleccionaTicket(idtick){
    		...
    		if(validate)location='M02?idtick='+idtick+'&id_cliente='+$('#id_cliente').val()+'&id_prov='+$('#id_prov').val();
    		else alert(msg);
    	}
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/070/M02'">VOLVER</button> 
