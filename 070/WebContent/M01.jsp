...
<div class="content" >
  <form action="" name="form1" method="post" id="form1" > 
		...
		<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><p style="margin:0px 0px;font-size:20px;background-color: #39F">SELECCIONAR PEDIDO A MODIFICAR</p></h3>		
		...
		<tr style="background-color:#0101DF;color:#FFFFFF">
			...
			<td class="detailEstado" style="font-size:20px"><strong>ESTADO</strong></td>
		
		</tr>
		</thead>
		<tbody id="fbody" class="scroll ticketsData" style="border: 1px solid black">
		<% for(PedidoVO pedido : pedidos){
			String clasevignovig=pedido.getEstadoVigNoVig().getId().equals("1")?"vig":"novig";%>
			<tr class='hov <%=clasevignovig%>'>
			<td class="detailID" style="font-size:20px"><strong><a href="M02?id_pedido=<%=pedido.getId() %>&n=1"><%=pedido.getId() %></a></strong></td>
			...
			<td class="detailEstado" style="font-size:20px"><strong><%=pedido.getEstado_p()%></strong></td>
