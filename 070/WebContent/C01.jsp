...
<div class="content" >
  <form action="" name="form1" method="post" id="form1" > 
		...
		<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><p style="margin:0px 0px;font-size:20px;background-color: #39F">SELECCIONAR PEDIDO A CONSULTAR</p></h3>		
		...
		<% for(PedidoVO pedido : pedidos){
			...
			<td class="detailID" style="font-size:20px"><strong><a href="C02?id_pedido=<%=pedido.getId() %>"><%=pedido.getId() %></a></strong></td>
