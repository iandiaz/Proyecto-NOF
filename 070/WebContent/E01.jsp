...
<div class="content" >
  <form action="" name="form1" method="post" id="form1" > 
		...
		<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><p style="margin:0px 0px;font-size:20px;background-color: #39F">SELECCIONAR PEDIDO A ELIMINAR</p></h3>		
		...
		%>
			...
			<td class="detailID" style="font-size:20px"><strong><a href="E02?id_pedido=<%=pedido.getId() %>"><%=pedido.getId() %></a></strong></td>
