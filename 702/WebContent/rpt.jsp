...
String p223=(String)request.getAttribute("p223");
String p224=(String)request.getAttribute("p224");
...
padding: 5px 5px 5px 5px;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <p >REPORTE TOMA DE CONTADORES</p>
                    </div>
 ...
 <% if(p223.equals("1")){%><option value="1" selected="selected" >1.- REPORTE TOMA DE CONTADORES</option><%} %>
 <% if(p224.equals("1")){%><option value="2"  >2.- REPORTE TOMA DE CONTADORES ACTUAL</option><%} %>
