  ...
  if(request.getParameter("Exito")!=null && !request.getParameter("Exito").equals("")){
  	  ...
  	  /*if(request.getParameter("Exito")!=null && !request.getParameter("Exito").equals("")){
  	  		if(request.getParameter("Exito").equals("NOOK1")){
  				out.println("<script>alert('NO EXISTE PERIODO ACTUAL')</script>");
  				//out.println("<script>window.location = '/001/'</script>");
  			} 
  		}*/
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/702/'">VOLVER</button> 
...
<tr style="background-color:#0101DF;color:#FFFFFF">
	...
	<td width="650px" style="font-size:20px"><strong>CLIENTE</strong></td>
</tr>  
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
        	 ...
        	 %>
			<tr class="hov" onclick="location='ctc2?empresas_id=<%=Alertas[0]%>';">
				<td width="50px" ><%=Alertas[0]%></td>
				<td width="650px" ><%=Alertas[1]%></td>
			</tr>
        	<% } %>
</table>
	</div>
