...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/702/ctc1'">VOLVER</button> 
	<div align="center" class="title">
		<p >CONSULTAR TOMA DE CONTADORES</p>
	</div>
</div>
<div class="content" >
				...
				String ubi_ant="";
		         ...
		         for(int i =0; i<arActivos.length; i++){
					...
					<tr class="hov" style="border-bottom: 2px solid black; " >
						...
						<td class="detailActivo" ></td>
						<td ></td>
						<td ><input type="text" class="inputDetail" value="<%if(periodos_para_tc[1]!=null && cont1_activo.indexOf(Activos[0]+";;"+Activos[6])!=-1) {%><%=cont1_difs.get(cont1_activo.indexOf(Activos[0]+";;"+Activos[6])) %> <% }else{out.print("0");} %>" style="height:30px ;" disabled></td>
						<td ><input type="text" class="inputDetail" value="<%if(periodos_para_tc[2]!=null && cont2_activo.indexOf(Activos[0]+";;"+Activos[6])!=-1) {%><%=cont2_difs.get(cont2_activo.indexOf(Activos[0]+";;"+Activos[6])) %> <% }else{out.print("0");} %>" style="height:30px ;" disabled></td>
						<td ><input type="text" class="inputDetail" value="<%if(periodos_para_tc[3]!=null && cont3_activo.indexOf(Activos[0]+";;"+Activos[6])!=-1) {%><%=cont3_difs.get(cont3_activo.indexOf(Activos[0]+";;"+Activos[6])) %> <% }else{out.print("0");} %>" style="height:30px ;" disabled></td>
						<td ><input type="text" class="inputDetail" value="<%if(periodos_para_tc[4]!=null && cont4_activo.indexOf(Activos[0]+";;"+Activos[6])!=-1) {%><%=cont4_difs.get(cont4_activo.indexOf(Activos[0]+";;"+Activos[6])) %> <% }else{out.print("0");} %>" style="height:30px ;" disabled></td>
						<td ><input type="text" class="inputDetail" value="<%if(periodos_para_tc[5]!=null && cont5_activo.indexOf(Activos[0]+";;"+Activos[6])!=-1) {%><%=cont5_difs.get(cont5_activo.indexOf(Activos[0]+";;"+Activos[6])) %> <% }else{out.print("0");} %>" style="height:30px ;" disabled></td>
						<td ><input type="text" class="inputDetail" id="difcont6_<%=Activos[0] %>;<%=Activos[6] %>" name="difcont6_<%=Activos[0] %>;<%=Activos[6] %>" value="<%if(cont6_activo.indexOf(Activos[0]+";;"+Activos[6])!=-1) {%><%=cont6_difs.get(cont6_activo.indexOf(Activos[0]+";;"+Activos[6])) %> <% }else{out.print("0");} %>" style="height:30px ;" readonly="readonly">
