...
public class rpt extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("grabar_excel") !=  null && request.getParameter("informe").equals("1")){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"rpt_702_1_xls.php?"+filtros+"';</script>");
		}
		if(request.getParameter("grabar_excel") !=  null && request.getParameter("informe").equals("2")){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"rpt_702_2_xls.php?"+filtros+"';</script>");
		}
		...
		if(request.getParameter("grabar_pdf") !=  null && request.getParameter("informe").equals("1")){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"generaPDF.php?inf=702-1&usu="+usuario+filtros+"';</script>");
		}
		if(request.getParameter("grabar_pdf") !=  null && request.getParameter("informe").equals("2")){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"generaPDF.php?inf=702-2&usu="+usuario+filtros+"';</script>");
		}
   ...
   /////////////////////GENERAR POR WEB ////////////////////////
        ...
        if(request.getParameter("grabar_web") !=  null && request.getParameter("informe").equals("1")){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"rpt_702_1_pdf.php?inf=702-1&usu="+usuario+filtros+"';</script>");
		}
        if(request.getParameter("grabar_web") !=  null && request.getParameter("informe").equals("2")){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"rpt_702_2_pdf.php?inf=702-2&usu="+usuario+filtros+"';</script>");
		}
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		String p223=Controlador.verificaPermisoSession(Controlador.getPerfilIDSession(request), "223");
		String p224=Controlador.verificaPermisoSession(Controlador.getPerfilIDSession(request), "224");
		
		
		
		request.setAttribute("p223", p223);
		request.setAttribute("p224", p224);
