...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div> 
                   ...
                   <form method="get" action="Menumanual" style="margin: 0px 0px 0px 0px">                
  ...
  <div class="content">
        ...
        <div class="movilButons">
         ...
         <button type="button" class="btn btn-success movile" disabled="disabled">INGRESAR</button>
         <button type="button" class="btn btn-danger movile"  disabled="disabled">ELIMINAR</button>
         <button type="button" class="btn btn-warning movile" <% if(perb_modificar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='Mmanual'" <%} %> >MODIFICAR</button>
         <button type="button" class="btn btn-primary movile" <% if(perb_consultar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='Cmanual'" <%} %>>CONSULTAR</button>
         <button type="button" class="btn btn-info movile"  disabled="disabled" >REPORTES</button>
        </div>
