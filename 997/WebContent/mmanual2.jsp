...
margin: 0 auto;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                     ...
                     <form method="get" action="Mmanual2" style="margin:0px 0px 0px 0px">                 
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onClick="location='Mmanual'">VOLVER</button>
  ...
  <div class="content" >
          ...
          <form action="Mmanual2" name="form1" method="post" enctype="multipart/form-data">
 ...
 <tr>
  ...
  <tr>
    <td><div class="divhead"><strong>NOMBRE:</strong><input maxlength="45" type="text" name="Modulos_nombre" id="Modulos_nombre" style="width:522px;height:30px;background:#FFF;" value="<%=Modulos_nombre%>" disabled="disabled">
	    ...
	    <tr><td style="width: 85%;">SELECCIONE MANUAL DE USUARIO</td></tr>
	    <tr>
	    <td><input type="file" style="display:inline-block;margin-top: 10px;" name="modulos_manualnombre" id="modulos_manualnombre" accept=".pdf,.PDF"></td>
	    </tr>
	    </table>
