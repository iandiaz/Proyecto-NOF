...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <form method="get" action="Cmanual" style="margin: 0px 0px 0px 0px">                 
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR MANUAL A CONSULTAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<ar_modulos.length; i++){
			...
			<tr class="hov" style="color:<%=mmodulos[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=mmodulos[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='Cmanual2?id_m=<%=mmodulos[0]%>';">
