...
<%
	String[] ar_modulos =(String[]) request.getAttribute("ar_modulos");
...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <form method="get" action="Mmanual" style="margin: 0px 0px 0px 0px">                 
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button type="button" onclick="location='/997/'" class="btn btn-danger pull-right" style="margin-right: 5px;">VOLVER</button>
                   
                    <div align="center" class="title">
                    <p >MODIFICAR MANUAL</p>
                    </div>
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR MANUAL A MODIFICAR</p> </h3>
...
<td width="630px" style="font-size:20px"  ><strong>NOMBRE</strong></td>
<td width="150px" style="font-size:20px"><strong>ESTADO</strong></td>
</tr>  
<tbody id="fbody" class="scroll" style="border: 1px solid black">

 <%        
         for(int i =0; i<ar_modulos.length; i++){
        	 String[] mmodulos = ar_modulos[i].split("/");
        	 
        	 %>
        		
			<tr class="hov" style="color:<%=mmodulos[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=mmodulos[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='Mmanual2?id_m=<%=mmodulos[0]%>';">
				<td width="47px"><%=mmodulos[0]%></td>
				<td width="700px"><%=mmodulos[1]%></td>
				<td width="150px"><%=mmodulos[3]%></td>
			</tr>
