...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
    		...
    		String guia_des_traszf_id=request.getParameter("guia_des_traszf_id");
    		...
    		request.setAttribute("guia_des_traszf_id",guia_des_traszf_id);
    		...
    		String queru="SELECT "
    				...
    				+ "	INNER JOIN [DIRECCION] ON u_destino.dire_id = [DIRECCION].[DIRE_ID] "
    				+ "	WHERE"
