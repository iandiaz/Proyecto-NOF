	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR TRASLADO DE ACTIVO ZONA FRANCA</p> </h3>
			</div>
			...
			<input type="hidden" name="numtick" value="<%=numtick %>" >
			<input type="hidden" name="obs" value="<%=obs %>" >
        	...
        	<div style=" max-height:400px; width:1200px; ">
				...
				%>
						<tr class="hov">
							<td width="10px" ><% if(!Alertas[13].equals("NO EXISTE")){%><input type="checkbox" <% if(Alertas[5].equals(Alertas[6])){ %> checked <% } %> value="<%=Alertas[0]%>/<%=Alertas[6]%>/<%=Alertas[1]%>/<%=Alertas[2]%>/<%=Alertas[3]%>/<%=Alertas[4]%>/<%=Alertas[7]%>/<%=Alertas[8]%>/<%=Alertas[9]%>/<%=Alertas[10]%>///<%=Alertas[13]%>" name="permisos[]" class="ck_deta"> <% } %></td>
