...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/824/'">VOLVER</button> 
	<div align="center" class="title">
		<p >CONSULTAR GUIA DE DESPACHO TRASLADO ACTIVOS ZONA FRANCA</p>
	</div>
</div>
	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR CLIENTE</p> </h3>
			</div>
...
<td width="400px" style="font-size:20px"><strong>ENTIDAD DESTINO</strong></td>
<td width="600px" style="font-size:20px"><strong>DIRECCION</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
        	 ...
        	 %>
			<tr class="hov" style="color:<%=Alertas[5].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[5].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='cguia?guia_des_traszf_id=<%=Alertas[0]%>';">
				<!-- <td width="50px" ><%=Alertas[0]%></td> -->
				<td width="400px" ><%=Alertas[1]%></td>
				<td width="600px" ><%=Alertas[2]%></td>
