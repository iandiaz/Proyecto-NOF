...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
        	 ...
        	 %>
			<tr class="hov" style="color:<%=Alertas[5].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[5].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='eguia?guia_des_traszf_id=<%=Alertas[0]%>';">
