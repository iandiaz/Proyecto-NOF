...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
     ...
     <p >MENU CONFIGURACION GPS DINAMICO</p>
                     </div>
  ...
  <div class="content">
        ...
        <div class="movilButons">
         ...
         <button type="button" class="btn btn-success movile" <% if(perb_ingresar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='iguias_stipo'" <%} %> >INGRESAR</button>
         ...
         <button type="button" class="btn btn-warning movile" <% if(perb_modificar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='mconf_search'" <%} %> >MODIFICAR</button>
         <button type="button" class="btn btn-primary movile" <% if(perb_consultar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='cconf'" <%} %>>CONSULTAR</button>
