...
/**
 * Servlet implementation class mconf_search
 */
@WebServlet("/mconf_search")
public class mconf_search extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		RequestDispatcher rd = request.getRequestDispatcher("mconf_search.jsp");
