  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/890/c1'">VOLVER</button>
...
<div class="divhead"><strong >EMISOR:</strong><input type="text" value="<%=emp_emisor %>" style="width:120px;height:30px; background:#FFF;" disabled="disabled"></div>
  ...
  <tr>
    ...
    <th scope="col" style="background:#39F" width="45px" align="center"><input type="checkbox" id="todos" name="todos" value="1" <% if(ar_usuariossel!=null && ar_usuarios.length==ar_usuariossel.length){%> checked="checked"  <%} %> disabled="disabled"  ></th>
