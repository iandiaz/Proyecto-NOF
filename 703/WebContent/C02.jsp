...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/703/C01'">VOLVER</button> 
		         ...
		         for(int i =0; i<arActivos.length; i++){
					...
					<tr class="hov" >
						<td class="detailID" ><%=Activos[0]%> <input type="hidden" name="activosdetail[]" value="<%=Activos[0]%>" />
																...
																<input type="hidden" name="estrucdetail[]" value="<%=Activos[6]%>" /></td>
