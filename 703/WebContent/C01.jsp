	...
	<div class="containermenu">
         <div class="menu"  style="min-width: 1100px;max-width: 1100px;">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR FACTURA A CONSULTAR</p> </h3>
			</div>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(FacturaVO factura: facturas){
        	 ...
        	 %>
			<tr class="hov" onclick="location='C02?factura_id=<%=factura.getId()%>';" style="color:<%=factura.getEstadoVigNoVig().getId().equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=factura.getEstadoVigNoVig().getId().equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;">
