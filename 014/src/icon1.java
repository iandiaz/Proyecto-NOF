...
/**
 * Servlet implementation class icon1
 */
@WebServlet("/icon1")
public class icon1 extends HttpServlet {
...
PrintWriter out = response.getWriter();
		...
		try {
		    ...
		    while(clpr_rs.next()){        	   
		    	...
		    	estado_clpral.add(clpr_rs.getString("empresas_id")+"/"+clpr_rs.getString("empresas_nombre")+"/"+clpr_rs.getString("estados_vig_novig_id")+"/"+clpr_rs.getString("estados_vig_novig_nombre")+"/"+clpr_rs.getString("empresas_rut"));
		...
		RequestDispatcher rd = request.getRequestDispatcher("icon1.jsp");
