...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/014/C01_001'">VOLVER</button> 
...
<div class="content" >
  ...
  <div class=" cuadroblanco" style="height:235px;">
	...
	<div class=" cuadroblanco" style="height:240px;margin-top: 2px;">
