...
<!--<![endif]-->
  ...
  <div class="content">
         ...
         <div class="menu" style="min-height: 45px;width: 545px;min-width: 545px;max-width: 545px;" >
        <div class="movilButons">
                
         <button type="button" class="btn btn-success movile" <% if(perb_ingresar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='icon1'" <%} %> >INGRESAR</button>
         <button type="button" class="btn btn-danger movile" <% if(perb_eliminar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='econ1'" <%} %> >ELIMINAR</button>
         <button type="button" class="btn btn-warning movile" <% if(perb_modificar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='mcon1'" <%} %> >MODIFICAR</button>
