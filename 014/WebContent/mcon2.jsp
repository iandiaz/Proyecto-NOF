<%@ page language="java" contentType="text/html; charset=US-ASCII"
    ...
    String TICON_ID=(String)request.getAttribute("TICON_ID");
    String estvnv_id=(String)request.getAttribute("estvnv_id");
...
<div class="content" >
  ...
  <div class=" cuadroblanco" style="height:235px;">
	...
	<div class=" cuadroblanco" style="height:200px;margin-top: 2px;">
		...
		<div class="detailcb scroll">	
			...
			<%        
	       	 ...
	       	 %>
	       	 	<option value="<%=DireDato[0]%>" <% if(TICON_ID.equals(DireDato[0])){%> selected="selected" <%} %> ><%=DireDato[1]%></option>
	       	 <% } %>
			</select></div>
			<div class="divhead"><strong>NOMBRE:</strong><input type="text" maxlength="30" name="nom" id="nom"  style="width:350px;height:30px ;" class="amarillo"  value="<%=CONT_NOMBRE %>" required="required" ><span class="cabecera" style="color:#F00">*</span></div>
			<div class="divhead"><strong>APE P:</strong><input type="text" maxlength="30" name="apep" id="apep"  style="width:350px;height:30px ;" class="amarillo"  value="<%=CONT_APEP %>" required="required" ><span class="cabecera" style="color:#F00">*</span></div>
			<div class="divhead"><strong>APE M:</strong><input type="text" maxlength="30" name="apem" id="apem"  style="width:350px;height:30px ;" class="amarillo"  value="<%=CONT_APEM %>" required="required" ><span class="cabecera" style="color:#F00">*</span></div>
			<div class="divhead"><strong>CARGO:</strong><input type="text" name="cargo" id="cargo" style="width:460px;height:30px ;" class="amarillo" maxlength="40"  value="<%=CONT_CARGO %>" required="required" ><span class="cabecera" style="color:#F00">*</span></div>		
    ...
    %>
      ...
      <option value="<%=estados_vig_novig[0]%>" <% if(estvnv_id.equals(estados_vig_novig[0])){%> selected="selected" <%} %> ><%=estados_vig_novig[1] %></option>
    <% } %>
    </select></div>
			<div class="divhead"><strong>EMAIL:</strong><input type="text" maxlength="50" name="email" id="email" style="width:620px;height:30px ;" class="amarillo" value="<%=CONT_EMAIL %>" required="required"><span class="cabecera" style="color:#F00">*</span></div>
			<div class="divhead"><strong>TELEFONO:</strong><input type="text" maxlength="20" name="fono" id="fono" style="width:240px;height:30px ;" class="amarillo" value="<%=CONT_TELEFONO %>" required="required"><span class="cabecera" style="color:#F00">*</span></div>
			<div class="divhead"><strong>CELULAR:</strong><input type="text" maxlength="20" name="fono_c" id="fono_c" style="width:240px;height:30px ;" class="amarillo" value="<%=CONT_TELEFONOC %>" required="required"><span class="cabecera" style="color:#F00">*</span></div>
			<div class="divhead"><strong>OBS:</strong><input type="text" maxlength="30" name="obs" id="obs" style="width:350px;height:30px ;" class="amarillo" value="<%=CONT_OBS %>" required="required"><span class="cabecera" style="color:#F00">*</span></div>
		</div>
	</div> 
