...
public boolean validateSession(HttpServletRequest request, HttpServletResponse response){
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("grabar_excel") !=  null && request.getParameter("informe").equals("1")){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"rpt_803_1_xls.php?"+filtros+"';</script>");
		}
		...
		if(request.getParameter("grabar_pdf") !=  null && request.getParameter("informe").equals("1")){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"generaPDF.php?inf=803-1&usu="+usuario+filtros+"';</script>");
		}
   ...
   /////////////////////GENERAR POR WEB ////////////////////////
        ...
        if(request.getParameter("grabar_web") !=  null && request.getParameter("informe").equals("1")){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"rpt_803_1_pdf.php?inf=996-1&usu="+usuario+filtros+"';</script>");
		}
