...
/**
 * Servlet implementation class mfac1
 */
@WebServlet("/mfac1")
public class mfac1 extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
		    ...
		    ResultSet Alertas_RS = state.executeQuery(SQL_Alertas);
          ...
          //--------------------- EMISOR ----------------------//
            ...
            RequestDispatcher rd = request.getRequestDispatcher("mfac1.jsp");
