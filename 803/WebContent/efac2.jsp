...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/803/efac1'">VOLVER</button> 
	<div align="center" class="title">
		<p>ELIMINAR FACTURA AFECTA - EXENTA SERVICIOS IMPRESION</p>
	</div>
</div>
<div class="content" >
	...
	<div class=" cuadroblanco" style="height:160px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>COND PAGO:</strong><input name="fac_servim_condiciones" id="fac_servim_condiciones" type="text" style="width:380px;height:30px ;background:#FFF;" readonly="readonly" value="<%=fac_servim_condiciones%>"></div>
	...
	<div class=" cuadroblanco" style="height:120px;margin-top: 5px;">
		...
		<div class="divhead"><strong>TELEFONO:</strong><input type="text" style="width:250px;height:30px ;background:#FFF;" disabled="disabled" value="<%=CONT_TELEFONO%>"></div>
	...
	<div class=" cuadroblanco" style="height:120px;margin-top: 5px;">
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>SUBTOTAL:</strong><input type="text" id="total" style="width:150px;height:30px ;background:#FFF;text-align: right;" readonly="readonly" value="<%=sub_fac_servim_total%>"></div>
		...
		<div class="divhead"><strong><% if(fac_servim_tipodte.equals("33") || fac_servim_tipodte.equals("30")){%>AFECTO<%}%><% if(fac_servim_tipodte.equals("34") || fac_servim_tipodte.equals("32")){%>EXENTO<%}%>:</strong><input type="text"  style="width:130px;height:30px ;background:#FFF;" readonly="readonly" value="<%=netoneto %>" id="netoneto"></div>
...
<div class=" cuadroblanco" style="height:80px;margin-top: 5px">
	...
	<div style="padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>TIPO CAMBIO:</strong><input type="text" style="width:130px;height:30px ;background:#FFF;" value="<%=fac_servim_tcambio%>" disabled="disabled"></div>
