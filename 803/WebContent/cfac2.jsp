...
String iva=nff.format(Integer.parseInt(fac_servim_iva)).replace(",",".");
...
String netodesc=nff.format(Integer.parseInt(fac_servim_neto)).replace(",",".");

String fac_servim_totalfinal=(String)request.getAttribute("fac_servim_totalfinal");	
String totalfinal=nff.format(Integer.parseInt(fac_servim_totalfinal)).replace(",",".");
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/803/cfac1'">VOLVER</button> 
	<div align="center" class="title">
		<p>CONSULTAR FACTURA AFECTA - EXENTA SERVICIOS IMPRESION</p>
	</div>
</div>
<div class="content" >
  ...
  <input type="hidden" name="fact_id" value="<%=gd_id%>" > 
	...
	<div class=" cuadroblanco" style="height:120px;margin-top: 5px;">
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>SUBTOTAL:</strong><input type="text" style="width:150px;height:30px ;background:#FFF;text-align: right;" readonly="readonly" id="total"  value="<%=neto%>"></div>
		...
		<div class="divhead"><strong><% if(fac_servim_tipodte.equals("33") || fac_servim_tipodte.equals("30")){%>AFECTO<%}%><% if(fac_servim_tipodte.equals("34") || fac_servim_tipodte.equals("32")){%>EXENTO<%}%>:</strong><input type="text" style="width:130px;height:30px ;background:#FFF;text-align: right;" readonly="readonly" value="<%=netodesc %>" id="netoneto"></div>
