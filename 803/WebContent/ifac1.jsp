   ...
   var folios_ar =new Array();
     ...
     <%  for(int i =0; i<ar_folios.length; i++){
                                            ...
                                            if(cli_seleccionada!=''){
                                            	 ...
                                            	 for(var ii=0; ii< periodos_ar.length;ii++){
                                                     ...
                                                     if(periodo_ar[1]==cli_seleccionada){
                                                       $('#peri_tc_id').append($('<option>', {
                                                                                   value: periodo_ar[0],
                                                                                   text: periodo_ar[2]+" "+periodo_ar[3]+" AL "+periodo_ar[4] 
                                                                                   }));
                                                     }
        ...
        function validateSubmit(){
        	...
        	if(Number(document.getElementById('totaltotal').value)<0){
        	...
        	if(document.getElementById('fac_servim_tcambio').value==""){
        ...
        function previsualizar(){
    		...
    		$("#obs_prev3").val($("#fac_servim_obs").val()+'-TC:'+$("#fac_servim_tcambio").val()+'-'+$("#fac_servim_n_impresiones").val());
        ...
        function cambiaDet(){
        	var total=0;
        	for(var i =1 ; i<=14;i++){
        		//alert(Number($('#val'+i).val()));
        		total+=Number($('#val'+i).val());
        	}
        	$('#total').val(total);
        	$('#total').blur();
        }
...
<div class="navbar">
	...
	<div align="center" class="title">
		<p>INGRESAR FACTURA AFECTA - EXENTA SERVICIOS IMPRESION</p>
	</div>
</div>
<div class="content" >
  <form action="" name="form1" method="post" id="form1" > 
	<div class=" cuadroblanco" style="height:120px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>FECHA:</strong><input type="text" style="width:130px;height:30px ;background:#FF3;" class="amarillo"  name="gv_fecha" id="datepicker3" value="<%=fecha %>" readonly="readonly"></div>
		...
		<div class="divhead"><strong>TIPO DTE:</strong><input type="radio" name="tipodte" id="tipodte1" value="33" checked="checked">(33)AFECTA <input type="radio" name="tipodte" id="tipodte2" value="34">(34)EXENTA</div>
		...
		<div class="divhead"><strong>TIPO MANUAL:</strong><input type="radio" name="tipodte" id="tipodte11"  value="30"   >(30)AFECTA <input type="radio" name="tipodte" id="tipodte22"  value="32">(32)EXENTA</div>
	...
	<div class=" cuadroblanco" style="height:275px;margin-top: 5px;">
		...
		<div class="divhead"><strong>RUT:</strong><input type="text" name="empresas_rut" id="empresas_rut" style="width:145px;height:30px ;background:#FFF;" disabled="disabled" value="" ><input type="hidden"  name="rut_prev"  id="rut_prev"></div>
		...
		<div class="divhead"><strong>CIUDAD:</strong><input type="text" style="width:350px;height:30px ;background:#FFF;" id="gv_ciudad" name="gv_ciudad" readonly="readonly" value="" ><input type="hidden"  name="ciudad_prev" id="ciudad_prev"></div>
		...
		<div class="divhead"><strong>PER FACT.:</strong><select name="peri_tc_id" id="peri_tc_id" style="margin:0px 0px 0px 0px;width: 325px" >
					...
					<option value="<%=periodos[0]%>"><%=periodos[2]+" "+periodos[3]+" AL "+periodos[4] %></option>
				<% } %>
				</select><span class="cabecera" style="color:#F00">*</span></div>
	</div>
	...
	<div class=" cuadroblanco" style="height:235px;margin-top: 5px;">
		...
		<div class="divhead"><strong>SERV IMP 1:</strong><input type="text" maxlength="53"  class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv1" id="serv1" value="" autofocus="autofocus" ></div>
		...
		<div class="divhead"><strong>SERV IMP 2:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv2" id="serv2" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 3:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv3" id="serv3" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 4:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv4" id="serv4" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 5:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv5" id="serv5" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 6:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv6" id="serv6" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 7:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv7" id="serv7" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 8:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv8" id="serv8" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 9:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv9" id="serv9" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 10:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv10" id="serv10" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 11:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv11" id="serv11" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 12:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv12" id="serv12" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 13:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv13" id="serv13" value=""></div>
		...
		<div class="divhead"><strong>SERV IMP 14:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv14" id="serv14" value=""></div>
