	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR FACTURA AFECTA - EXENTA SERVICIOS IMPRESION A ELIMINAR (QUE NO HAYA SIDO ENVIADA A SII)</p> </h3>
			</div>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
        	 ...
        	 %>
			<tr class="hov" style="color:<%=Alertas[4].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[4].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='efac2?gd_id=<%=Alertas[0]%>';">
				<td width="80px" ><%=Alertas[6]%></td>
				<td width="690px" ><%=Alertas[1]%></td>
				<td width="130px" >$<%=valString%></td>
				<td width="140px" nowrap="nowrap" ><%=Alertas[3]%></td>
