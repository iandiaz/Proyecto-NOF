...
padding: 5px 5px 5px 5px;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <p >REPORTE FACTURA AFECTA - EXENTA SERVICIOS IMPRESION</p>
                    </div>
  ...
  <option value="1" selected="selected" >1.- REPORTE FACTURAS SERVICIOS IMPRESION</option>
   ...
   <% for(int i =0; i<ar_grupos.length; i++){
    ...
    <% } %>
      ...
      <div class="divhead"><strong >EMISOR:</strong><select name="select_empresa_e" id="select_empresa_e">
       ...
       <div class="divhead"><strong >PERIODO:</strong><select name="select_periodo" id="select_periodo">
			   <option value="" selected="selected">TODOS</option>
			   <% for(int i =0; i<ar_select_periodo.length; i++){
			       		String[] periodo = ar_select_periodo[i].split("/");
