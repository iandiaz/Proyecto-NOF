  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                     ...
                     <form method="get" action="Eusuario2" style="margin:0px 0px 0px 0px">                 
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onClick="location='Eusuario'">VOLVER</button>
   ...
   <div class="content" >
        <form action="Eusuario2" name="form1" method="post">
...
<div class="divhead"><strong>NOM:</strong><input maxlength="35" type="text" style="width:190px;height:30px; background:#FFF;" value="<%=Usuarios_nombre%>" disabled="disabled" >
                    </div>
...
<div class="divhead"><strong>CONTRASEÑA:</strong><input maxlength="25" type="password" style="width:110px;height:30px; background:#FFF;" value="<%=Usuarios_pass%>" disabled="disabled" >
                    </div>
...
<div class="divhead"><strong>TELEFONO:</strong><input maxlength="25" type="text" style="width:180px;height:30px; background:#FFF;" value="<%=Usuarios_telefono%>" disabled="disabled" >
                    </div>
...
<div class="divhead"><strong>EMPRESA:</strong><input type="text" value="<%=empresas_nombre%>" style="width:640px;height:30px; background:#FFF; " disabled="disabled"></div>
