...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <form method="get" action="Cusuario" style="margin: 0px 0px 0px 0px;">                 
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button type="button" onclick="location='/008/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR USUARIO A CONSULTAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         for(int i =0; i<arusuarios.length; i++){
			...
			<tr class="hov" title="<%=cadenaEmpresas.equals("") ? "SIN EMPRESA ASIGNADO" : cadenaEmpresas %>" style="color:<%=usuarios[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=usuarios[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='Cusuario2?Usuarios_id=<%=usuarios[0]%>';">
