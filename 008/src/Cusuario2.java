...
/**
 * Servlet implementation class Cusuario2
 */
@WebServlet("/Cusuario2")
public class Cusuario2 extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		RequestDispatcher rd = request.getRequestDispatcher("cusuario2.jsp");
