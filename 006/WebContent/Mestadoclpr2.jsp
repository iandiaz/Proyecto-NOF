...
<%
	...
	String id_clpr=(String)request.getAttribute("id_clpr");
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                     ...
                     <form method="get" action="Mestadoclpr2" style="margin:0px 0px 0px 0px">                 
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onClick="location='Mestadoclpr'">VOLVER</button>
                   
                    <div align="center" class="title">
                    <p >MODIFICAR ESTADO CLIENTE-PROVEEDOR</p>
                    </div>
   ...
   <div class="content" >
         ...
         <form action="Mestadoclpr2" name="form1" method="post">
         <input type="hidden" name="id_clpr" value="<%=request.getParameter("id_clpr")%>">
           	<table class="table-movil" border="0" align="center">
  <tr>
    <td><div class="divhead"><strong >CORRELATIVO:</strong><input type="text" value="<%=id_clpr %>" style="width:50px;height:30px; background:#FFF;" disabled="disabled">
                    </div></td>
    </tr>
  <tr>
    <td><div class="divhead"><strong>NOMBRE:</strong><input maxlength="30" type="text" class="amarillo" name="Estado_Clpr_nombre" id="Estado_Clpr_nombre" style="width:348px;height:30px;background: #FF3" value="<%=grupos_nombre%>" required >
