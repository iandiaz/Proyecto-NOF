...
<%
String Estado_Clpr_nombre="";
String estados_vig_novig_id="";

if(request.getAttribute("Estado_Clpr_nombre")!=null && !request.getAttribute("Estado_Clpr_nombre").equals(""))Estado_Clpr_nombre =(String) request.getAttribute("Estado_Clpr_nombre");
...
<!-- VALIDANDO QUE LOS CAMPOS VALLAN CON ALGO -->
	...
	function validarIngreso(){
		if(document.getElementById('Estado_Clpr_nombre').value==""){
		alert('DEBE INGRESAR UN NOMBRE DE ESTADO DE CLIENTE PROVEEDOR');
		document.getElementById('Estado_Clpr_nombre').focus();
		return false;
		}
  ...
  if(request.getParameter("Exito")!=null && !request.getParameter("Exito").equals("")){
  		if(request.getParameter("Exito").equals("NOK")){
			out.println("<script>alert('EL NOMBRE DEL ESTADO DE CLIENTE PROVEEDOR YA EXISTE')</script>");
...
margin: 0 auto;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                     ...
                     <form method="get" action="Iestadoclpr" style="margin:0px 0px 0px 0px">                 
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/006/'">VOLVER</button>
                   
                    <div align="center" class="title" >
                    <p >INGRESAR ESTADO CLIENTE-PROVEEDOR</p>
                    </div>
  ...
  <div class="content" >
         ...
         <form action="Iestadoclpr" name="form1" method="post">
           	<table class="table-movil" border="0" align="center">
  <tr>
    <td><div class="divhead"><strong >CORRELATIVO:</strong><input type="text" value="<%=correlativo %>" style="width:50px;height:30px; background:#FFF;" disabled="disabled">
                    </div></td>
    </tr>
  <tr>
    <td><div class="divhead"><strong>NOMBRE:</strong><input maxlength="30" autofocus="autofocus" type="text" class="amarillo" style="width:348px;height:30px;background:#FF3" name="Estado_Clpr_nombre" id="Estado_Clpr_nombre" value="<%=Estado_Clpr_nombre %>" required >
