...
padding: 5px 5px 5px 5px;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <p >REPORTE ESTADO CLIENTE-PROVEEDOR</p>
                    </div>
  ...
  <div class="content" >
         ...
         <input type="hidden" name="id_g" value="<%=request.getParameter("id_g")%>">
            ...
            <div class="divhead"><strong >INFORME:</strong><input type="text" value="REPORTE ESTADO CLIENTE-PROVEEDOR" style="width:400px;height:30px; background:#FFF;" disabled="disabled">
                    </div>
