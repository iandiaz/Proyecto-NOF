...
<html lang="en">
  ...
  <!--<![endif]-->
   <script type="text/javascript">
  	function detelePerfil(id_clpr,nombre_clpr){
  		if(confirm("¿ESTA SEGURO QUE DESEA ELIMINAR EL ESTADO CLIENTE PROVEEDOR '"+nombre_clpr+"' ?")){
  			document.getElementById('delete_id').value=id_clpr;
  ...
  <form id="deletegrupo" action="" method="post" style="margin: 0px 0px 0px 0px;">
    ...
    <div class="navbar">
                    ...
                    <form method="get" action="Eestadoclpr" style="margin: 0px 0px 0px 0px;">                 
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR ESTADO CLIENTE-PROVEEDOR A ELIMINAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<arestado_clpr.length; i++){
			...
			<tr class="hov" style="color:<%=estado_clpr[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=estado_clpr[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='Eestadoclpr2?id_clpr=<%=estado_clpr[0]%>';">
