...
/**
 * Servlet implementation class Cestadoclpr
 */
@WebServlet("/Cestadoclpr")
public class Cestadoclpr extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		RequestDispatcher rd = request.getRequestDispatcher("Cestadoclpr.jsp");
