...
/**
 * Servlet implementation class rptestclpr
 */
@WebServlet("/rptestclpr")
public class rptestclpr extends HttpServlet {
...
public boolean validateSession(HttpServletRequest request, HttpServletResponse response){
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("grabar_excel") !=  null){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"rpt_estclpr_xls.php?"+filtros+"';setInterval(\"close()\",10000);</script>");
		}
		if(request.getParameter("grabar_pdf") !=  null){
			...
			out.write("<script>window.location='"+Constantes.URL_SITIO+"generaPDF.php?inf=006-1"+filtros+"';setInterval(\"close()\",10000);</script>");
		}
	}
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		//::::::::::::::::::::::::::::::::::::::::::sql estado clpr para select option::::::::::::::::::::::::::::::::::::::  
		  ...
		  System.out.println("SIZE LIST: "+estclpr.size());  	
		  ESTCLPR_RS.close();
      ...
      request.setAttribute("ar_empresas", ar_empresas);
		...
		conexion.close();
        RequestDispatcher a = request.getRequestDispatcher("rpt_estclpr.jsp");
