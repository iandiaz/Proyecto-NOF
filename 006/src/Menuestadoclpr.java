...
/**
 * Servlet implementation class Menuestadoclpr
 */
@WebServlet("/Menuestadoclpr")
public class Menuestadoclpr extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * Default constructor. 
     */
    public Menuestadoclpr() {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		///////////////////////////////////////////////////////////
		RequestDispatcher rd = request.getRequestDispatcher("menuestadoclpr.jsp");
