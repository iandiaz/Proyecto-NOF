...
/**
 * Servlet implementation class Cestadoclpr2
 */
@WebServlet("/Cestadoclpr2")
public class Cestadoclpr2 extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		RequestDispatcher rd = request.getRequestDispatcher("Cestadoclpr2.jsp");
