...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/009/'" class="btn btn-danger pull-right" style="margin-right: 5px;">VOLVER</button>
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR GRUPO DE PERFILES USUARIO PARA ALERTAS A MODIFICAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arGrupos.length; i++){
			...
			<tr class="hov" title="<%=Grupos[4]%>" style="color:<%=Grupos[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Grupos[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='mgruper_mod?id_g=<%=Grupos[0]%>';">
