...
<!-- VALIDANDO QUE LOS CAMPOS VAYAN CON ALGO -->
	...
	function validarIngreso(){
		...
		alert('DEBE INGRESAR UN NOMBRE DE GRUPO DE PERFILES');
...
padding: 5px 5px 5px 5px;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onClick="location='mgruper'">VOLVER</button>
                   
                    <div align="center" class="title" >
                    <p >MODIFICAR GRUPO DE PERFILES USUARIO PARA ALERTAS</p>
                    </div>
  ...
  <div class="content" >
      ...
      <form action=mgruper_mod name="form1" method="post">
                   <div class=" cuadroblanco" >
         
         <input type="hidden" name="id_g" value="<%=request.getParameter("id_g")%>">
             
             
           	<div class="divhead"><strong>CORRELATIVO:</strong><input type="text" value="<%=gruposusu_id %>" style="width:50px;height:30px; background:#FFF;color: #000;" disabled="disabled" >
                    </div>
            <div class="divhead"><strong>NOMBRE:</strong><input maxlength="50" type="text" class="amarillo" name="gruposusu_nombre" id="gruposusu_nombre" style="width:565px;height:30px;background:#FF3;border: 1px solid #FFFF00;" value="<%=gruposusu_nombre%>" required autofocus="autofocus" >
                    <span class="cabecera" style="color:#F00">*</span></div>
            <div class="divhead" style="width:750px;"><strong>ESTADO:</strong><select name="estados_vig_novig_id" id="estados_vig_novig_id" style="margin:0px 0px 0px 0px;width: 167px">
                ...
                <tbody class="scroll">
                    <%
                       ...
                       if(ar_perfiles!=null) for(int i =0; i<ar_perfiles.length; i++){
                            ...
                            %>
                    <tr>
                        <td class="int"><%=perfil[0]%></td>
                        <td class="int" align="center"><input name="perfiles_sel[]" value="<%=perfil[0]%>" type="checkbox"<% if(perfil.length>2 && perfil[2]!=null && perfil[2].equals("sel")){%> checked <% } %> ></td>
