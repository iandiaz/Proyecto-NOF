...
<html lang="en">
  ...
  <div class="content">
        ...
        <div class="titulomenu" style="border: 1px solid black">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR GRUPO DE PERFILES USUARIO PARA ALERTAS A CONSULTAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<arGrupos.length; i++){
			...
			<tr class="hov" title="<%=Grupos[4] %>" style="color:<%=Grupos[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Grupos[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='cgruper_ver?id_g=<%=Grupos[0]%>';" >
