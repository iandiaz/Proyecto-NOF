...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
     ...
     <p >MENU GRUPO DE PERFILES USUARIO PARA ALERTAS</p>
                     </div>
  ...
  <div class="content">
        ...
        <div class="movilButons">
         ...
         <button type="button" class="btn btn-success movile" <% if(perb_ingresar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='igruper'" <%} %> >INGRESAR</button>
         ...
         <button type="button" class="btn btn-primary movile" <% if(perb_consultar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='cgruper'" <%} %>>CONSULTAR</button>
