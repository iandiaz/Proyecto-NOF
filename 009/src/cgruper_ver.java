 ...
 */
@WebServlet("/cgruper_ver")
public class cgruper_ver extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
    		...
    		String SQL_GRUPO = ""
		    		...
		    		+ "		DATE_FORMAT(g.gruposusu_feccreacion,'%d-%m-%Y %H:%i:%s') AS perfilusu_feccreacion_ok, "
		    		+ "		IF ( "
		...
		RequestDispatcher rd = request.getRequestDispatcher("cgruper_ver.jsp");
