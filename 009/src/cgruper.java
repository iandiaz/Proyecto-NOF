...
/**
 * Servlet implementation class cgruper
 */
@WebServlet("/cgruper")
public class cgruper extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		RequestDispatcher rd = request.getRequestDispatcher("cgruper.jsp");
