...
/**
 * Servlet implementation class egrupo_search
 */
@WebServlet("/egruper")
public class egrupo_search extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public egrupo_search() {
        super();
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
		    ...
		    String SQL_Grupos_Per = "SELECT * FROM gruposusu g INNER JOIN estados_vig_novig e ON e.estados_vig_novig_id=g.estados_vig_novig_id ORDER BY g.gruposusu_nombre";
		    Grupos_RS =  state.executeQuery(SQL_Grupos_Per);
		...
		RequestDispatcher rd = request.getRequestDispatcher("egruper.jsp");
