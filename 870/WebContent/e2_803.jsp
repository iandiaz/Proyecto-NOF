...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/870/e1'">VOLVER</button> 
	<div align="center" class="title">
		<p>ELIMINAR APROBACION NOTA DE CREDITO</p>
	</div>
</div>
<div class="content" >
  <form action="" name="form1" id="form1" method="post" > 
	...
	<div class=" cuadroblanco" style="height:240px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>ESTADO:</strong><input maxlength="10" type="text" style="width:130px;height:30px ;background:#FFF;" value="<%=est_aprobacion %>"   readonly="readonly"></div>
