...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/870/m1'">VOLVER</button> 
...
<div class="content" >
  <form action="" name="form1" id="form1" method="post" > 
	...
	<div class=" cuadroblanco" style="height:240px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>ESTADO:</strong><select name="est_aprobacion" id="est_aprobacion"  style="margin:0px 0px 0px 0px;width: 167px; margin-bottom: 9px">
    <% for(int i =0; i<ar_estados.length; i++){
       		String[] estados_vig_novig = ar_estados[i].split("/");
    
    %>
     
      <option value="<%=estados_vig_novig[0]%>" <% if(est_aprobacion.equals(estados_vig_novig[0]))%><%="selected"%>><%=estados_vig_novig[1] %></option>
    <% } %>
