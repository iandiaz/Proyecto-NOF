				    ...
				    if(modref.equals("801")){
			 		  ...
			 		  RS_DATOS.close();
			 		   ...
			 		   for(int x=0; x < prod_res.size(); x++){
			 			   System.out.println("det_841_801"+prod_res.get(x));
...
//						   
			           ...
			           RequestDispatcher rd = request.getRequestDispatcher("i2_801.jsp");
				    ...
				    if(modref.equals("802")){
						...
						//-------------------------CABECERA GUIA RESUMEN-------------------------//
						 String SQL_CAB = "SELECT 	g.802_folio,"
				            ...
				            RequestDispatcher rd = request.getRequestDispatcher("i2_802.jsp");
				            rd.forward(request, response);
					 }
...
//						   
				            ...
				            RequestDispatcher rd = request.getRequestDispatcher("i2_803.jsp");
				            rd.forward(request, response);
					 }
...
//						   
				            statecor.close();
				            conexion.close();
				            RequestDispatcher rd = request.getRequestDispatcher("i2_804.jsp");
				            rd.forward(request, response);
					 }
