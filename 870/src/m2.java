...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		if(request.getParameter("grabar") != null){
			try {
			    ...
			    String est_aprobacion=request.getParameter("est_aprobacion");
			    
				
				 String SQL_DATOS="UPDATE `841` "
				 		+ "	Set "
				 		+ "	841_est_aprobacion= "+est_aprobacion
			...
			request.setAttribute("d_id", request.getParameter("d_id"));
			 ...
			 String f_nc_sql="SELECT"
				    ...
				    if(f_nc_RS.next()){
				    	...
				    	request.setAttribute("est_aprobacion", f_nc_RS.getString("841_est_aprobacion"));
...
//						   
			           ...
			           RequestDispatcher rd = request.getRequestDispatcher("m2_801.jsp");
				    ...
				    if(modref.equals("802")){
						...
						//-------------------------CABECERA GUIA RESUMEN-------------------------//
						 String SQL_CAB = "SELECT 	g.802_folio,"
				            ...
				            RequestDispatcher rd = request.getRequestDispatcher("m2_802.jsp");
				            rd.forward(request, response);
					 }
...
//						   
				            ...
				            RequestDispatcher rd = request.getRequestDispatcher("m2_803.jsp");
				            rd.forward(request, response);
					 }
...
//						   
				            statecor.close();
				            conexion.close();
				            RequestDispatcher rd = request.getRequestDispatcher("m2_804.jsp");
				            rd.forward(request, response);
					 }
