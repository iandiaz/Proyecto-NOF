...
<div class="navbar">
	...
	<form method="get" action= style="margin: 0px 0px 0px 0px;">       
		...
		<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/821/cfac_search'">VOLVER</button> 
	
	</form>  
	<div align="center" class="title">
		<p >CONSULTAR GUIA DE DESPACHO VENTA ACTIVO</p>
	</div>
</div>
<div class="content" >
  <form action="" name="form1" method="post" id="form1"  >
  <input type="hidden" name="fact_id" value="<%=gv_id%>" >
	...
	<div class=" cuadroblanco" style="height:240px;margin-top: 5px;">
		...
		<div class="divhead"><strong>TELEFONO:</strong><input type="text" style="width:140px;height:30px ;background:#FFF;" disabled="disabled" value="<%=CONT_TELEFONO%>"></div>
