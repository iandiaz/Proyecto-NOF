...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/821/ifac_search'">VOLVER</button> 
	<div align="center" class="title">
		<p >INGRESAR GUIA DE DESPACHO VENTA ACTIVO</p>
	</div>
</div>
<div class="content" >
  <form action="ifac" name="form1" method="post" id="form1">
  <input type="hidden" name="gv_id" value="<%=gv_id%>" >
	<div class=" cuadroblanco" style="height:80px;">
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>NRO.BIRT:</strong><input  type="text" style="width:100px;height:30px ;background:#FFF;" disabled="disabled" value="<%=gv_id%>"></div>
		...
		<div class="divhead"><strong>ESTADO SII:</strong><input type="text" style="width:150px;height:30px ;background:#FFF;" disabled="disabled" value="<%=id_guia_estado%>"></div>
	...
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>SUBTOTAL:</strong><input name="subtotal" id="subtotal" type="text" style="width:150px;height:30px ;background:#FFF;" value="<%=neto %>"  readonly="readonly"></div>
...
<div class=" cuadroblanco" style="height:80px;margin-top: 5px">
	...
	<div style="padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>ESTADO:</strong><input type="text" value="<%=GV_ESTADO%>" style="width:200px;height:30px ;background:#FFF;" disabled="disabled" ></div>
	...
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>FORMA DE DESPACHO:</strong><input type="text" name="obs1" id="obs1" class="amarillo" maxlength="255" style="width:720px;height:30px ;background:#FF3;" value=""><span class="cabecera" style="color:#F00">*</span></div>
		<div class="divhead"><strong>OBSERVACION:</strong><input type="text" name="obs2" id="obs2" class="amarillo" maxlength="255" style="width:720px;height:30px ;background:#FF3;" value=""><span class="cabecera" style="color:#F00">*</span></div>
		...
		<div class="bgrabar">
          ...
          <button type="submit" name="grabar" id="grabar" class="btn btn-success" <% if(id_guia_estado.equals("ENVIADA")){ %>disabled<% } %> onclick="return validateSubmit()" >GRABAR</button>
