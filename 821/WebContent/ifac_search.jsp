	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR GUIA A GENERAR DTE PARA SII</p> </h3>
			</div>
...
<td width="100px" style="font-size:20px"><strong>ESTADO</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
			...
			<tr class="hov" onclick="location='ifac?gv_id=<%=Alertas[0]%>';">
				<td width="80px" ><%=Alertas[0]%></td>
				<td width="600px" ><%=Alertas[1]%></td>
				<td width="130px" >$<%=valString%></td>
				<td width="140px" ><%=Alertas[3]%></td>
				<td width="100px" ><%=Alertas[4]%></td>
	...
	<center>GUIAS EMITIDAS EN BIRT, Y AÚN NO PREPARADAS PARA ENVIAR A SII.
	</center>
</div><br><br><br>
<div class="footerapp">               
