...
/**
 * Servlet implementation class menufac
 */
@WebServlet("/menufac")
public class menufac extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
    		...
    		String log_sql=""
    				...
    				+ " ) "
    				+ " VALUES "
    				+ " (now(), 'USUARIO INGRESA AL MENU DEL MODULO 821', '"+id_iusuario+"') ";
        ...
        conexion.close();
		RequestDispatcher rd = request.getRequestDispatcher("menufac.jsp");
