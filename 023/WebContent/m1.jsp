...
<html lang="en">
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR PRODUCTO A MODIFICAR</p> </h3>
...
<tbody id="fbody" class="scroll noloading" style="border: 1px solid black; display: none;">
 ...
 <%
         ...
         for(int i =0; i<productos.size(); i++){
			...
			<tr class="hov" style="color:<%=prod[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=prod[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='m2?id_p=<%=prod[0]%>';" >
