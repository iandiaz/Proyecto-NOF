...
String prod_cuc=(String)request.getAttribute("prod_cuc");
...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/023/C01_001'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
  ...
  <div class="divhead"><strong>PN/TLI/COD FABRICANTE:</strong><input type="text" value="<%=prod_pn_tli_codfab%>" style="width:220px;height:30px; background:#FFF;color: #000" readonly="readonly" ></div>
	...
	<div class="divhead"><strong>OBSERVACION:</strong><input type="text" value="<%=prod_observacion%>" style="width:520px;height:30px; background:#FFF;color: #000" disabled="disabled" ></div>
	<div class="divhead"><strong>CUC:</strong><input type="text" value="<%=prod_cuc%>" style="width:100px;height:30px; background:#FFF;color: #000" disabled="disabled" ></div>
