...
<html lang="en">
        ...
        .done(function( data ) {
        	$('#fbody').empty();
          		...
          		$.each( productos_arr, function( key, producto ) {
          			...
          			if(producto.estadoVigNoVig.id==1){
          				classvnv="vig";
          			}
          				
          			if(producto.estadoVigNoVig.id==2){
          				classvnv="novig";
          			}
          			
          			var line="<tr class='hov "+classvnv+"' onclick=\"location='c2?id_p="+producto.id+"';\" style='font-size:20px'  >";
          			
          			line+="<td width=\"60px\" >"+producto.id+"</td>";
          			
          			line+="<td width='150px' >"+producto.pn+"</td>";
          			line+="<td width='350px' >"+producto.funcionalidad.nombre+"</td>";
          			
          			line+="<td width='520px' >"+producto.desc_corto+"</td>";
          			line+="<td width='120px' >"+producto.estadoVigNoVig.nombre+"</td>";
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR PRODUCTO A CONSULTAR</p> </h3>
