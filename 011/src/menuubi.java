...
/**
 * Servlet implementation class menuubi
 */
@WebServlet("/menuubi")
public class menuubi extends HttpServlet {
...
String SQL_PERFILES = "SELECT "
		...
		///////////////////////////////////////////////////////////
		RequestDispatcher rd = request.getRequestDispatcher("menuubi.jsp");
