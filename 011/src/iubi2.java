...
/**
 * Servlet implementation class iubi2
 */
@WebServlet("/iubi2")
public class iubi2 extends HttpServlet {
	...
	private void mt(HttpServletRequest request, HttpServletResponse response)throws IOException, ServletException {
		...
		try {
    		...
    		Connection conexion=(Connection) DriverManager.getConnection
    		 ...
    		 String SQL_clpr = "SELECT "
     		 		...
     		 		+ " AND em.empresas_id="+empresas_id
		...
		RequestDispatcher rd = request.getRequestDispatcher("iubi2.jsp");
