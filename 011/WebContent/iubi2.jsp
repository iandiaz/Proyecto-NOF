...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/011/iubi1'">VOLVER</button> 
		...
		<p >INGRESAR UBICACION</p>
         ...
         <div class="menu"  style="min-width: 1200px;max-width: 1200px;">
         	<div class="titulomenu" style="border: 1px solid black;min-width: 1200px;max-width: 1200px;">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR DIRECCI&Oacute;N A INGRESAR UBICACION</p> </h3>
			</div>
...
<tr style="background-color:#0101DF;color:#FFFFFF">
	<td width="60px" style="font-size:20px"><strong>ID</strong></td>
			...
			<td width="730px" style="font-size:20px"><strong>DIRECCION</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
        	 ...
        	 %>
			<tr class="hov" onclick="location='iubi3?empresas_id=<%=empresas_id %>&dir_id=<%=Alertas[6]%>';" style="color:<%=Alertas[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;">
				<td width="60px" ><%=Alertas[6]%></td>
				
				<td width="730px" ><%=Alertas[5]%></td>
