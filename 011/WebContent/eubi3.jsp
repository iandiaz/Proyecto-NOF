...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/011/eubi2'">VOLVER</button> 
	<div align="center" class="title">
		<p >ELIMINAR UBICACION</p>
	</div>
</div>
<div class="content" >
  ...
  <div class=" cuadroblanco" style="height:295px;">
	...
	<div class=" cuadroblanco" style="height:200px;margin-top: 2px;">
		<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><p style="margin:0px 0px;font-size:20px;background-color: #39F">DETALLE UBICACION</p></h3>
			...
			<div class="divhead"><strong>TIPO UBI:</strong><input type="radio" <% if(UBI_TIPO.equals("1")){%> checked="checked" <%} %> disabled="disabled">BODEGA<input type="radio" <% if(UBI_TIPO.equals("2")){%> checked="checked" <%} %>  disabled="disabled" style="height: 30px">USUARIO </div>
			<div class="divhead"><strong>USUARIO:</strong><input type="text"  maxlength="25"   style="width:290px;height:30px ;background-color: #FFF" value="<%=UBI_USUARIO %>" disabled="disabled"  ></div>
			<div class="divhead"><strong>UBI FIS:</strong><input type="text" name="UBI_FISICA" id="UBI_FISICA"   style="width:350px;height:30px;background-color: #FFF"   maxlength="30"  value="<%=UBI_FISICA %>"  disabled="disabled" ></div>		
			<div class="divhead"><strong>UBI FACTURACION:</strong><input type="text"  style="width:350px;height:30px ;background-color: #FFF"  maxlength="30"  value="<%=UBI_DESCRIPCION %>" disabled="disabled" ></div>		
			<div class="divhead ubiusuariodiv"><strong>TIPO TOMAR CONTADOR:</strong><input type="radio" <% if(tpg_id.equals("1")){%> checked="checked" <%} %> disabled="disabled" >PRESENCIAL
			...
			<div class="divhead" ><strong>USA SUBUBICACION:</strong><input type="checkbox" <% if(ubi_usa_sububicacion.equals("1")){%> checked="checked" <%} %>  disabled="disabled" style="height: 30px" ></div>
