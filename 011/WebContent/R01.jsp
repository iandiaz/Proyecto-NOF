...
String p117=(String)request.getAttribute("p117");
String p118=(String)request.getAttribute("p118");
String p119=(String)request.getAttribute("p119");
String p252=(String)request.getAttribute("p252");
...
padding: 5px 5px 5px 5px;
  ...
  <div class="content" >
            ...
            <div class="divhead"><strong >INFORME:</strong><select name="informe" id="informe" class="informe">
           	  	...
           	  	<% if(p117.equals("1")){%><option value="1" selected="selected" >1.- REPORTE UBICACIONES USUARIO SIN PRIMARIO</option><%} %>
				<% if(p118.equals("1")){%><option value="2" >2.- REPORTE UBICACIONES BODEGAS CON PRIMARIO</option><%} %>
				<% if(p119.equals("1")){%><option value="3" >3.- REPORTE UBICACIONES NO NOF CON MAS DE UN SUMINISTRO</option><%} %>
				<% if(p252.equals("1")){%><option value="4" >4.- REPORTE UBICACIONES</option><%} %>
