		...
		<p >ELIMINAR UBICACION</p>
         ...
         <div class="menu"  style="min-width: 700px;max-width: 900px;">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR CLIENTE/PROVEEDOR A ELIMINAR UBICACION</p> </h3>
			</div>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
        	 ...
        	 %>
			<tr class="hov" onclick="location='eubi2?empresas_id=<%=Alertas[0]%>';" style="color:<%=Alertas[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;">
