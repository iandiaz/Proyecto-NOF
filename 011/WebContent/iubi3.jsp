...
<script>
    ...
    function validateSubmit(){
    	...
    	if(document.getElementById('UBI_USUARIO').value==""){
    		validate=false;
    	}
    	
    	if(document.getElementById('UBI_DESCRIPCION').value==""){
    		validate=false;
    	}
    	...
    	if(validate){
    		...
    		alert('DEBE INGRESAR TODOS LOS DATOS DE LA UBICACION');
    		return false;
    	}
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/011/iubi2'">VOLVER</button> 
	<div align="center" class="title">
		<p >INGRESAR UBICACION</p>
	</div>
</div>
<div class="content" >
  <form action="" name="form1" onsubmit="return validateSubmit()" method="post" style="margin: 0px 0px 0px 0px">
  <input type="hidden" name="ubi_usullave" id="ubi_usullave" /> 
  <div class=" cuadroblanco" style="height:295px;">
   ...
   <input type="text" value="<%=empresas_relacionada%>" style="width:45px;height:30px; background:#FFF; " disabled="disabled">   
	...
	<div class=" cuadroblanco" style="height:170px;margin-top: 2px;">
		<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><p style="margin:0px 0px;font-size:20px;background-color: #39F">DETALLE UBICACION</p></h3>
			...
			<div class="divhead"><strong>TIPO UBI:</strong>
				<input type="radio" name="tubi" value="1" checked="checked">BODEGA
				<input type="radio" name="tubi" value="2" style="height: 30px">USUARIO </div>
			<div class="divhead"><strong>USUARIO:</strong><input type="text"  maxlength="25" name="UBI_USUARIO" id="UBI_USUARIO"  style="width:290px;height:30px ;" class="amarillo"  value="" required="required" ><span class="cabecera" style="color:#F00">*</span></div>
			<div class="divhead"><strong>UBI FIS:</strong><input type="text" name="UBI_FISICA" id="UBI_FISICA"  class="amarillo"  style="width:350px;height:30px;"   maxlength="30" required="required" ><span class="cabecera" style="color:#F00">*</span></div>		
			
			<div class="divhead"><strong>FACTURACION:</strong><input type="text" name="UBI_DESCRIPCION" id="UBI_DESCRIPCION" style="width:350px;height:30px ;" class="amarillo" maxlength="30"  value="" required="required"><span class="cabecera" style="color:#F00">*</span></div>		
			<div class="divhead ubiusuariodiv"><strong>TIPO TOMAR CONTADOR:</strong>
			<input type="radio" name="tpg_id" value="1" checked="checked" style="height: 30px">PRESENCIAL
			<input type="radio" name="tpg_id" value="2" style="height: 30px">REMOTO
			<input type="radio" name="tpg_id" value="3" style="height: 30px">REMOTO EN CLIENTE
			<input type="radio" name="tpg_id" value="4" style="height: 30px">EJECUTIVO COMERCIAL </div>
			<div class="divhead" style="padding-top:10px;"><strong>USA SUBUBICACION:</strong><input type="checkbox" name="ubi_usa_sububicacion" value="1" ></div>
