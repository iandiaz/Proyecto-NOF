...
<!-- VALIDANDO QUE LOS CAMPOS VALLAN CON ALGO -->
	...
	function validarIngreso(){
		...
		alert('DEBE INGRESAR UN NOMBRE DE TIPO CONTACTO');
 ...
 <% 
  if(request.getParameter("Exito")!=null && !request.getParameter("Exito").equals("")){
  		if(request.getParameter("Exito").equals("NOK")){
			out.println("<script>alert('EL NOMBRE DE TIPO CONTACTO YA EXISTE')</script>");
	...
	%>
    <meta charset="utf-8">
    <title>New Office - TIPO CONTACTO</title>
...
margin: 0 auto;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/015/mtcon1'">VOLVER</button>
                   
                    <div align="center" class="title" >
                    <p >MODIFICAR TIPO CONTACTO</p>
                    </div>
  ...
  <tr>
    <td><div class="divhead"><strong>NOMBRE:</strong><input maxlength="20" autofocus="autofocus" type="text" class="amarillo" style="width:240px;height:30px ;background:#FF3;border: 1px solid #FFFF00;" name="tcon_nombre" id="tcon_nombre" value="<%=grupos_nombre %>" required >
