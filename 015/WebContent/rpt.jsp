...
padding: 5px 5px 5px 5px;
  ...
  <option value="1" selected="selected" >1.- REPORTE TIPO CONTACTO POR CONTACTO</option>
 <option value="2"  >2.- REPORTE CONTACTO POR TIPO CONTACTO</option>
  ...
  <div class="divhead"><strong>ESTADO TIPO CONTACTO:</strong><select name="select_estado" id="select_estado">
    			<option value="" selected="selected">TODOS</option>
	 		    <option value="1" >VIGENTE</option>
	 		    <option value="2">NO VIGENTE</option>
	 		    </select>
                 </div>  
 	  <div class="divhead"><strong>ESTADO CONTACTO:</strong><select name="select_estado_contacto" id="select_estado_contacto">
    			<option value="" selected="selected">TODOS</option>
	 		    <option value="1" >VIGENTE</option>
	 		    <option value="2">NO VIGENTE</option>
	 		    </select>
