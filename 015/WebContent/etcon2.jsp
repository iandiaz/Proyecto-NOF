...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/015/etcon1'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
...
<tr>
  ...
  <div class="bgrabar" >
           <button onclick="location='etcon2?delete_id=<%=grupos_id%>';" type="button" name="grabar" id="grabar" class="btn btn-success" >GRABAR</button>
           </div> 
       </div> 
