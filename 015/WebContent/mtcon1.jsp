...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/015/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
  ...
  <div class="content">
        ...
        <div class="titulomenu" style="border: 1px solid black">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR TIPO CONTACTO A MODIFICAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<arGrupos.length; i++){
			...
			<tr class="hov" style="color:<%=Grupos[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Grupos[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='mtcon2?id_g=<%=Grupos[0]%>';" >
