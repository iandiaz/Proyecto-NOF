...
/**
 * Servlet implementation class menutcon
 */
@WebServlet("/menutcon")
public class menutcon extends HttpServlet {
...
String SQL_PERFILES = "SELECT "
		...
		///////////////////////////////////////////////////////////
		RequestDispatcher rd = request.getRequestDispatcher("menutcon.jsp");
