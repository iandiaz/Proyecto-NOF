        ...
        .done(function( data ) {
        	$('#fbody').empty();
          		...
          		$.each( configuraciones_arr, function( key, configuracion ) {
          			...
          			var line="<tr class='hov "+classvnv+"' onclick=\"location='N025_C_02_001?id="+configuracion.id+"';\" style='font-size:20px'  >";
		...
		<p>CONSULTAR <%=modname %></p>
         ...
         <div class="menu"  style="min-width: 640px;max-width: 640px;">
         	<div class="titulomenu" style="border: 1px solid black;min-width: 640px;max-width: 640px;">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR CONFIGURACION A CONSULTAR</p> </h3>
			</div>
