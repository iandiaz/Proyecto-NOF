...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div> 
                     ...
                     <p>N<%=Constantes.MODULO%>.1.01.001</p>
                     </div>
  ...
  <div class="content">
        ...
        <div class="movilButons">
         ...
         <button type="button" class="btn btn-success movile" <% if(perb_ingresar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='N<%=Constantes.MODULO%>_I_01_001?n=1'" <%} %> >INGRESAR</button>
         <button type="button" class="btn btn-danger movile" <% if(perb_eliminar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='N<%=Constantes.MODULO%>_E_01_001'" <%} %> >ELIMINAR</button>
         <button type="button" class="btn btn-warning movile" <% if(perb_modificar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='N<%=Constantes.MODULO%>_M_01_001?n=1'" <%} %> >MODIFICAR</button>
         <button type="button" class="btn btn-primary movile" <% if(perb_consultar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='N<%=Constantes.MODULO%>_C_01_001'" <%} %>>CONSULTAR</button>
