...
margin: 0 auto;
	...
	function grabar(){
		$('.loaded').hide();
		$('.loading').show();
		$.post( "eliminarConfAsync", $( "#form1" ).serialize())
	        .done(function( data ) {
	        	  if(data.trim()=="OK") {
  ...
  <input type="hidden" name="id" value="<%=configuracion.getId() %>"> 
  	<div class="cuadroblanco" style="height:auto;margin-top: 5px;overflow: auto; min-height: 50px">
		<div style="padding: 5px 5px 5px 5px;">
			...
			<div class="divhead vertical-middle"><strong>NOMBRE CONFIGURACION:</strong> <input type="text" name="confe_nombre" id="confe_nombre" style="width:420px;height:30px ;" value="<%=configuracion.getNombre() %>" readonly="readonly" ></div>
