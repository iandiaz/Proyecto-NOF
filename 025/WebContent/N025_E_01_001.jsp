        ...
        .done(function( data ) {
        	$('#fbody').empty();
          		...
          		$.each( configuraciones_arr, function( key, configuracion ) {
          			...
          			var line="<tr class='hov "+classvnv+"' onclick=\"location='N025_E_02_001?id="+configuracion.id+"';\" style='font-size:20px'  >";
		...
		<p>ELIMINAR <%=modname %></p>
         ...
         <div class="menu"  style="min-width: 640px;max-width: 640px;">
         	<div class="titulomenu" style="border: 1px solid black;min-width: 640px;max-width: 640px;">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR CONFIGURACION A ELIMINAR</p> </h3>
			</div>
