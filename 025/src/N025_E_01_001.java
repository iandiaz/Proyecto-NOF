 ...
 */
@WebServlet("/N025_E_01_001")
public class N025_E_01_001 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public N025_E_01_001() {
        super();
    }
	...
	private void mt(HttpServletRequest request, HttpServletResponse response)throws IOException, ServletException {
		PrintWriter out = response.getWriter();		
	   	...
	   	RequestDispatcher rd = request.getRequestDispatcher("N"+Constantes.MODULO+"_E_01_001.jsp");
