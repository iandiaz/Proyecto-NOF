...
/**
 * Servlet implementation class Econtrato
 */
@WebServlet("/Econtrato")
public class Econtrato extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
		    ...
		    String SQL_usuarios = "SELECT *, DATE_FORMAT(u.fecha_inicio,'%d-%m-%Y') as fecha_inicio1 "
		    		+ "				FROM contrato u INNER JOIN estados_vig_novig e ON e.estados_vig_novig_id=u.estados_vig_novig_id ORDER BY u.contrato_id";
		...
		RequestDispatcher rd = request.getRequestDispatcher("Econtrato.jsp");
