...
/**
 * Servlet implementation class Mcontrato
 */
@WebServlet("/Mcontrato")
public class Mcontrato extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
		    ...
		    while(usuarios_rs.next()){        	   
		    	...
		    	usuariosal.add(usuarios_rs.getString("contrato_id")+"/"+usuarios_rs.getString("contrato_nombre")+"/"+usuarios_rs.getString("estados_vig_novig_id")+"/"+usuarios_rs.getString("estados_vig_novig_nombre")
		    			+"/"+usuarios_rs.getString("fecha_inicio1")+"/"+usuarios_rs.getString("estadocontrato_nombre"));
		...
		RequestDispatcher rd = request.getRequestDispatcher("Mcontrato.jsp");
