...
/**
 * Servlet implementation class Econtrato2
 */
@WebServlet("/Econtrato2")
public class Econtrato2 extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		//grabar
				...
				if(request.getParameter("grabar") !=  null){
					...
					try {	
					    ...
					    String SQL_UPDATE = ""
					    		+ " UPDATE contrato "
					    		+ " SET estados_vig_novig_id=2,contrato_accion_alertada=0,contrato_ult_idper_exec=21,contrato_fecmod=now(),contrato_modificador="+Usuarios_ID
					    		+ " WHERE contrato_id="+request.getParameter("Usuarios_id");
					    System.out.println("UP: "+SQL_UPDATE); 
					    stategrabar.executeUpdate(SQL_UPDATE);
					    stategrabar.close();
			            conexion.close();
			            
			            RequestDispatcher rd_up = request.getRequestDispatcher("Econtrato?mExito=OK");
		...
		RequestDispatcher rd = request.getRequestDispatcher("Econtrato2.jsp");
