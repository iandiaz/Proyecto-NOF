  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                     ...
                     <form method="get" action="Ccontrato2" style="margin:0px 0px 0px 0px">                 
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onClick="location='Ccontrato'">VOLVER</button>
   ...
   <div class="content" >
         ...
         <form action="Ccontrato2" name="form1" method="post">
...
<div class="bgrabar" style="width: 1000px; padding-left: 5px;padding-right: 5px">
