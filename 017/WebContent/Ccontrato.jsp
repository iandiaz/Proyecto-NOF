...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <form method="get" action="Ccontrato" style="margin: 0px 0px 0px 0px;">                 
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR CONTRATO A CONSULTAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         for(int i =0; i<arusuarios.length; i++){
			...
			<tr class="hov" title="<%=cadenaEmpresas.equals("") ? "SIN EMPRESA ASIGNADO" : cadenaEmpresas %>" style="color:<%=usuarios[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=usuarios[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='Ccontrato2?Usuarios_id=<%=usuarios[0]%>';">
