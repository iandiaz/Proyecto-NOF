...
<%
    ...
    String[] ar_usuarios_emp=(String[])request.getAttribute("ar_usuarios_emp");
...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <form method="get" action="Mcontrato" style="margin: 0px 0px 0px 0px;">                 
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button type="button" onclick="location='/017/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR CONTRATO A MODIFICAR</p> </h3>
...
<td width="130px" style="font-size:20px"><strong>FECHA INICIO</strong></td>
<td width="130px" style="font-size:20px"><strong>ESTADO</strong></td>
<td width="200px" style="font-size:20px"><strong>ETAPA CONTRATO</strong></td>
</tr>  
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         for(int i =0; i<arusuarios.length; i++){
             ...
             //buscamos por le id donde se encuentre el usuario
             
             for(int x =0 ; x< ar_usuarios_emp.length ; x++){
                 String[] usu_emp_ar =ar_usuarios_emp[x].split("/");
                 if(usu_emp_ar[0].equals(usuarios[0]))cadenaEmpresas+=""+usu_emp_ar[1];
                }
        	 %>
        		
			<tr class="hov" title="<%=cadenaEmpresas.equals("") ? "SIN EMPRESA ASIGNADO" : cadenaEmpresas %>" style="color:<%=usuarios[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=usuarios[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='Mcontrato2?Usuarios_id=<%=usuarios[0]%>';">
				<td width="47px"><%=usuarios[0]%></td>
				<td width="350px"><%=usuarios[1]%></td>
				<td width="130px"><%=usuarios[4]%></td>
				<td width="130px"><%=usuarios[3]%></td>
				<td width="200px"><%=usuarios[5]%></td>
			</tr>
