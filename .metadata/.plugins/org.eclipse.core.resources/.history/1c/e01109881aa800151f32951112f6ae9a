 ...
 <style type="text/css">
   ...
   <script>
    ...
    function getOCs(){
        ...
        $.post( "getOCsAsync", {id_est_autorizacion:1  })
        .done(function( data ) {
        	$('#fbody').empty();
          		...
          		$.each( ocs_arr, function( key, oc ) {
          			...
          			var line="<tr class='hov' onclick=\"location='N<%=Constantes.MODULO %>_I_02_001?id="+oc.id+"';\" style='font-size:20px'  >";
          			
          			line+="<td width=\"60px\" >"+oc.id+"</td>";
          			
          			line+="<td width='300px' >"+oc.nro+"</td>";
          			line+="<td width='146px' >"+oc.estado_aprobacion.nombre+"</td>";
...
<div class="navbar">
		...
		<p >INGRESAR <%=modname %></p>
         ...
         <div class="menu"  style="min-width: 520px;max-width: 520px;">
         	<div class="titulomenu" style="border: 1px solid black;min-width: 520px;max-width: 520px;">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR ORDEN DE COMPRA A AUTORIZAR</p> </h3>
			</div>
  ...
  <table class="table" style="margin-left:0px; width:100%;">
	...
	<tr style="background-color:#0101DF;color:#FFFFFF">
		...
		<td width="300px" style="font-size:20px"><strong>COD</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
			...
			<tr class="hov" style="font-size: 20px">
				<td colspan="5" width="1200px" align="center">CARGANDO... <img alt="" src="/<%=Constantes.MODULO %>/images/loading.GIF"></td>
