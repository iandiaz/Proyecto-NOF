      ...
      <form action="Ccal" method="post" >
         ...
         <table border="1" class="cal">
            ...
            <tr>
                ...
                <td <%=marcado%>> <div style="vertical-align: top;height: 30%;" ><%=msg%></div> <% if(!msg.equals("")){ %> <div class="hrs"><p><%=hi%></p><p><%=hf%></p></div> <% } %>   <input type="hidden" name="<%=msg%>" id="<%=msg%>" value="<%=cal_ar[x]%>"> </td>
