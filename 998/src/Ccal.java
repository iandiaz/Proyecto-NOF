...
/**
 * Servlet implementation class Ccal
 */
@WebServlet("/Ccal")
public class Ccal extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
    ...
    //tamaño = 7 dias de semana * 6 semanas maximo = 42
    ...
    //por default traemos el mes y año actual para armar el calendario
    ...
    try {
        ...
        if(request.getParameter("grabar")!=  null){
            ...
            String SQL_UP = "UPDATE `cal` SET `cal`.`cal_estado` = 2 WHERE YEAR (`cal`.`cal_dia`) ="+year_actual+" AND MONTH (`cal`.`cal_dia`) ="+mes_actual+" AND `cal`.`cal_estado` = 1";
            ...
            for(int i =1; i<42; i++){
                if(request.getParameter(""+i)!=null){
                    ...
                    if(data_dia_ar[0]!=null && data_dia_ar[0].equals("novacio")){
                        ...
                        + " VALUES('"+year_actual+"-"+mes_actual+"-"+data_dia_ar[1]+"',1,'"+data_dia_ar[2]+"','"+data_dia_ar[3]+"')";
        ...
        while(CALNOW_RS.next()){
        	System.out.println(CALNOW_RS.getInt("cal_dia")+"/"+(1-weekdar_first+CALNOW_RS.getInt("cal_dia")));
		...
		///////////////////////////////////////////////////////////
		RequestDispatcher rd = request.getRequestDispatcher("Ccal.jsp");
