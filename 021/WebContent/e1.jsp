...
<html lang="en">
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR MARCA A ELIMINAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<marcas.size(); i++){
			...
			<tr class="hov" style="color:<%=marca[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=marca[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='e2?id_m=<%=marca[0]%>';" >
