...
public class EmpresaVO {
	...
	private String empresas_esproveedor;
	private EstadosVigNoVigVO estadoVigNoVig;
	private String empresas_relacionada;

	public String getEmpresas_esproveedor() {
		return empresas_esproveedor;
	}

	public void setEmpresas_esproveedor(String empresas_esproveedor) {
		this.empresas_esproveedor = empresas_esproveedor;
	}
