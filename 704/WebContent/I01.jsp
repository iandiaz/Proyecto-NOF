...
margin: 0 auto;
    ...
    $( document ).ready(function() {
		...
		$('#prod_id').on('change', function() {
	        ...
	        $.post( "getActivos", { prod_id: prod_id })
	        .done(function( data ) {
	        	  $( ".activosData" ).html( (data) );
	        	  $('.noloading').show();
		  	      $('.loading').hide();
	        });
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/704'">VOLVER</button> 
...
<div class="content" >
  <form action="" name="form1" method="post" id="form1" > 
	...
	<div class=" cuadroblanco" style="height:50px;padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>PRODUCTO PRINCIPAL:</strong><select name="prod_id" id="prod_id" style="margin:0px 0px 0px 0px;" >
				
				<option value="">SELECCIONAR</option>
				<% for(ProductoVO producto:productos){ %>
				<option value="<%=producto.getId()%>"><%=producto.getPn() %> - <%=producto.getDesc_corto() %></option>
			<% } %>
	...
	<div class=" cuadroblanco" style="height:300px;margin-top: 5px;">
		<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><p style="margin:0px 0px;font-size:20px;background-color: #39F">SELECCIONAR ACTIVO PRIMARIO</p></h3>		
		...
		<tr style="background-color:#0101DF;color:#FFFFFF">
			...
			<td class="detailSerie" style="font-size:20px"><strong>SERIE</strong></td>
			<td class="detailUbi" style="font-size:20px"><strong>ESTADO PRODUCTO</strong></td> 
			
		</tr>
		</thead>
		<tbody id="fbody" class="scroll activosData" style="border: 1px solid black">
		</tbody>
		</table>
