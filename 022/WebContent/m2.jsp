...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/022/m1'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
  ...
  <div class="content">
         ...
         <input type="hidden" name="id_m" value="<%=func_id%>" /> 
            
  <table class="table-movil" border="0" align="center">
	<tr>
	    <td><div class="divhead"><strong>CORRELATIVO:</strong><input type="text" value="<%=func_id %>" style="width:50px;height:30px; background:#FFF; color: #000" disabled="disabled">
	                    </div></td>
	    </tr>
	<tr>
		<td><div class="divhead"><strong>NOMBRE:</strong><input type="text" value="<%=func_nombre%>" maxlength="30" class="amarillo" style="width:350px;height:30px ;background:#FF3;border: 1px solid #FFFF00;" name="func_nombre" id="func_nombre" >
						</div></td>
