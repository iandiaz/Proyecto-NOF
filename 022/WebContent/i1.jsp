...
if(request.getAttribute("func_nombre")!=null && !request.getAttribute("func_nombre").equals("")) func_nombre =(String) request.getAttribute("func_nombre");
...
margin: 0 auto;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/022/'">VOLVER</button>
  ...
  <tr>
    <td><div class="divhead"><strong>NOMBRE:</strong><input maxlength="30" autofocus="autofocus" type="text" class="amarillo" style="width:350px;height:30px ;background:#FF3;border: 1px solid #FFFF00;" name="func_nombre" id="func_nombre" value="<%=func_nombre %>" required >
