...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/022/c1'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
  ...
  <table class="table-movil" border="0" align="center">
	...
	<tr>
		<td><div class="divhead"><strong>NOMBRE:</strong><input type="text" value="<%=func_nombre%>" style="width:350px;height:30px; background:#FFF;color: #000" disabled="disabled" >
						</div></td>
