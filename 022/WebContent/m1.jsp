...
<html lang="en">
  ...
  <form id="deletegrupo" action="" method="post" style="margin: 0px 0px 0px 0px;">
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/022/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR FUNCIONALIDAD A MODIFICAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<funcionalidades.size(); i++){
        	 String[] funcionalidad = funcionalidades.get(i).split(";;");
        	 	 
        	 %>
        		
			<tr class="hov" style="color:<%=funcionalidad[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=funcionalidad[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='m2?id_m=<%=funcionalidad[0]%>';" >
				<td width="47px"><%=funcionalidad[0]%></td>
				<td width="290px"><%=funcionalidad[1]%></td>
				<td width="150px"><%=funcionalidad[3]%></td>
			</tr>
