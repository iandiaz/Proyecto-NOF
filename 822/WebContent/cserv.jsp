...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/822/cserv_search'">VOLVER</button> 
	<div align="center" class="title">
		<p>CONSULTAR GUIA DE DESPACHO VENTA SERVICIO</p>
	</div>
</div>
<div class="content" > 
<form action="" name="form1" method="post" id="form1" >
  <input type="hidden" name="fact_id" value="<%=gd_id%>" >
	...
	<div class=" cuadroblanco" style="height:235px;margin-top: 5px;">
		...
		%>
		<div class="divhead"><strong>SERVICIO <%=i+1%>:</strong><input type="text" style="width:600px;height:30px ;background:#FFF;" value="<%=servicio%>" id="serv<%=i+1%>" readonly="readonly"></div>
		<div class="divhead"><strong>VALOR <%=i+1%>:</strong><input type="text" style="width:140px;height:30px ;background:#FFF;text-align: right;" value="<%=valor%>" id="val<%=i+1%>" readonly="readonly"></div>
		<% } %>
		</div>
	</div>
		<div class=" cuadroblanco" style="height:120px;margin-top: 5px;">
