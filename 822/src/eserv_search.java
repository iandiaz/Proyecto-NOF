...
/**
 * Servlet implementation class eserv_search
 */
@WebServlet("/eserv_search")
public class eserv_search extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		RequestDispatcher rd = request.getRequestDispatcher("eserv_search.jsp");
