...
<html lang="en">
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR PRODUCTO-PRECIO A CONSULTAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         for(int i =0; i<arestado_clpr.length; i++){
			...
			<tr class="hov"  onclick="location='c2?prod_id=<%=estado_clpr[0]%>&cuc=<%=precio%>&nom=<%=estado_clpr[1]%>';">
				<td width="100px"><%=estado_clpr[0]%></td>
				<td width="715px"><%=estado_clpr[1]%></td>
