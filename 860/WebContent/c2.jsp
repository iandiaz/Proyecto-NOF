...
padding: 5px 5px 5px 5px;
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <div class="brand"><img src="lib/bootstrap/img/logonew_big.png"></div>
                    ...
                    <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onClick="location='/860/c1'">VOLVER</button>
                   
                    <div align="center" class="title">
                    <p >CONSULTAR PRECIO GUIA TRASLADO</p>
                    </div>
  ...
  <div class="divhead"><strong>%:</strong><input onkeydown="return validateNum(event)" maxlength="3" type="text"  style="width:50px;height:30px ;background:#FFF;" name="porcentaje" id="porcentaje" value="<%=porcentaje%>" readonly="readonly"  ></div>        
  <div class="divhead"><strong>PRECIO GUIA DESPACHO:</strong><input onkeydown="return validateNum(event)" type="text"  style="width:105px;height:30px ;background:#FFF;" name="precio_guia_desp" id="precio_guia_desp" maxlength="8" value="<%=precio_guia_desp %>" readonly="readonly" ></div>
