...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/010/cdir1'">VOLVER</button> 
	<div align="center" class="title">
		<p >CONSULTAR DIRECCION</p>
	</div>
</div>
<div class="content" >
  <div class=" cuadroblanco" style="height:200px;">
   ...
   <input type="text" value="<%=empresas_relacionada%>" style="width:45px;height:30px; background:#FFF; " disabled="disabled">   
	...
	<div class=" cuadroblanco" style="height:230px;margin-top: 2px;">
		...
		<div class="divhead"><strong>COD POSTAL:</strong><input type="text"  id="cod_postal"  style="width:90px;height:30px ;background:#FFF;" disabled="disabled"  value="<%=DIRE_COD_POSTAL%>" ></div>
