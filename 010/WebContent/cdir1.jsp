...
<div class="navbar">
	...
	<div align="center" class="title">
		<p >CONSULTAR DIRECCI&Oacute;N</p>
	</div>
</div>
	...
	<div class="containermenu">
         <div class="menu"  style="min-width: 1000px;max-width: 1000px;">
         	<div class="titulomenu" style="border: 1px solid black;min-width: 1000px;max-width: 1000px;">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR DIRECCI&Oacute;N A CONSULTAR</p> </h3>
			</div>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
        	 ...
        	 %>
			<tr class="hov" onclick="location='cdir2?dir_id=<%=Alertas[6]%>';" style="color:<%=Alertas[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;">
