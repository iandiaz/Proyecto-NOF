...
/**
 * Servlet implementation class menudir
 */
@WebServlet("/menudir")
public class menudir extends HttpServlet {
...
String SQL_PERFILES = "SELECT "
		...
		///////////////////////////////////////////////////////////
		RequestDispatcher rd = request.getRequestDispatcher("menudir.jsp");
