...
/**
 * Servlet implementation class Eclpr2
 */
@WebServlet("/Eclpr2")
public class Eclpr2 extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		if(request.getParameter("grabar") !=  null){
			...
			try {
			    ...
			    String SQL_UPDATE = ""
			    		+ "UPDATE empresas "
			    		+ "SET estados_vig_novig_id=2,empresas_accion_alertada=0, empresas_ult_idper_exec=17"
	            ...
	            RequestDispatcher rd_up = request.getRequestDispatcher("Eclpr?mExito=OK");
		...
		RequestDispatcher rd = request.getRequestDispatcher("Eclpr2.jsp");
