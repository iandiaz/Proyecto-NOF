...
String PR1=(String)request.getAttribute("PR1");
String PR2=(String)request.getAttribute("PR2");
...
padding: 5px 5px 5px 5px;
  ...
  <% if(PR1.equals("1")){%> <option value="1" selected="selected" >1.- REPORTE CLIENTE-PROVEEDOR</option> <%} %>
    <% if(PR2.equals("1")){%> <option value="2" >2.- REPORTE CLIENTE-PROVEEDOR POR RESPONSABLE</option> <%} %>
  ...
  <div class="divhead"><strong>EMPRESA:</strong><select name="select_empresa" id="select_empresa">
    ...
    <div class="divhead"><strong>RESPONSABLE CUENTA:</strong><select name="select_responsable" id="select_responsable" style="margin:0px 0px 0px 0px;width: 500px; margin-bottom: 9px">
  	<option value="" selected="selected">TODOS</option>
