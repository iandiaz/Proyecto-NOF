  ...
  <!--<![endif]-->
   <script type="text/javascript">
  	function detelePerfil(id_g,nombre_g){
  		if(confirm("¿ESTA SEGURO QUE DESEA ELIMINAR LA ALERTA TEMPORAL'"+nombre_dato+"' ?")){
  			document.getElementById('delete_id').value=id_g;
  			document.getElementById('deleteaccion').submit();
  		}
  		
  	}
  </script>
  
  <form id="deletegruper" action="" method="post" style="margin: 0px 0px 0px 0px;">
    ...
    <div class="navbar">
                    ...
                    <form method="get" action="ealertemp" style="margin: 0px 0px 0px 0px">                
                    <button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
                    </form>
                    <button type="button" onclick="location='/995/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
                   
                    <div align="center" class="title">
                    <p >ELIMINAR ALERTA TEMPORAL</p>
                    </div>
         ...
         <input maxlength="50" type="text" id="searchInput" class="form-control span12" style="width:570px;height:30px" autofocus="autofocus">
                    </div>
</div>
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR ALERTA TEMPORAL A ELIMINAR</p> </h3>
...
<td width="570px" style="font-size:20px"  ><strong>NOMBRE</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<arAlertas.length; i++){
			...
			<tr class="hov" style="color:<%=Alertas[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='ealertemp_del?id_a=<%=Alertas[0]%>';">
				<td width="47px"><%=Alertas[0]%></td>
				<td width="570px"><%=Alertas[1]%></td>
