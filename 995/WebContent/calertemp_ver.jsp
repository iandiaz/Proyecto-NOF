...
<div class="navbar">                  
	...
	<div class="version" align="right"><p>N995.C.02.001</p></div>
	<form method="get" action="calertemp_ver" style="margin:0px 0px 0px 0px">                 
		<button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
	</form>
	<button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onClick="location='calertemp_search'">VOLVER</button>
	<div align="center" class="title" ><p >CONSULTAR ALERTAS TEMPORALES</p></div>               
</div>    
<div class="content" >
	<div class="cuadroblanco" >
		<div class="divhead"><strong>ID:</strong><input type="text" value="<%=correlativo %>" style="width:50px;height:30px; background:#FFF;color: #000;" disabled="disabled" >
		</div>		
		<div class="divhead"><strong>NOM:</strong><input type="text" value="<%=alertas_temp_nombre%>" style="width:570px;height:30px; background:#FFF;color: #000;" disabled="disabled" ></div>
		...
		<div class="divhead"><strong>ESTADO TICKET:</strong><input type="text" value="<%=ticket_estados_nombre%>" style="width:290px;height:30px; background:#FFF;color: #000;" disabled="disabled">
		  ...
		  <div class="divhead"><strong>TIPO TICKET:</strong><input type="text" value="<%=tipo_ticket_nombre%>" style="width:290px;height:30px; background:#FFF;color: #000;" disabled="disabled" ></div>
        ...
        <div class="divhead"><strong>MENSAJE:</strong><input  autofocus="autofocus" type="text" style="width:800px;height:30px; background:#FFF;color: #000;" value="<%=alertas_temp_descripcion %>" disabled="disabled" >
        </div>
