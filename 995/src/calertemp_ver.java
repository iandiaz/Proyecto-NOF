...
/**
 * Servlet implementation class calertemp_ver
 */
@WebServlet("/calertemp_ver")
public class calertemp_ver extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public calertemp_ver() {
        super();
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
  		...
  		//::::::::::::::::::::::::::fin sql trae estados vig no vig para select option:::::::::::::::::::::::::::::::::::::
    		...
    		String SQL_GRUPO = ""
		    		...
		    		+ "		DATE_FORMAT(a.alertas_temp_feccreacion,'%d-%m-%Y %H:%i:%s') AS perfilusu_feccreacion_ok, "
		    		+ "		IF ( "
		    		...
		    		+ " FROM alertas_temp a "
		    		+ "		LEFT JOIN ticket_estados t ON a.ticket_estados_id=t.ticket_estados_id"
		...
		String msg="";
		if(existeAlerta){}
		RequestDispatcher rd = request.getRequestDispatcher("calertemp_ver.jsp");
