...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/071/E01'">VOLVER</button> 
	<div align="center" class="title">
		<p>ELIMINAR <%=modname %></p>
	</div>
</div>
<div class="content" >
  <form action="E02" name="form1" method="post" id="form1" > 
  	<input type="hidden" name="id" readonly="readonly" value="<%=OC.getId() %>" >
