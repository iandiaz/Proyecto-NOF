        ...
        .done(function( data ) {
        	$('#fbody').empty();
          		...
          		$.each( ocs_arr, function( key, oc ) {
          			...
          			if(oc.estadoVigNoVig.id==1){
          				classvnv="vig";
          			}
          				
          			if(oc.estadoVigNoVig.id==2){
          				classvnv="novig";
          			}
          			
          				
          			var line="<tr class='hov "+classvnv+"' onclick=\"location='M02?id="+oc.id+"';\" style='font-size:20px'  >";
          			
          			line+="<td width=\"60px\" >"+oc.nro+"</td>";
          			
          			line+="<td width='300px' >"+oc.cliente.nombre_nof+"</td>";
          			line+="<td width='250px' >"+oc.proveedor.nombre_nof+"</td>";
          			
          			line+="<td width='430px' >"+oc.direccion.direccion+"</td>";
          			line+="<td width='146px' >"+oc.estadoVigNoVig.nombre+"</td>";
...
<div class="navbar">
		...
		<p >MODIFICAR <%=modname %></p>
         ...
         <div class="menu"  style="min-width: 1200px;max-width: 1200px;">
         	<div class="titulomenu" style="border: 1px solid black;min-width: 1200px;max-width: 1200px;">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR OC A MODIFICAR</p> </h3>
			</div>
  ...
  <table class="table" style="margin-left:0px; width:100%;">
	...
	<tr style="background-color:#0101DF;color:#FFFFFF">
		<td width="60px" style="font-size:20px"><strong>NRO</strong></td>
		<td width="300px" style="font-size:20px"><strong>CLIENTE</strong></td>
	
		<td width="250px" style="font-size:20px"><strong>PROVEEDOR</strong></td>
		<td width="430px" style="font-size:20px"><strong>DIRECCION</strong></td>
