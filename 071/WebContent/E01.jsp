        ...
        .done(function( data ) {
        	$('#fbody').empty();
          		...
          		$.each( ocs_arr, function( key, oc ) {
          			...
          			var line="<tr class='hov "+classvnv+"' onclick=\"location='E02?id="+oc.id+"';\" style='font-size:20px'  >";
		...
		<p >ELIMINAR <%=modname %></p>
         ...
         <div class="menu"  style="min-width: 1200px;max-width: 1200px;">
         	<div class="titulomenu" style="border: 1px solid black;min-width: 1200px;max-width: 1200px;">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR OC A ELIMINAR</p> </h3>
			</div>
