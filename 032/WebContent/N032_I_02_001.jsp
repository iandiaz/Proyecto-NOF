...
margin: 0 auto;
    ...
    function autorizar(){
    	...
    	if(confirm("¿ESTÁ SEGURO QUE DESEA APROBAR ESTA ORDEN DE COMPRA?")){
    		$.post( "modificarOCAsync?id_est_autorizacion=2", $( "#form1" ).serialize())
    	    .done(function( data ) {
    	    	if(data.trim()=="OK"){
    ...
    function rechazar(){
    	if(confirm("¿ESTÁ SEGURO QUE DESEA RECHAZAR ESTA ORDEN DE COMPRA?")){
    	$.post( "modificarOCAsync?id_est_autorizacion=3", $( "#form1" ).serialize())
	    .done(function( data ) {
	    	if(data.trim()=="OK"){
	    		alert("OPERACION REALIZADA CON EXITO");
        		  location="N<%=Constantes.MODULO%>_1_01_001";  
  ...
  <form action="" name="form1" method="post" id="form1" > 
  	...
  	<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><span style="margin:0px 0px;font-size:20px;">DATOS OC </span> </h3>
		...
		<div style="padding: 5px 5px 5px 5px;">
			...
			<div class="divhead vertical-middle"><strong>ESTADO APROBACION:</strong><input type="text" style="width:120px;height:30px ;" value="${oc.estado_aprobacion.nombre}" readonly="readonly"></div>
	...
	<div class=" cuadroblanco loaded" style="height:auto;margin-top: 5px;overflow: auto; min-height: 40px">
		<button type="button" onclick="autorizar()" class="btn btn-success" style="position: absolute;bottom: 0; right: 0;margin: 2px 2px 2px 2px;" >AUTORIZAR</button>
		<button type="button" onclick="rechazar()" class="btn btn-success" style="position: absolute;bottom: 0; right: 120px;margin: 2px 2px 2px 2px;" >RECHAZAR</button>	
	</div>
