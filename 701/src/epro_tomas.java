...
/**
 * Servlet implementation class epro_tomas
 */
@WebServlet("/epro_tomas")
public class epro_tomas extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
    		...
    		state = (Statement) ((java.sql.Connection) conexion).createStatement();
    		 ...
    		 String SQL_Alertas = "SELECT ep.estado_periodo_id,ep.estado_periodo_nombre,p.peri_tc_correlativo,p.peri_tc_id, m.empresas_razonsocial,m.empresas_nombrenof, e.estados_vig_novig_id, e.estados_vig_novig_nombre,"
    	...
    	System.out.println(SQL_Alertas);
		    ...
		    while(Alertas_RS.next()){        	   
		    	alertas.add(Alertas_RS.getString("peri_tc_id")+"/"+
		    				...
		    				Alertas_RS.getString("peri_tc_fdesde")+"/"+
		    				Alertas_RS.getString("peri_tc_fhasta")+"/"+
		...
		RequestDispatcher rd = request.getRequestDispatcher("epro_tomas.jsp");
