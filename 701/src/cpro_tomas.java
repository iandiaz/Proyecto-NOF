...
/**
 * Servlet implementation class cpro_tomas
 */
@WebServlet("/cpro_tomas")
public class cpro_tomas extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		RequestDispatcher rd = request.getRequestDispatcher("cpro_tomas.jsp");
