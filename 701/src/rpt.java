...
public class rpt extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("grabar_excel") !=  null && request.getParameter("informe").equals("1")){
			...
			if(request.getParameter("f3") !=  null && !request.getParameter("f3").equals("") ){
				filtros+="&id_f3="+request.getParameter("f3")+"";
			...
			if(request.getParameter("estado_periodo_id") !=  null && !request.getParameter("estado_periodo_id").equals("") ){
				filtros+="&estper="+request.getParameter("estado_periodo_id")+"";
				
			}
			if(request.getParameter("fec_fac_check") !=  null && request.getParameter("fec_fac_check").equals("1") ){
				filtros+="&ffac_c="+request.getParameter("fec_fac_check")+"";
				
			}
			
			
			
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_1_xls.php?"+filtros+"';</script>");
		}
		if(request.getParameter("grabar_excel") !=  null && request.getParameter("informe").equals("2")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_2_xls.php?"+filtros+"';</script>");
		}
		if(request.getParameter("grabar_excel") !=  null && request.getParameter("informe").equals("3")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_3_xls.php?"+filtros+"';</script>");
		}
		...
		if(request.getParameter("grabar_excel") !=  null && request.getParameter("informe").equals("4")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_4_xls.php?"+filtros+"';</script>");
		}
		if(request.getParameter("grabar_excel") !=  null && request.getParameter("informe").equals("5")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_5_xls.php?"+filtros+"';</script>");
		}
		/////////////////////////////PDF 
		...
		if(request.getParameter("grabar_pdf") !=  null && request.getParameter("informe").equals("1")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/generaPDF.php?inf=701-1&usu="+usuario+filtros+"';</script>");
		}
		if(request.getParameter("grabar_pdf") !=  null && request.getParameter("informe").equals("2")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/generaPDF.php?inf=701-2&usu="+usuario+filtros+"';</script>");
		}
		...
		if(request.getParameter("grabar_pdf") !=  null && request.getParameter("informe").equals("3")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/generaPDF.php?inf=701-3&usu="+usuario+filtros+"';</script>");
		}
		if(request.getParameter("grabar_pdf") !=  null && request.getParameter("informe").equals("4")){
			PrintWriter out = response.getWriter();
			String filtros="";
			if(request.getParameter("f1") !=  null && !request.getParameter("f1").equals("") ){
				filtros+="&id_f1="+request.getParameter("f1")+"";
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/generaPDF.php?inf=701-4&usu="+usuario+filtros+"';</script>");
		}
        ...
        if(request.getParameter("grabar_pdf") !=  null && request.getParameter("informe").equals("5")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/generaPDF.php?inf=701-5&usu="+usuario+filtros+"';</script>");
		}
   ...
   /////////////////////GENERAR POR WEB ////////////////////////
        ...
        if(request.getParameter("grabar_web") !=  null && request.getParameter("informe").equals("1")){
          ...
          if(request.getParameter("select_grupo") !=  null && !request.getParameter("select_grupo").equals("") ){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_1_pdf.php?inf=701-1&usu="+usuario+filtros+"';</script>");
		}
        if(request.getParameter("grabar_web") !=  null && request.getParameter("informe").equals("2")){
          ...
          if(request.getParameter("select_grupo") !=  null && !request.getParameter("select_grupo").equals("") ){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_2_pdf.php?inf=701-1&usu="+usuario+filtros+"';</script>");
		}
        if(request.getParameter("grabar_web") !=  null && request.getParameter("informe").equals("3")){
          ...
          if(request.getParameter("select_grupo") !=  null && !request.getParameter("select_grupo").equals("") ){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_3_pdf.php?inf=701-3&usu="+usuario+filtros+"';</script>");
		}
        if(request.getParameter("grabar_web") !=  null && request.getParameter("informe").equals("4")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_4_pdf.php?inf=701-4&usu="+usuario+filtros+"';</script>");
		}
        ...
        if(request.getParameter("grabar_web") !=  null && request.getParameter("informe").equals("5")){
			...
			out.write("<script>window.location='http://"+request.getServerName()+":81/NOF/rpt_701_5_pdf.php?inf=701-5&usu="+usuario+filtros+"';</script>");
		}
