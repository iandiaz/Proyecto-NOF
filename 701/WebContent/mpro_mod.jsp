...
String estado_periodo_id=(String)request.getAttribute("estado_periodo_id");
String ar_estperi[]=(String [])request.getAttribute("ar_estperi");
...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>New Office - Modificar Periodos Toma de Contadores</title>
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/701/mpro_tomas?empresas_id=<%=empresas_id%>'">VOLVER</button> 
	<div align="center" class="title">
		<p >MODIFICAR PERIODOS TOMA DE CONTADORES Y FACTURACION</p>
	</div>
</div>
<div class="content" >
<form action="" name="form1" method="post">
  ...
  <input type="hidden" name="peri_tc_id_emp" value="<%=empresas_id%>" >
	<div class=" cuadroblanco" style="height:425px;">
		...
		<div class="divhead"><strong>PERIODO:</strong><input type="text" style="width:80px;height:30px ;background:#FFF;" disabled="disabled" value="<%=peri_tc_id%>"></div>
		...
		<div class="divhead"><strong>FECHA DESDE:</strong><input type="text" style="width:130px;height:30px ;background:#FF3;" id="datepicker" name="f1" class="amarillo" readonly="readonly" value="<%=peri_tc_fdesde%>"></div>
		<div class="divhead"><strong>FECHA HASTA:</strong><input type="text" style="width:130px;height:30px ;background:#FF3;" id="datepicker2" name="f2" class="amarillo" readonly="readonly" value="<%=peri_tc_fhasta%>"></div>
<div class="divhead"><strong>FECHA FACTURACION:</strong><input type="text" style="width:130px;height:30px ;background:#FF3;" id="datepicker3" name="f3" class="amarillo" readonly="readonly" value="<%=peri_ffac%>"></div>
		<div class="divhead"><strong>ESTADO:</strong><select name="estados_vig_novig_id" id="estados_vig_novig_id" style="margin:0px 0px 0px 0px;width: 150px">
    		...
    		<div class="divhead"><strong>ESTADO PER:</strong><select name="estado_periodo" id="estado_periodo" style="margin:0px 0px 0px 0px;width: 170px">
    		<% for(int i =0; i<ar_estperi.length; i++){
       			String[] estados_vig_novig = ar_estperi[i].split("/");
    		%>
     			<option value="<%=estados_vig_novig[0]%>" <% if(estado_periodo_id.equals(estados_vig_novig[0]))%><%="selected"%>><%=estados_vig_novig[1] %></option>
    		<% } %>
    		</select><span class="cabecera" style="color:#F00">*</span></div>
		<div class="divhead"><strong>Fecha creación:</strong><input type="text" style="width:225px;height:30px; background:#FFF;" disabled="disabled" value="<%=fec_crea%>"></div>
		<div class="divhead"><strong>Usuario creador:</strong><input type="text" style="width:400px;height:30px; background:#FFF;" disabled="disabled" value="<%=user_crea%>"></div>
		<div class="divhead"><strong>Fecha última mod:</strong><input type="text" style="width:225px;height:30px; background:#FFF;" disabled="disabled" value="<%=fec_mod%>"></div>
		<div class="divhead"><strong>Usuario última mod:</strong><input type="text" style="width:400px;height:30px; background:#FFF;" disabled="disabled" value="<%=user_mod%>"></div>
		<div class="bgrabar"  >
