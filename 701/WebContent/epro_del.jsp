...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>New Office - Eliminar Periodos Toma de Contadores</title>
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/701/epro_tomas?empresas_id=<%=empresas_id%>'">VOLVER</button> 
	<div align="center" class="title">
		<p >ELIMINAR PERIODOS TOMA DE CONTADORES Y FACTURACION</p>
	</div>
</div>
<div class="content" >
<form action="epro_del" name="form1" method="post">
  ...
  <input type="hidden" name="peri_tc_id_emp" value="<%=empresas_id%>" >
	<div class=" cuadroblanco" style="height:425px;">
		...
		<div class="divhead"><strong>Fecha creación:</strong>
		...
		<div class="divhead"><strong>Fecha última mod:</strong>
			<input type="text" style="width:225px;height:30px; background:#FFF;" disabled="disabled" value="<%=fec_mod%>"></div>
		<div class="divhead"><strong>Usuario última mod:</strong>
			<input type="text" style="width:400px;height:30px; background:#FFF;" disabled="disabled" value="<%=user_mod%>"></div>
		<div class="bgrabar"  >
           <button type="submit" name="grabar" class="btn btn-success" <% if(!peri_tc_id_last.equals(peri_tc_id)){ %> disabled="disabled" <% } %>>GRABAR</button>
		</div>
	</div>
</form>
</div><br><br><br>
