...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>New Office - Modificar Programacion Toma de Contadores</title>
...
<div class="content" >
  ...
  <input type="hidden" name="empresas_id" value="<%=empresas_id%>" >
	<div class=" cuadroblanco" style="height:150px;">
		...
		<div class="divhead"><strong>RAZON SOCIAL:</strong><input type="text" style="width:600px;height:30px ;background:#FFF;" disabled="disabled" value="<%=empresas_id%>"></div>
		<strong style="font-size:20px;">FECHA DESDE:</strong><input maxlength="35" value="" type="text" id="datepicker" name="f1" class="amarillo" style="width:130px;height:30px ;background:#FF3;" >
        <strong style="font-size:20px;">FECHA HASTA:</strong><input maxlength="35" value="" type="text" id="datepicker2" name="f2" class="amarillo" style="width:130px;height:30px ;background:#FF3;" >
		<div class="bgrabar"  >
	...
	<div class=" cuadroblanco" style="height:200px;">
		...
		<p style="margin:0px 0px;font-size:20px;background-color: #39F">DATOS PROGRAMACIONES</p></h3>
		<table class="table" style="width:100%;">
			<thead style="border: 1px solid black;">
			   <tr style="background-color:#0101DF;color:#FFFFFF">
				<td width="100px" style="font-size:20px"><strong>ID</strong></td>
				<td width="350px" style="font-size:20px"><strong>DESDE</strong></td>
				<td width="350px" style="font-size:20px"><strong>HASTA</strong></td>
			  </tr>  
        ...
        for(int i =0; i<ar_productos.length; i++){
       	 ...
       	 %>
			<tr class="hov">
				<td width="100px"><%=ProdDato[0]%></td>
				<td width="350px"><%=ProdDato[1]%></td>
				<td width="350px"><%=ProdDato[2]%></td>
			</tr>
       	<% } %>
			</tbody>
		  </table>
