...
<div class="navbar">
	...
	<div align="center" class="title">
		<p >MODIFICAR ADMINISTRACION DE FOLIOS</p>
	</div>
</div>
<div class="content" >
  <form action="" name="form1" method="post">
	...
	<div class=" cuadroblanco" style="height:200px;margin-top: 5px;">
		...
		<p style="margin:0px 0px;font-size:20px;background-color: #39F">SELECCIONAR RANGO DE FOLIOS A MODIFICAR </p></h3>
        ...
        for(int i =0; i<ar_admfolios.length; i++){
			...
			onclick="location='m2?id=<%=ProdDato[4]%>';" >
				<td width="200px" ><%=ProdDato[0]%></td>
