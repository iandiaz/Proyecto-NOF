...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/850/c1'">VOLVER</button> 
	<div align="center" class="title">
		<p >CONSULTAR ADMINISTRACION DE FOLIOS</p>
	</div>
</div>
<div class="content" >
  <form action="" name="form1" method="post">
 	<div class=" cuadroblanco" style="height:280px;">
		...
		<div class="divhead" style="width: 400px;"><strong>ID:</strong><input type="text" style="width:60px;height:30px ;background:#FFF;"  readonly="readonly" value="<%=id%>"></div>
		
		<div class="divhead"><strong>COD DTE:</strong><input type="text" style="width:40px;height:30px ;background:#FFF;"  readonly="readonly" value="<%=tipodte%>" name="tipodte"><input type="text" style="width:340px;height:30px ;background:#FFF;"  readonly="readonly" value="<%=nomdte%>"></div>
		...
		<div class="divhead"><strong style="font-size:20px;">FOLIO DESDE:</strong><input  value="<%=fdesde %>" type="text"   readonly="readonly" style="width:130px;height:30px ;background:#FFF;text-align: right;" ></div>
        <div class="divhead"><strong style="font-size:20px;">FOLIO HASTA:</strong><input  value="<%=fhasta %>" type="text" readonly="readonly"  style="width:130px;height:30px ;background:#FFF;text-align: right;" ></div>
		...
		<div class="divhead"><textarea maxlength="195"   name="admfolios_correo_aviso" id="admfolios_correo_aviso" readonly="readonly" style="width:730px;height:70px ;background:#FFF;text-transform:uppercase;" ><%=admfolios_correo_aviso %></textarea></div>
