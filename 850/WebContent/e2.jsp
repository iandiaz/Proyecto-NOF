...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/850/e1'">VOLVER</button> 
...
<div class="content" >
  <form action="" name="form1" method="post">
 	<div class=" cuadroblanco" style="height:240px;">
		...
		<div class="divhead"><strong style="font-size:20px;">FOLIO DESDE:</strong><input  value="<%=fdesde %>" type="text"   readonly="readonly" style="width:130px;height:30px ;background:#FFF;" name="fdesde"></div>
        <div class="divhead"><strong style="font-size:20px;">FOLIO HASTA:</strong><input  value="<%=fhasta %>" type="text" readonly="readonly"  style="width:130px;height:30px ;background:#FFF;"  name="fhasta" ></div>
