...
margin: 0 auto;
  ...
  <div class="content" >
         ...
         <form action="Igrupo" name="form1" method="post">
  ...
  <tr>
    <td><div class="divhead"><strong>NOMBRE:</strong><input maxlength="25" autofocus="autofocus" type="text" class="amarillo" style="width:290px;height:30px ;background:#FF3;border: 1px solid #FFFF00;" name="grupos_nombre" id="grupos_nombre" value="<%=grupos_nombre %>" required >
