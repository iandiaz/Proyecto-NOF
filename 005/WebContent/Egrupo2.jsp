...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='Egrupo'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
                   
                    <div align="center" class="title" >
                    <p >ELIMINACION DE GRUPO</p>
                    </div>
  ...
  <table class="table-movil" border="0" align="center">
	...
	<td><div class="divhead"><strong>Usuario última mod:</strong><input type="text" value="<%=user_mod%>" style="width:400px;height:30px; background:#FFF;color: #000 " disabled="disabled">
          ...
          <div class="bgrabar" >
           <button onclick="location='Egrupo2?delete_id=<%=grupos_id%>';" type="button" name="grabar" id="grabar" class="btn btn-success" >GRABAR</button>
           </div> 
