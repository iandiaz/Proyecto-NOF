...
/**
 * Servlet implementation class Mgrupo2
 */
@WebServlet("/Mgrupo2")
public class Mgrupo2 extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		if(request.getParameter("grabar") !=  null){
			...
			try {
	    		...
	    		String sql_valgrupo="SELECT * FROM grupos WHERE grupos_nombre='"+grupos_nombre.toUpperCase()+"' AND grupos_id<>"+request.getParameter("id_g");
			    ...
			    String SQL_UPDATE = ""
			    		+ "UPDATE grupos "
			    		+ " SET grupos_accion_alertada=0 "
			    		+ "		,grupos_ult_idper_exec=10 "
			    		+ "		,grupos_nombre='"+grupos_nombre.toUpperCase()+"', estados_vig_novig_id="+estados_vig_novig_id+" "
			    		+ " 	,grupos_fecmod=now() "
			    		+ " 	,grupos_modificador= "+id_iusuario
			    		+ " WHERE grupos_id="+request.getParameter("id_g");
	            ...
	            RequestDispatcher rd_up = request.getRequestDispatcher("Mgrupo?mExito=OK");
		...
		RequestDispatcher rd = request.getRequestDispatcher("Mgrupo2.jsp"+msg);
