...
<html lang="en">
  ...
  <div class="content">
        ...
        <div class="movilButons">
         ...
         <button type="button" class="btn btn-warning movile" disabled="disabled" >MODIFICAR</button>
         <button type="button" class="btn btn-primary movile" disabled="disabled" >CONSULTAR</button>
         <button type="button" class="btn btn-info movile"  onClick="location='rpt'"  >REPORTES</button>
        </div>
