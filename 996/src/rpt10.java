...
/**
 * Servlet implementation class rpt10
 */
@WebServlet("/rpt10")
public class rpt10 extends HttpServlet {
	...
	public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		PrintWriter out = response.getWriter();		
	  	...
	  	String[] select_vendedor = request.getParameterValues("select_vendedor[]");
			if(select_vendedor!=null)for (String ven:select_vendedor ) {
				System.out.println("vendedor seleccionado: "+ven);
		...
		request.setAttribute("select_grupo", idgrupo);
		request.setAttribute("select_empresa", idemp);
		request.setAttribute("select_year", select_year);
		request.setAttribute("select_month", select_month);
		request.setAttribute("select_vendedor", select_vendedor);
		...
		request.setAttribute("ar_select_periodo", PeriodosDAO.getPeriodosVigentesParaSelect());
		 ...
		 request.setAttribute("ar_vendedores", UsuariosDAO.getVendedores());
     
        RequestDispatcher a = request.getRequestDispatcher("rpt10.jsp");
