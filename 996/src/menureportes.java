...
/**
 * Servlet implementation class menureportes
 */
@WebServlet("/menureportes")
public class menureportes extends HttpServlet {
	...
	public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		PrintWriter out = response.getWriter();
	        ...
	        RequestDispatcher a = request.getRequestDispatcher("menureportes.jsp");
