...
String neto=(String)request.getAttribute("fac_servim_total");
String desc=(String)request.getAttribute("DESC");	
String iva=(String)request.getAttribute("fac_servotros_iva");	
if(fac_servim_tipodte.equals("34") || fac_servim_tipodte.equals("32")){iva="0";}
String netodesc=(String)request.getAttribute("fac_servotros_neto");	
String totalfinal=(String)request.getAttribute("fac_servotros_totalfinal");	
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/804/mfac1'">VOLVER</button> 
	<div align="center" class="title">
		<p>MODIFICAR FACTURA AFECTA - EXENTA SERVICIOS OTROS</p>
	</div>
</div>
<div class="content" >
	...
	<div class=" cuadroblanco" style="height:160px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>FECHA:</strong><input type="text" style="width:130px;height:30px ;background:#FF3;"  value="<%=FAC_FECHA %>" readonly="readonly" class="amarillo" id="datepicker3" name="gv_fecha"></div>
	...
	<div class=" cuadroblanco" style="height:275px;margin-top: 5px;">
		...
		<div class="divhead"><strong>CIUDAD:</strong><input id="gv_ciudad" name="gv_ciudad" type="text" style="width:350px;height:30px ;background:#FFF;" readonly="readonly" value="<%=DIRE_CIUDAD %>" ></div>
		...
		<div class="divhead"><strong>RESPONSABLE CUENTA:</strong><input type="text" id="resp" name="resp" style="width:350px;height:30px ;background:#FFF;" readonly="readonly" value="<%=PERS_NOMBRE%>"></div>
	</div>
	...
	<div class=" cuadroblanco" style="height:120px;margin-top: 5px;">
		...
		<div class="divhead"><strong>E-MAIL:</strong><input type="text" id="cont_mail" name="cont_mail"  style="width:350px;height:30px ;background:#FFF;" readonly="readonly" value="<%=CONT_EMAIL%>"></div>
	...
	<div class=" cuadroblanco" style="height:235px;margin-top: 5px;">
		...
		%>
		<div class="divhead"><strong>SERV OTROS <%=i+1%>:</strong><input type="text" maxlength="53"  class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv<%=i+1 %>" id="serv<%=i+1 %>" value="<%=servicio%>" ></div>
	...
	<div class=" cuadroblanco" style="height:120px;margin-top: 5px;">
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>SUBTOTAL:</strong><input name="total" id="total" type="text" style="width:150px;height:30px ;background:#FFF;"  value="<%=neto%>"  readonly="readonly"></div>
		...
		<div class="divhead"><strong>TOTAL:</strong><input type="text" style="width:150px;height:30px ;background:#FFF;" readonly="readonly"  value="<%=totalfinal%>" id="totaltotal" name="totaltotal"></div>
