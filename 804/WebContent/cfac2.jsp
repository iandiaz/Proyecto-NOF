...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/804/cfac1'">VOLVER</button> 
	<div align="center" class="title">
		<p>CONSULTAR FACTURA AFECTA - EXENTA SERVICIOS OTROS</p>
	</div>
</div>
<div class="content" >
