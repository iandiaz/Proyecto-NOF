...
<div class="navbar">
	...
	<div align="center" class="title">
		<p>INGRESAR FACTURA AFECTA - EXENTA SERVICIOS OTROS</p>
	</div>
</div>
<div class="content" >
  <form action="" name="form1" id="form1" method="post" > 
	...
	<div class=" cuadroblanco" style="height:235px;margin-top: 5px;">
		...
		<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>SERV OTROS 1:</strong><input type="text" maxlength="53"  class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv1" id="serv1" value="" autofocus="autofocus" ></div>
		...
		<div class="divhead"><strong>SERV OTROS 2:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv2" id="serv2" value=""></div>
		...
		<div class="divhead"><strong>SERV OTROS 3:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv3" id="serv3" value=""></div>
		...
		<div class="divhead"><strong>SERV OTROS 4:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv4" id="serv4" value=""></div>
		...
		<div class="divhead"><strong>SERV OTROS 5:</strong><input type="text" maxlength="53" class="amarillo" style="width:600px;height:30px ;background:#FF3;" name="serv5" id="serv5" value=""></div>
	...
	<div style="padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong id="netolabel">AFECTO:</strong><input type="text" style="width:130px;height:30px ;background:#FFF;" value="" id="netoneto" name="netoneto" readonly="readonly"></div>
		<div class="divhead"><strong>IVA 19%:</strong><input type="text" style="width:120px;height:30px ;background:#FFF;" value="" id="iva" name="iva" readonly="readonly"></div>
...
<div class=" cuadroblanco" style="height:80px;margin-top: 5px">
	...
	<div class=" cuadroblanco" style="height:120px;margin-top: 5px;">
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>TIPO CAMBIO:</strong><input type="text" name="fac_servim_tcambio" id="fac_servim_tcambio" class="amarillo" maxlength="9" style="width:120px;height:30px ;background:#FF3;" value="" onkeydown="return validateNum(event)"><span class="cabecera" style="color:#F00">*</span></div>
