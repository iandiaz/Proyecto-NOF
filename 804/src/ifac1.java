	...
	if(request.getParameter("grabar") != null){
		try {
			...
			String SQL_GUIA = ""
					...
					+ "	`804`.`804_ciudad`,  "
					+ "	`804`.`804_empresa_emisora_nombre`,  "
					+ "	`804`.`cont_email`,  "
					+ "	`804`.`cont_telefono`,  "
					+ "	`804`.`cont_nombre`,  "
					+ "	`804`.`804_responsable`  "
			...
			if(request.getParameter("serv1")!="" && request.getParameter("val1")!=""){
				...
				String SQL_FACDET = "INSERT INTO detalle_804 (`detalle_804`.`804_id`,`detalle_804`.`d804_valor`,`detalle_804`.`d804_descripcion`) VALUES ("+GID+","+val1+",'"+serv1.toUpperCase()+"')";
			...
			if(request.getParameter("serv2")!="" && request.getParameter("val2")!=""){
				...
				String SQL_FACDET = "INSERT INTO detalle_804 (`detalle_804`.`804_id`,`detalle_804`.`d804_valor`,`detalle_804`.`d804_descripcion`) VALUES ("+GID+","+val2+",'"+serv2.toUpperCase()+"')";
	            state.executeUpdate(SQL_FACDET);}
			if(request.getParameter("serv3")!="" && request.getParameter("val3")!=""){
				...
				String SQL_FACDET = "INSERT INTO detalle_804 (`detalle_804`.`804_id`,`detalle_804`.`d804_valor`,`detalle_804`.`d804_descripcion`) VALUES ("+GID+","+val3+",'"+serv3.toUpperCase()+"')";
	            state.executeUpdate(SQL_FACDET);}
			if(request.getParameter("serv4")!="" && request.getParameter("val4")!=""){
				...
				String SQL_FACDET = "INSERT INTO detalle_804 (`detalle_804`.`804_id`,`detalle_804`.`d804_valor`,`detalle_804`.`d804_descripcion`) VALUES ("+GID+","+val4+",'"+serv4.toUpperCase()+"')";
	            state.executeUpdate(SQL_FACDET);}
			if(request.getParameter("serv5")!="" && request.getParameter("val5")!=""){
				...
				String SQL_FACDET = "INSERT INTO detalle_804 (`detalle_804`.`804_id`,`detalle_804`.`d804_valor`,`detalle_804`.`d804_descripcion`) VALUES ("+GID+","+val5+",'"+serv5.toUpperCase()+"')";
	            state.executeUpdate(SQL_FACDET);}
			//--------------------- FIN -----------------------//
    		...
    		String log_sql=""
    				...
    				+ " ) "
    				+ " VALUES "
    				+ " (now(), 'USUARIO INGRESA REGISTRO "+GID+" A LA TABLA 804', '"+id_iusuario+"') ";
