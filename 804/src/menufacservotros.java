...
/**
 * Servlet implementation class menuservotros
 */
@WebServlet("/menufacservotros")
public class menufacservotros extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * Default constructor. 
     */
    public menufacservotros() {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
    		...
    		String log_sql=""
    				...
    				+ " ) "
    				+ " VALUES "
    				+ " (now(), 'USUARIO INGRESA AL MENU DEL MODULO 804', '"+id_iusuario+"') ";
		...
		///////////////////////////////////////////////////////////
		RequestDispatcher rd = request.getRequestDispatcher("menufacservotros.jsp");
