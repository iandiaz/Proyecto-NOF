...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/802/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
...
<div align="center" class="form-group has-warning" style="font-size: 20px"> 
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR FACTURA AFECTA - EXENTA GUIA RESUMEN A MODIFICAR (QUE NO HAYA SIDO ENVIADA A SII)</p></h3>
...
<td width="600px" style="font-size:20px"  ><strong>NOMBRE</strong></td>
<td width="200px" style="font-size:20px"><strong>TOTAL</strong></td>
<td width="160px" style="font-size:20px"><strong>ESTADO</strong></td>
</tr>  
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         for(int i =0; i<arestado_clpr.length; i++){
	         ...
	         String valString = nf.format(Integer.parseInt(estado_clpr[4])).replace(",",".");
        	 %>
        		
			<tr class="hov" style="color:<%=estado_clpr[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=estado_clpr[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='mres_mod?guiaresumen_id=<%=estado_clpr[0]%>';">
				<td width="50px"><%=estado_clpr[0]%></td>
				<td width="600px"><%=estado_clpr[1]%></td>
				<td width="200px">$ <%=valString%></td>
				<td width="150px"><%=estado_clpr[3]%></td>
