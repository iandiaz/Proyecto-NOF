...
<html lang="en">
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR CLIENTE</p> </h3>
...
<td width="750px" style="font-size:20px"  ><strong>NOMBRE</strong></td>
<td width="200px" style="font-size:20px"><strong>ESTADO</strong></td>
</tr>  
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 if(cuenta.equals("1")){
         ...
         for(int i =0; i<arestado_clpr.length; i++){
			...
			<tr class="hov" style="color:<%=estado_clpr[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=estado_clpr[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='ires_add?n=1&clientes_id=<%=estado_clpr[0]%>';">
				<td width="50px"><%=estado_clpr[0]%></td>
				<td width="750px"><%=estado_clpr[1]%></td>
				<td width="200px"><%=estado_clpr[3]%></td>
			</tr>
			
        	<% }
        }else{%>
        <center>NO EXISTEN CLIENTES CON GUIAS PENDIENTES DE FACTURAR.</center>
