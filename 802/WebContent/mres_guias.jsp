...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/802/mres_mod?guiaresumen_id=<%=guiaresumen_id %>'">VOLVER</button> 
...
<div class="content">        
	<div class="containermenu">
         <div class="menu">
			...
			<form method="post" action="mres_mod" style="margin:0px 0px 0px 0px">
			
			<input type="hidden" name="empresa_emisor" value="<%=empresa_emisor %>" >
			<input type="hidden" name="afecta" value="<%=afecta %>" >
			
			<input type="hidden" style="width:120px" name="guiaresumen_id" value="<%=guiaresumen_id %>" >
        	<div style=" max-height:400px; width:1000px; ">
				...
				%>
						<tr class="hov">
							<td width="10px" ><input type="checkbox" value="<%=Alertas[0]%>/<%=Alertas[2]%>/<%=Alertas[3]%>" name="permisos[]" class="ck_deta" <%=check %>></td>
