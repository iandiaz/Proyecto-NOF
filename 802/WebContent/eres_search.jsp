...
<div align="center" class="form-group has-warning" style="font-size: 20px"> 
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR FACTURA AFECTA - EXENTA GUIA RESUMEN A ELIMINAR (QUE NO HAYA SIDO ENVIADA A SII)</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<arestado_clpr.length; i++){
			...
			<tr class="hov" style="color:<%=estado_clpr[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=estado_clpr[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='eres_del?guiaresumen_id=<%=estado_clpr[0]%>';">
