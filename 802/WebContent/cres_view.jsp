...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/802/cres_search'">VOLVER</button> 
	<div align="center" class="title">
		<p>CONSULTAR FACTURA AFECTA - EXENTA GUIA RESUMEN</p>
	</div>
</div>
<div class="content" >
  <form action="" name="form1" id="form1" method="post" >
  <input type="hidden" name="fact_id" value="<%=guiaresumen_id%>" > 
