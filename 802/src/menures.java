...
/**
 * Servlet implementation class menures
 */
@WebServlet("/menures")
public class menures extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
    		...
    		String log_sql=""
    				...
    				+ " ) "
    				+ " VALUES "
    				+ " (now(), 'USUARIO INGRESA AL MENU 802', '"+id_iusuario+"') ";
		...
		///////////////////////////////////////////////////////////
		RequestDispatcher rd = request.getRequestDispatcher("menures.jsp");
