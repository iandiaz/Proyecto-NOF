...
/**
 * Servlet implementation class cres_search
 */
@WebServlet("/cres_search")
public class cres_search extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
		    ...
		    String SQL_clpr = "SELECT * FROM `802` g"
		...
		RequestDispatcher rd = request.getRequestDispatcher("cres_search.jsp");
