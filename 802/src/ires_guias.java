...
/**
 * Servlet implementation class ires_guias
 */
@WebServlet("/ires_guias")
public class ires_guias extends HttpServlet {
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
		    ...
		    String SQL_Alertas = "(SELECT "
		    			...
		    			+ "	G.822_ESTADO, "
    		 			...
    		 			+ " WHERE G.822_FOLIO is not null AND G.en_factura IS NULL AND CLPR_ID = "+EID+" "
		    ...
		    while(Alertas_RS.next()){
		    	alertas.add(Alertas_RS.getString("GD_ID")+"/"+Alertas_RS.getString("empresas_razonsocial")
		    			+"/"+Alertas_RS.getString("GD_TOTAL")+"/"+Alertas_RS.getString("GD_FECHA")+"/"+Alertas_RS.getString("folio"));
    	    }
		    Alertas_RS.close();
		    state.close();
            conexion.close();
		...
		RequestDispatcher rd = request.getRequestDispatcher("ires_guias.jsp");
