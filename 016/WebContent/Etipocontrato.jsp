...
<html lang="en">
  ...
  <form id="deletegrupo" action="" method="post" style="margin: 0px 0px 0px 0px;">
    ...
    <div class="navbar">
     ...
     <form method="get" action="Mtipocontrato" style="margin: 0px 0px 0px 0px">                
     	<button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">
     		CERRAR SESIÓN
     	</button>
     </form>
     
     <button type="button" onclick="location='/016/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
    
     <div align="center" class="title">
     	<p >ELIMINAR TIPO CONTRATO</p>
     </div>
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR TIPO CONTRATO A ELIMINAR</p> </h3>
...
%>
			...
			<tr class="hov"  style="color:<%=Grupos[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Grupos[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='Etipocontrato2?id_g=<%=Grupos[0]%>';">
  ...
  <!-- Table -->
	...
	<div class="footerapp">
    	...
    	<p style="float: left;">
            ...
            <strong><%=Usu_nom %></strong>
        </p>
               
        <button type="button" onclick="window.open('/003/','_blank')" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:2px;">
        	MENU
        </button>
    </div>
