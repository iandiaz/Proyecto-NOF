...
<%
	String grupos_id=(String)request.getAttribute("tipo_contrato_id");
	String[] ar_estados =(String[]) request.getAttribute("ar_estados");
	String grupos_nombre =(String) request.getAttribute("tipo_contrato_nombre");
...
<!-- VALIDANDO QUE LOS CAMPOS VALLAN CON ALGO -->
 ...
 <% 
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
      ...
      <form method="get" action="Itipocontrato" style="margin:0px 0px 0px 0px">
      	...
      	<button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">
      		CERRAR SESIÓN
      	</button>
      	
      </form>
      
      <button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onClick="location='Mtipocontrato'">
      	VOLVER
      </button>
  ...
  <form action="Mtipocontrato2" name="form1" method="post">
 	...
 	<tr>
    	<td>
    		<div class="divhead">
    			...
    			<input type="text" value="<%=grupos_id %>" style="width:50px;height:30px; background:#FFF;color: #000;" disabled="disabled" >
            </div>
        </td>
    </tr>
  	<tr>
    	<td>
    		<div class="divhead">
    			...
    			<input maxlength="25" type="text" class="amarillo" name="tipo_contrato_nombre" id="grupos_nombre" style="width:290px;height:30px;background:#FF3;border: 1px solid #FFFF00;" value="<%=grupos_nombre%>" required autofocus="autofocus" >
