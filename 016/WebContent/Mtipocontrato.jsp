...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/016/'" class="btn btn-danger pull-right" style="margin-right: 5px;">VOLVER</button>
                   
                    <div align="center" class="title">
                    <p >MODIFICAR TIPO CONTRATO</p>
                    </div>
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR TIPO CONTRATO A MODIFICAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arGrupos.length; i++)
         {
			...
			<tr class="hov"  style="color:<%=Grupos[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Grupos[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='Mtipocontrato2?id_g=<%=Grupos[0]%>';">
