...
/**
 * Servlet implementation class Mtipocontrato
 */
@WebServlet("/Mtipocontrato")
public class Mtipocontrato extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Mtipocontrato() {
        super();
	...
	public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		try 
		{
    		...
    		String SQL_Grupos = ""
  		    		...
  		    		+ "ORDER BY g.tipo_contrato_nombre";
 		    ...
 		    {        	   
 		    	...
 		    	grupos.add(Grupos_RS.getString("tipo_contrato_id")+"/"+Grupos_RS.getString("tipo_contrato_nombre")+"/"+Grupos_RS.getString("estados_vig_novig_id")+"/"+Grupos_RS.getString("estados_vig_novig_nombre"));
 		    ...
 		    {       	   
 		    	...
 		    	grupo_emp.add(grupos_empresa_rs.getString("tipo_contrato_id")+"/"+grupos_empresa_rs.getString("empresas_nombre"));       	    
		...
		RequestDispatcher rd = request.getRequestDispatcher("Mtipocontrato.jsp");
