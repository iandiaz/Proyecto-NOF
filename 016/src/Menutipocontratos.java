...
/**
 * Servlet implementation class Menutipocontratos
 */
@WebServlet("/Menutipocontratos")
public class Menutipocontratos extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Menutipocontratos() {
        super();
	...
	public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		if(request.getParameter("logout") !=  null)
		{
			if (cookies != null) 
			{
			    for (Cookie cookie : cookies) 
			    {
			    	...
			    	if(cookie.getName().equals("Usuarios_id"))
			    	{
		...
		try 
		{
			...
			///////////////////////////////////////////////////////////
			RequestDispatcher rd = request.getRequestDispatcher("menutipocontrato.jsp");
