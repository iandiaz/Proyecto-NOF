...
/**
 * Servlet implementation class Etipocontrato2
 */
@WebServlet("/Etipocontrato2")
public class Etipocontrato2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Etipocontrato2() {
        super();
...
public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try 
		{
    		...
    		if(request.getParameter("delete_id") !=  null)
    		{
	 				...
	 				String UPDATE = "UPDATE tipo_contrato SET estados_vig_novig_id=2,tipo_contrato_accion_alertada=0,tipo_contrato_ult_idper_exec=9 WHERE tipo_contrato_id="+request.getParameter("delete_id");
	 				...
	 				RequestDispatcher redir = request.getRequestDispatcher("Etipocontrato?EExito=OK");
		    ...
		    System.out.println("select: "+Grupo_RS);
		...
		RequestDispatcher rd = request.getRequestDispatcher("Etipocontrato2.jsp");
