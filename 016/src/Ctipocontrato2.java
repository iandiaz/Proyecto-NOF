...
/**
 * Servlet implementation class Ctipocontrato2
 */
@WebServlet("/Ctipocontrato2")
public class Ctipocontrato2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Ctipocontrato2() {
        super();
	...
	public void mt(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		RequestDispatcher rd = request.getRequestDispatcher("Ctipocontrato2.jsp");
