 ...
 <style type="text/css">
   ...
   <script>
    ...
    function getSbs(){
        ...
        .done(function( data ) {
        	$('#fbody').empty();
          		var sbs_arr = $.parseJSON(data);
          		
          		$.each( sbs_arr, function( key, sb ) {
          			
          			var classvnv ="";
          			
          			if(sb.estados_vig_novig.id==1){
          				classvnv="vig";
          			}
          				
          			if(sb.estados_vig_novig.id==2){
          				classvnv="novig";
          			}
          			
          			var line="<tr class='hov "+classvnv+"' onclick=\"location='N<%=Constantes.MODULO %>_E_02_001?id="+sb.id+"';\" style='font-size:20px'  >";
          			
          			line+="<td width=\"60px\" >"+sb.id+"</td>";
          			
          			line+="<td width='300px' >"+sb.empresa+"</td>";
          			line+="<td width='146px' >"+sb.estados_vig_novig.nombre+"</td>";
...
<div class="navbar">
	...
	<div class="version" align="right">
	  <p>N<%=Constantes.MODULO %>.E.01.001</p>
	</div>	
		...
		<p >ELIMINAR <%=modname %></p>
         ...
         <div class="menu"  style="min-width: 520px;max-width: 520px;">
         	<div class="titulomenu" style="border: 1px solid black;min-width: 520px;max-width: 520px;">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR SPECIAL BID A ELIMINAR</p> </h3>
			</div>
