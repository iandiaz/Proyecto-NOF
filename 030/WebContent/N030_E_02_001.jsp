...
margin: 0 auto;
    ...
    function grabar(){
					...
					$.post( "eliminarSBAsync", $( "#form1" ).serialize())
					    .done(function( data ) {
					    	if(data.trim()=="OK"){
  ...
  <form action="" name="form1" method="post" id="form1" > 
  	...
  	<h3 class="subtitle" align="center" style="margin:0px 0px 0px 0px"><span style="margin:0px 0px;font-size:20px;">DATOS SPECIAL BID </span> </h3>
		...
		<div style="padding: 5px 5px 5px 5px;">
			<div class="divhead vertical-middle"><strong>ID BID:</strong><input type="text" style="width:80px;height:30px ;" readonly="readonly" value="${specialbid.id}" name="id"  ></div>
