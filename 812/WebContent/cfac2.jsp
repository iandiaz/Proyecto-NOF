...
String fac_servim_condiciones=(String)request.getAttribute("fac_comserv_glosa_desc");	
...
String fac_comserv_ivap=(String)request.getAttribute("fac_comserv_porcentaje_ivaret");	
String ivap=nff.format(Integer.parseInt(fac_comserv_ivap)).replace(",",".");

String fac_comserv_iva=(String)request.getAttribute("fac_comserv_valor_ivaret");	
...
String gr_glosa_desc=(String)request.getAttribute("fac_comserv_glosa_desc");	
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/812/cfac1'">VOLVER</button> 
	<div align="center" class="title">
		<p>CONSULTAR FACTURA DE COMPRA AFECTA - EXENTA SERVICIO</p>
	</div>
</div>
<div class="content" >
	...
	<div class=" cuadroblanco" style="height:120px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>TIPO DTE:</strong><input type="radio"   disabled="disabled" checked="checked"  >(46) FACT COMPRA ELECT</div>
