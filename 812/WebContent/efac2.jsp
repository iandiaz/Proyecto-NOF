...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/812/efac1'">VOLVER</button> 
	<div align="center" class="title">
		<p>ELIMINAR FACTURA DE COMPRA AFECTA - EXENTA SERVICIO</p>
	</div>
</div>
<div class="content" >
