...
<html lang="en">
  ...
  <!--<![endif]-->
   <script type="text/javascript">
  	function detelePerfil(id_g,nombre_g){
  		if(confirm("¿ESTA SEGURO QUE DESEA ELIMINAR LA ALERTA'"+nombre_dato+"' ?")){
  ...
  <form id="deletegruper" action="" method="post" style="margin: 0px 0px 0px 0px;">
    ...
    <div class="navbar">
                    ...
                    <button type="button" onclick="location='/999/'" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">VOLVER</button>
                   
                    <div align="center" class="title">
                    <p >ELIMINAR ALERTA POR EVENTO</p>
                    </div>
  ...
  <div class="content">
         ...
         <p  style="margin:0px 0px;font-size:20px;background-color: #39F">ELEGIR ALERTA A ELIMINAR</p> </h3>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         ...
         for(int i =0; i<arAlertas.length; i++){
			...
			<tr class="hov" style="color:<%=Alertas[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='ealertas_del?id_a=<%=Alertas[0]%>';">
