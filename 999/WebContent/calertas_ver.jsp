...
<div class="navbar">                  
	...
	<div class="version" align="right"><p>N999.C.02.001</p></div>
	<form method="get" action="" style="margin:0px 0px 0px 0px">                 
		<button type="submit" name="logout" id="logout" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;">CERRAR SESIÓN</button>
	</form>
	<button  type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onClick="location='calertas_search'">VOLVER</button>
	<div align="center" class="title" ><p >CONSULTAR ALERTA POR EVENTO</p></div>
</div>    
<div class="content" >
	<div class="cuadroblanco" >
		...
		<div class="divhead">
			<strong>NOM:</strong><input type="text" value="<%=alertas_nombre%>" style="width:570px;height:30px; background:#FFF;color: #000;" disabled="disabled" ></div>
		<div class="divhead">
			<strong>ESTADO:</strong><input type="text" value="<%=estados_vig_novig_nombre%>" style="width:144px;height:30px; background:#FFF;color: #000;" disabled="disabled">
		</div>
    ...
    <table class="table004det">
        ...
        <tbody class="scroll" style="overflow-y: scroll;">
            ...
            <tr>
                ...
                <td class="int" width="25px" align="center"><input class="dale" disabled="disabled" name="permisos[]" <% if(usuario_has_emp){%> checked="checked" <% } %> value="<%=usuemp[0]%>" type="checkbox"></td>
