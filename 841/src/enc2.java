...
/**
 * Servlet implementation class enc2
 */
@WebServlet("/enc2")
public class enc2 extends HttpServlet {
...
//						   
			           ...
			           RequestDispatcher rd = request.getRequestDispatcher("enc2_801.jsp");
				    ...
				    if(modref.equals("802")){
						...
						//-------------------------CABECERA GUIA RESUMEN-------------------------//
						 String SQL_CAB = "SELECT 	g.802_folio,"
				            ...
				            RequestDispatcher rd = request.getRequestDispatcher("enc2_802.jsp");
				            rd.forward(request, response);
					 }
...
//						   
				            ...
				            RequestDispatcher rd = request.getRequestDispatcher("enc2_803.jsp");
				            rd.forward(request, response);
					 }
...
//						   
				            statecor.close();
				            conexion.close();
				            RequestDispatcher rd = request.getRequestDispatcher("enc2_804.jsp");
				            rd.forward(request, response);
					 }
