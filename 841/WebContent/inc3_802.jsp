  ...
  <form action="" name="form1" id="form1" method="post"> 
   ...
   <%if(ncexistente!=null && !tref.equals("2")){%>
	...
	<div class=" cuadroblanco" style="height:160px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>FECHA NC:</strong><input name="fec_nc" id="fec_nc" type="text" class="amarillo" style="width:125px;height:30px ;background:#FF3;" readonly="readonly"  value="<%=gr_fecha%>"></div>
			...
			<tbody id="fbody" class="scroll" style="border: 1px solid black;display: inline-block;">
			 ...
			 %>
					<tr class="hov">
						...
						<% if(tref.equals("3")){ %><input onblur="calcularTotal()"  class="amarillo" style="width:100px;height:30px ;background:#FF3;" type="text" id="detalle_nc_<%=Alertas[5]%>" name="detalle_nc_<%=Alertas[5]%>" value="0"> <% }
