...
<div class="content" >
   ...
   <input type="hidden" name="total_ref" value="<%=total%>" >
	...
	<div class=" cuadroblanco" style="height:200px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>FECHA:</strong><input name="fec_ref" type="text" style="width:130px;height:30px ;background:#FFF;"  value="<%=FAC_FECHA %>" id="datepickerfechafactura" readonly="readonly" ></div>
