...
<div class="content" >
  <form action="" name="form1" id="form1" method="post"> 
	...
	<div class="divhead"><strong>NRO.NC:</strong><input type="text" name="folio" id="folio" style="width:80px;height:30px ;background:#FFF;"  value="<%=folionc%>" readonly="readonly" ></div>
		...
		<div class="divhead"><strong>NRO.FACT:</strong><input type="text" name="folio" id="folio" style="width:80px;height:30px ;background:#FFF;" value="<%=gr_folio %>" readonly="readonly"></div>
			...
			<tbody id="fbody" class="scroll" style="border: 1px solid black">
			 ...
			 %>
					<tr class="hov">
						...
						<input style="width:100px;height:30px ;background:#FFF;" type="text" id="detalle_nc_<%=Alertas[5]%>" name="detalle_nc_<%=Alertas[5]%>" value="<%=valString%>" readonly="readonly">
