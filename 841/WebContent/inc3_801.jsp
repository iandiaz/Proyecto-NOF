...
String ncexistente =(String)request.getAttribute("ncexistente");
...
<script>
    ...
    function validateSubmit(){
    	...
    	if(document.getElementById('razon_nc').value==""){
    		msg+="DEBE INGRESAR LA RAZON DE LA NOTA DE CREDITO\n";
			document.getElementById('razon_nc').focus();
			validate= false;
		}
    	if(Number(document.getElementById('total').value)><%=TOTAL%>){
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/841/inc1'">VOLVER</button> 
	<div align="center" class="title">
		<p >INGRESAR NOTA DE CREDITO</p>
	</div>
</div>
<div class="content" >
  <form action="" name="form1" id="form1" method="post">
  
  <input type="hidden" name="total_ref" value="<%=TOTAL%>" >
  ...
  <input type="hidden" name="fact_id" value="<%=fact_id%>" >
   <input type="hidden" name="tref" value="<%=tref%>" >
    ...
    <input type="hidden" name="obs0" value="<%=USU_INICIAL%>-<%=factura_obs1%>" >
    <input type="hidden" name="obs1" value="<%=CONT_NOMBRE%>-<%=CONT_EMAIL%>" >
    <input type="hidden" name="obs2" value="<%=FACT_OBS%>-<%=factura_obs2%>-<%=FACT_TIPO_CAMBIO%>" >
    <input type="hidden" name="empresas_idemisor" value="123" >
				
    <%if(ncexistente!=null && !tref.equals("2")){%>
    <div class=" cuadroblanco" style="height:40px;background-color: red; color: white;">
	<div style="padding: 5px 5px 0px 5px">
		<div class="divhead"><strong>ATENCION: YA EXISTE UNA NOTA DE CREDITO INGRESADA PARA ESTA FACTURA <a href="/841/cnc2?d_id=<%=ncexistente%>">[VER]</a></strong></div>
	...
	<div style="padding: 5px 5px 0px 5px">
		<div class="divhead"><strong>NRO.FACT:</strong><input  type="text" name="folio" id="folio" style="width:100px;height:30px ;background:#FFF;" readonly="readonly" value="<%=FACT_FOLIO%>"></div>
		...
		<div class="divhead"><strong>FECHA NC:</strong><input name="fec_nc" id="fec_nc" type="text" class="amarillo" style="width:125px;height:30px ;background:#FF3;" readonly="readonly"  value="<%=FACT_FECHA%>"></div>
		...
		<div class="divhead"><strong>EMISOR:</strong><input type="text" style="width:120px;height:30px ;background:#FFF;" readonly="readonly" value="<%=CLPR_NOMBRE_FANTASIA%>" name="empresa_emisora_nombre"></div>
	...
	<div class=" cuadroblanco" style="height:310px;margin-top: 5px">
		...
		<div class="divhead"><strong>RAZON SOCIAL:</strong><input type="text" style="width:600px;height:30px ;background:#FFF;" readonly="readonly" value="<%=CLPR_RAZON_SOCIAL%>" name="841_rz"></div>
		<div class="divhead"><strong>RUT:</strong><input type="text" name="841_rut" id="empresas_rut" style="width:145px;height:30px ;background:#FFF;" readonly="readonly" value="<%=empresas_rut%>" ></div>
		<div class="divhead"><strong>GIRO:</strong><input type="text" style="width:600px;height:30px ;background:#FFF;" readonly="readonly" value="<%=CLPR_GIRO%>" name="empresas_girocliente"></div>
		
		<div class="divhead"><strong>DIRECCION:</strong><input type="text" style="width:500px;height:30px ;background:#FFF;" readonly="readonly" value="<%=DIRE_DIRECCION%>" name="841_direccion"></div>
		<div class="divhead"><strong>COMUNA:</strong><input type="text" style="width:250px;height:30px ;background:#FFF;" readonly="readonly" value="<%=COMU_NOMBRE%>" name="841_comuna"></div>		
		<div class="divhead"><strong>CIUDAD:</strong><input type="text" style="width:250px;height:30px ;background:#FFF;" readonly="readonly" value="<%=DIRE_CIUDAD%>"  name="ciudad"></div>
	...
	<div class=" cuadroblanco" style="height:200px;margin-top: 5px">
        ...
        for(int i =0; i<ar_productos.length; i++){
			...
			<tr class="hov">
				...
				<td width="100"><% if(tref.equals("3")){ %><input onblur="calcularTotal()"  class="amarillo" style="width:100px;height:30px ;background:#FF3;" type="text" id="detalle_nc_<%=ProdDato[7]%>" name="detalle_nc_<%=ProdDato[7]%>" value="0"> <% }
				else{%><input style="width:100px;height:30px ;background:#FFF;" type="text" id="detalle_nc_<%=ProdDato[7]%>" name="detalle_nc_<%=ProdDato[7]%>" value="<%=ProdDato[4]%>" readonly="readonly"><% } %>  </td>
			</tr>
...
<div class=" cuadroblanco" style="height:40px;margin-top: 5px;">
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead">
		<strong>RAZON NC:</strong><input  class="amarillo" style="width:850px;height:30px ;background:#FF3;" maxlength="75" type="text" id="razon_nc" name="razon_nc" value="">
		</div>
	</div>
</div>
	...
	<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead">
		<strong>DONDE DICE:</strong><input  class="amarillo" style="width:850px;height:30px ;background:#FF3;" maxlength="75" type="text" id="nc_dondedice" name="nc_dondedice" value="">
		<strong>DEBE DECIR:</strong><input  class="amarillo" style="width:850px;height:30px ;background:#FF3;" maxlength="75" type="text" id="nc_debedecir" name="nc_debedecir" value="">
		</div>
	</div>
