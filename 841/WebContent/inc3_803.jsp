...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>New Office - NOTA CREDITO</title>
...
<div class="content" >
  ...
  <input type="hidden" name="total_ref" value="<%=total%>" > 
	...
	<div class=" cuadroblanco" style="height:200px;padding: 5px 5px 5px 5px;">
		...
		<div class="divhead"><strong>FECHA:</strong><input type="text" name="fec_ref" id="datepickerfechafactura" style="width:130px;height:30px ;background:#FFF;"  value="<%=FAC_FECHA %>" readonly="readonly" ></div>
		<div class="divhead"><strong>FECHA NC:</strong><input name="fec_nc" id="fec_nc" type="text" class="amarillo" style="width:125px;height:30px ;background:#FF3;" readonly="readonly"  value="<%=FAC_FECHA%>"></div>
		
		<div class="divhead"><strong>CONDICIONES:</strong><input type="text" style="width:380px;height:30px ;background:#FFF;" readonly="readonly" value="<%=fac_servim_condiciones%>"></div>
		...
		<div class="divhead"><strong>TIPO DOCUMENTO:</strong><input name="tipodte" type="radio" style="height: 30px" value="33" disabled="disabled" <% if(fac_servim_tipodte.equals("33")){%> checked="checked" <%} %> >(33)AFECTA <input name="tipodte" type="radio"  style="height: 30px" disabled="disabled" <% if(fac_servim_tipodte.equals("34")){%> checked="checked" <%} %> value="34">(34)EXENTA</div>
	...
	<div class=" cuadroblanco" style="height:235px;margin-top: 5px;">
		...
		%>
		<div class="divhead"><strong>SERV IMP <%=i+1%>:</strong><input type="text" class="serv<%=i+1 %>" style="width:600px;height:30px ;background:#FFF;" value="<%=servicio%>" readonly="readonly"></div>
		...
		<% if(tref.equals("3")){ %><input onblur="calcularTotal()"  class="amarillo val<%=i+1 %>" style="width:100px;height:30px ;background:#FF3;text-align: right;" type="text" id="detalle_nc_<%=i%>"  name="detalle_nc_<%=id%>"  value="0"> <% }
		else{%><input onblur="calcularTotal()" class="val<%=i+1 %>"  style="width:100px;height:30px ;background:#FFF;text-align: right;" type="text" id="detalle_nc_<%=i%>"  name="detalle_nc_<%=id%>"  value="<%=valor %>" readonly="readonly"><% } %> 
		</div>
		<% } %>
		</div>
	</div>
