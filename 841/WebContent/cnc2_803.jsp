...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/841/cnc1'">VOLVER</button> 
	<div align="center" class="title">
		<p>CONSULTAR NOTA DE CREDITO</p>
	</div>
</div>
<div class="content" >
