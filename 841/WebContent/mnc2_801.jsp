	...
	<div class=" cuadroblanco" style="height:200px;margin-top: 5px">
        ...
        for(int i =0; i<ar_productos.length; i++){
			...
			<tr class="hov">
				...
				<td width="100"><% if(tref.equals("3")){ %><input onblur="calcularTotal()"  class="amarillo" style="width:100px;height:30px ;background:#FF3;" type="text" id="detalle_nc_<%=ProdDato[7]%>" name="detalle_nc_<%=ProdDato[7]%>" value="<%=ProdDato[4]%>"> <% }
