...
if(tipo_dteref!=null && !tipo_dteref.equals("null") && !tipo_dteref.equals("")){
...
<div class="content" >
  <form action="" name="form1" id="form1" method="post" > 
	...
	<div class=" cuadroblanco" style="height:235px;margin-top: 5px;">
		...
		<% if(tref.equals("3")){ %><input onblur="calcularTotal()"  class="amarillo val<%=i+1 %>" style="width:100px;height:30px ;background:#FF3;text-align: right;" type="text" id="detalle_nc_<%=i%>"  name="detalle_nc_<%=id%>"  value="<%=valor %>"> <% }
