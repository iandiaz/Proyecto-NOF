...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/841/'">VOLVER</button> 
...
<td width="150px" style="font-size:20px"><strong>ESTADO SII</strong></td>						
					...
					%>        		
						<tr class="hov" style="color:<%=Alertas[4].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[4].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='<%=url %>?d_id=<%=Alertas[0]%>';">
