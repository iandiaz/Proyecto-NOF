...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         for(int i =0; i<anexos.size(); i++){
			...
			<tr class="hov"  style="color:<%=anexo[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=anexo[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='C02?anexo=<%=anexo[0]%>';">
				<td width="47px"><%=anexo[0]%></td>
				<td width="350px"><%=anexo[1]%></td>
				<td width="400px"><%=anexo[4]%></td>
				<td width="450px"><%=anexo[6]%></td>
