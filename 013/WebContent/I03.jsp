...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/013/I02?contrato_id=${anexoContrato.getContrato().getContrato_id()}&emp_id=${anexoContrato.getEmpresa().getEmpresas_id()}'">VOLVER</button> 
...
<div class="content" >
  <form name="form1" id="formSub" method="post" action="I03"> 
    <input type="hidden" name="contrato_id" value="">
    	...
    	<div class="divhead"><strong>NOMBRE:</strong><input type="text" name="estrcobro_nombre" id="estrcobro_nombre" class="amarillo" maxlength="50" style="width:520px;height:30px ;background:#FF3;" value="${estructuraCobro.getEstrcobro_nombre()}"></div>
		<div class="divhead"><strong>OBSERVACION:</strong><input type="text" name="estrcobro_observaciones" id="estrcobro_observaciones" class="amarillo" maxlength="70" style="width:720px;height:30px ;background:#FF3;" value="${estructuraCobro.getEstrcobro_observaciones()}"></div>
