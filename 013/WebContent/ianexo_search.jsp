...
ArrayList<String> contratos =(ArrayList<String>) request.getAttribute("contratos");
	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;">ELEGIR CONTRATO</p> </h3>
			</div>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         for(int i =0; i<contratos.size(); i++){
        	 String[] contrato = contratos.get(i).split(";;");
             	 
        	 %>
        		
			<tr class="hov"  style="color:<%=contrato[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=contrato[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='I02?contrato_id=<%=contrato[0]%>&emp_id=<%=contrato[7]%>';">
				<td width="47px"><%=contrato[0]%></td>
				<td width="350px"><%=contrato[1]%></td>
				<td width="130px"><%=contrato[4]%></td>
				<td width="130px"><%=contrato[3]%></td>
				<td width="200px"><%=contrato[5]%></td>
				<td width="400px"><%=contrato[6]%></td>
