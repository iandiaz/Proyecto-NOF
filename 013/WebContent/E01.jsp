...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%
         for(int i =0; i<anexos.size(); i++){
			...
			<tr class="hov"  style="color:<%=anexo[2].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=anexo[2].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" onclick="location='E02?anexo=<%=anexo[0]%>';">
