...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/013/E01'">VOLVER</button> 
	<div align="center" class="title">
		<p >ELIMINAR <%=modname %></p>
	</div>
</div>
<div class="content" >
  <form action="E02" name="form1" method="post"> 
    <input type="hidden" name="anexo" value="${anexoContrato.getAnc_id()}" />
	...
	<div class=" cuadroblanco" style="height:230px;margin-top: 5px;">
		...
		<div class="divhead"><strong>FECHA DESDE:</strong><input type="text" style="width:130px;height:30px ;background:#FFF;" value="${anexoContrato.getFecha_desde()}" readonly="readonly" ></div>
		<div class="divhead"><strong>FECHA HASTA:</strong><input type="text" style="width:130px;height:30px ;background:#FFF;" value="${anexoContrato.getFecha_hasta()}" readonly="readonly" ></div>
		<div style="padding: 5px 5px 5px 5px;">
		<div class="divhead"><strong>CARGO FIJO MENSUAL UNICO ANEXO CONTRATO:</strong><input type="text" style="width:130px;height:30px ;background:#FFF;" value="${anexoContrato.getCargoFijoUnico()}" readonly="readonly"  ></div>
		...
		<div class="divhead"><strong>NOMBRE:</strong><input type="text"  maxlength="70" style="width:720px;height:30px ;background:#FFF;" value="${anexoContrato.getNombre()}" readonly="readonly"></div>								
		...
		<div class="divhead"><strong>ESTADO:</strong><input type="text" maxlength="70" style="width:120px;height:30px ;background:#FFF;" value="${anexoContrato.getEstadoVignoVig().getNombre()}" readonly="readonly" ></div>
...
<table  class="table004det">
  ...
  <tr>
    ...
    <th scope="col" style="width: 425px;" >UBICACION FISICA</th>
    <th scope="col" style="width: 425px;" >UBICACION FACTURACION</th>
  ...
  <tr>
    ...
    <td class="int" width="425px"><%=maqCon.getUbi_fisica()%> - <%=maqCon.getId_activo()%> - <%=maqCon.getTp_tc_nombre()%></td>
    <td class="int" width="425px"><%=maqCon.getDescripcion()%></td>
    <td class="int" width="50px"><%=maqCon.getEstructurasids()%></td>
  </tr>
