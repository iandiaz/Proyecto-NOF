...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>New Office - Ingresar Facturas Afecta Excenta Activos</title>
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/801/'">VOLVER</button> 
	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR FACTURA A GENERAR DTE PARA SII</p> </h3>
			</div>
        	<div style=" max-height:300px; width:1200px; ">
  <table class="table" style="margin-left:0px; width:100%;">
<thead style="border: 1px solid black">
<tr style="background-color:#0101DF;color:#FFFFFF">
<td width="50px" style="font-size:20px"><strong>FOLIO BIRT</strong></td>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
			...
			<tr class="hov" onclick="location='ifac?fact_id=<%=Alertas[0]%>';">
	...
	<center>FACTURAS EMITIDAS EN BIRT, Y AÚN NO PREPARADAS PARA ENVIAR A SII. 
	</center>
</div><br><br><br>
<div class="footerapp">               
