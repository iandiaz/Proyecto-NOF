...
String fecvencimiento= (String)request.getAttribute("fecvencimiento");
if(fecvencimiento==null || fecvencimiento.equals("NULL") )fecvencimiento="";

String DESCUENTO= (String)request.getAttribute("descuento");
if(DESCUENTO==null || DESCUENTO.equals("NULL") )DESCUENTO="0";

String subtotal_= (String)request.getAttribute("subtotal");
if(subtotal_==null || subtotal_.equals("NULL") )subtotal_="0";


String GLOSADESC= (String)request.getAttribute("glosadesc");
if(GLOSADESC==null || GLOSADESC.equals("NULL") )GLOSADESC="";


String CLPR_RUT=(String)request.getAttribute("CLPR_RUT")+"-"+(String)request.getAttribute("CLPR_DV");
...
if(factura_obs1==null || factura_obs1.equals("NULL")){factura_obs1="";}
if(factura_obs2==null || factura_obs2.equals("NULL")){factura_obs2="";}
...
<div class="navbar">
	...
	<button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top:5px;" onclick="location='/801/cfac_search'">VOLVER</button> 
	<div align="center" class="title">
		<p >CONSULTAR FACTURA AFECTA - EXENTA ACTIVOS</p>
	</div>
</div>
<div class="content" >
  <form  name="form1" id="formdata" method="post" >
  <input type="hidden" name="fact_id" value="<%=fact_id%>" >
	<div class=" cuadroblanco" style="height:160px;">
	<div style="padding: 5px 5px 5px 5px">
	<div class="divhead"><strong>NRO.FOLIO:</strong><input  type="text" style="width:100px;height:30px ;background:#FFF;" disabled="disabled" value="<%=FACT_FOLIO%>"></div>
	...
	<div class="divhead"><strong>FECHA:</strong><input  type="text" style="width:150px;height:30px ;background:#FFF;" readonly="readonly"  value="<%=FACT_FECHA%>" id="datepickerfechafactura"></div>
	<div class="divhead"><strong>CONDICIONES:</strong><input type="text" style="width:350px;height:30px ;background:#FFF;" readonly="readonly" value="<%=FACT_CONDICIONES%>" id="condiciones" ></div>
	...
	<div class="divhead"><strong>FEC. VENCIMIENTO:</strong><input maxlength="10" type="text" style="width:130px;height:30px ;background:#FFF;" value="<%=fecvencimiento %>" readonly="readonly"></div>
	...
	<div class=" cuadroblanco" style="height:310px;margin-top: 5px">
		...
		<div class="divhead"><strong>TIPO CAMBIO:</strong><input  type="text" style="width:120px;height:30px ;background:#FFF;" readonly="readonly" value="<%=FACT_TIPO_CAMBIO%>" id="tipo_cambio"></div>
		<div class="divhead"><strong>CONTACTO:</strong><input type="text" style="width:400px;height:30px ;background:#FFF;" readonly="readonly" value="<%=CONT_NOMBRE%>" name="CONT_NOMBRE" id="CONT_NOMBRE"></div>
		...
		<div class="divhead"><strong>CONTACTO EMAIL:</strong><input id="CONT_EMAIL" name="CONT_EMAIL" type="text"  style="width:450px;height:30px ;background:#FFF;"  value="<%=CONT_EMAIL%>" readonly="readonly"></div>
	...
	<div style="padding: 5px 5px 0px 5px">
		<div class="divhead"><strong>SUBTOTAL:</strong><input type="text" style="width:150px;height:30px ;background:#FFF;text-align: right;" readonly="readonly" value="<%=subtotal%>"  id="neto"></div>
		...
		<div class="divhead"><strong>TOTAL:</strong><input type="text" style="width:150px;height:30px ;background:#FFF;text-align: right;" id="total" readonly="readonly" value="<%=total%>"></div>
...
<div class=" cuadroblanco" style="height:80px;margin-top: 5px">
	...
	<div style="padding: 5px 5px 5px 5px">
		...
		<div class="divhead"><strong>OTRAS OBS:</strong><input type="text" style="width:720px;height:30px ;background:#FFF;" readonly="readonly" value="<%=FACT_OBS%>" id="ref"></div>
		<div class="bgrabar">
