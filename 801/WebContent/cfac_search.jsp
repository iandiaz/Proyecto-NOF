...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>New Office - Consultar Facturas Afecta Excenta Activos</title>
	...
	<div class="containermenu">
         <div class="menu">
         	<div class="titulomenu" style="border: 1px solid black">
         		...
         		<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR FACTURA A CONSULTAR</p> </h3>
			</div>
...
<tbody id="fbody" class="scroll" style="border: 1px solid black">
 ...
 <%        
         for(int i =0; i<arAlertas.length; i++){
			...
			<tr class="hov" onclick="location='cfac?fact_id=<%=Alertas[0]%>';">
