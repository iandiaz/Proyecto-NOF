...
<html lang="en">
  ...
  if(request.getParameter("Exito")!=null && !request.getParameter("Exito").equals("")){
	...
	%>
    <meta charset="utf-8">
    <title>New Office - Facturas Afecta Exenta Activos</title>
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
     ...
     <p >MENU FACTURAS AFECTA - EXENTA ACTIVOS</p>
                     </div>
  ...
  <div class="content">
        ...
        <div class="movilButons">
         ...
         <button type="button" class="btn btn-success movile" <% if(perb_ingresar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='ifac_search'" <%} %> >INGRESAR</button>
         ...
         <button type="button" class="btn btn-primary movile" <% if(perb_consultar.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='cfac_search'" <%} %>>CONSULTAR</button>
         <button type="button" class="btn btn-info movile" <% if(perb_reportes.equals("0")){%> disabled="disabled" <%}else{%> onClick="location='rptgrupos'" <%} %>  >REPORTES</button>
        </div>
