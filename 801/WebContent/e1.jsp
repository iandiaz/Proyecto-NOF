	...
	<div class="containermenu">
		<div class="menu">
			<div class="titulomenu" style="border: 1px solid black;">
				...
				<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR DOCUMENTO A ELIMINAR (QUE NO HAYA SIDO ENVIADA A SII)</p> </h3>
			</div>
			<div style="max-height:400px; width:1200px;">
				<table class="table" style="margin-left:0px;width: 1200px">
					...
					%>        		
						<tr class="hov" onclick="location='e2?id=<%=Alertas[0]%>';" style="color:<%=Alertas[4].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[4].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;">
