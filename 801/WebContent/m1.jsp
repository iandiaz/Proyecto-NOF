...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>New Office - FACTURA AFECTA - EXENTA ACTIVOS</title>
	...
	<div class="containermenu">
		<div class="menu">
			<div class="titulomenu" style="border: 1px solid black;">
				...
				<p style="margin:0px 0px;font-size:20px;background-color:#39F;width:1198px">ELEGIR DOCUMENTO A MODIFICAR (QUE NO HAYA SIDO ENVIADA A SII)</p> </h3>
			</div>
...
<td width="150px" style="font-size:20px"><strong>ESTADO</strong></td>					
					...
					%>        		
						<tr class="hov" onclick="location='m2?id=<%=Alertas[0]%>';" style="color:<%=Alertas[4].equals("1") ? "#000" :"#FFF"%>;font-size:20px;background-color:<%=Alertas[4].equals("1") ? "#00FF00" :"#F00"%>;font-size:20px;" >
